...
const basis = await import('./tools/warehouse-sizing/ui-basis.js?v=20260716-w4a');
...
const { W_STATIONS, renderShellW } = await import('./tools/warehouse-sizing/shell-w.js?v=20260716-w4a');
