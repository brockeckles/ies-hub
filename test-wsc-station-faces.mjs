...
const basis = await import('./tools/warehouse-sizing/ui-basis.js?v=20260722-s5');
...
const { W_STATIONS, renderShellW } = await import('./tools/warehouse-sizing/shell-w.js?v=20260722-s5');
