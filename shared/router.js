 ...
 *
 * Usage:
 *   import { router } from './router.js?v=20260417-m7';
 *
 *   router.register('designtools/cost-model', {
 *     load: () => import('../tools/cost-model/ui.js?v=20260417-m7'),
...
import { state } from './state.js?v=20260417-m7';
import { bus } from './event-bus.js?v=20260417-m7';
