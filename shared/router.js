 ...
 *
 * Usage:
 *   import { router } from './router.js?v=20260417-pc';
 *
 *   router.register('designtools/cost-model', {
 *     load: () => import('../tools/cost-model/ui.js?v=20260417-pc'),
...
import { state } from './state.js?v=20260417-pc';
import { bus } from './event-bus.js?v=20260417-pc';
