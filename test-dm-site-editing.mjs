...
// ── source wiring scans ───────────────────────────────────────────────────
{
  // MSA route retired 2026-07-04 — ui.js deleted. api/calc remain as the
  // deal-tab engine; the ui-wiring pins below became retirement pins.
  ...
  t('MSA ui retired — no manual site-edit surface fights CM-authoritative pricing', () => {
    if (readFileSync('./index.html', 'utf8').includes("designtools/deal-manager"))
      throw new Error('MSA route still registered');
    return true;
  });
