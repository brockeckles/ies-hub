 ...
 * @returns {Promise<import('./types.js?v=20260417-p5').NetworkConfig[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260417-p5').NetworkConfig|null>}
 */
 ...
 * @param {import('./types.js?v=20260417-p5').NetworkConfig} config
 * @returns {Promise<import('./types.js?v=20260417-p5').NetworkConfig>}
 */
 ...
 * @param {string} configId
 * @param {string} name
 * @param {import('./types.js?v=20260417-p5').ScenarioResult} result
 ...
 * @returns {Promise<import('./types.js?v=20260417-p5').DemandPoint[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260417-p5').Facility[]>}
 */
 ...
 * @returns {Promise<{ configs: import('./types.js?v=20260417-p5').NetworkConfig[], demandSeed: import('./types.js?v=20260417-p5').DemandPoint[], facilitySeed: import('./types.js?v=20260417-p5').Facility[] }>}
 */
