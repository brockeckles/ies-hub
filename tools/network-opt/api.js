 ...
 * @returns {Promise<import('./types.js?v=20260418-sB').NetworkConfig[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260418-sB').NetworkConfig|null>}
 */
 ...
 * @param {import('./types.js?v=20260418-sB').NetworkConfig} config
 * @returns {Promise<import('./types.js?v=20260418-sB').NetworkConfig>}
 */
 ...
 * @param {string} configId
 * @param {string} name
 * @param {import('./types.js?v=20260418-sB').ScenarioResult} result
 ...
 * @returns {Promise<import('./types.js?v=20260418-sB').DemandPoint[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260418-sB').Facility[]>}
 */
 ...
 * @returns {Promise<{ configs: import('./types.js?v=20260418-sB').NetworkConfig[], demandSeed: import('./types.js?v=20260418-sB').DemandPoint[], facilitySeed: import('./types.js?v=20260418-sB').Facility[] }>}
 */
