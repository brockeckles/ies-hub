 ...
 * @returns {Promise<import('./types.js?v=20260418-s4').NetworkConfig[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260418-s4').NetworkConfig|null>}
 */
 ...
 * @param {import('./types.js?v=20260418-s4').NetworkConfig} config
 * @returns {Promise<import('./types.js?v=20260418-s4').NetworkConfig>}
 */
 ...
 * @param {string} configId
 * @param {string} name
 * @param {import('./types.js?v=20260418-s4').ScenarioResult} result
 ...
 * @returns {Promise<import('./types.js?v=20260418-s4').DemandPoint[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260418-s4').Facility[]>}
 */
 ...
 * @returns {Promise<{ configs: import('./types.js?v=20260418-s4').NetworkConfig[], demandSeed: import('./types.js?v=20260418-s4').DemandPoint[], facilitySeed: import('./types.js?v=20260418-s4').Facility[] }>}
 */
