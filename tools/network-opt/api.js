 ...
 * @returns {Promise<import('./types.js?v=20260418-sF').NetworkConfig[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260418-sF').NetworkConfig|null>}
 */
 ...
 * @param {import('./types.js?v=20260418-sF').NetworkConfig} config
 * @returns {Promise<import('./types.js?v=20260418-sF').NetworkConfig>}
 */
 ...
 * @param {string} configId
 * @param {string} name
 * @param {import('./types.js?v=20260418-sF').ScenarioResult} result
 ...
 * @returns {Promise<import('./types.js?v=20260418-sF').DemandPoint[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260418-sF').Facility[]>}
 */
 ...
 * @returns {Promise<{ configs: import('./types.js?v=20260418-sF').NetworkConfig[], demandSeed: import('./types.js?v=20260418-sF').DemandPoint[], facilitySeed: import('./types.js?v=20260418-sF').Facility[] }>}
 */
