 ...
 * @returns {Promise<import('./types.js?v=20260418-sA').NetworkConfig[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260418-sA').NetworkConfig|null>}
 */
 ...
 * @param {import('./types.js?v=20260418-sA').NetworkConfig} config
 * @returns {Promise<import('./types.js?v=20260418-sA').NetworkConfig>}
 */
 ...
 * @param {string} configId
 * @param {string} name
 * @param {import('./types.js?v=20260418-sA').ScenarioResult} result
 ...
 * @returns {Promise<import('./types.js?v=20260418-sA').DemandPoint[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260418-sA').Facility[]>}
 */
 ...
 * @returns {Promise<{ configs: import('./types.js?v=20260418-sA').NetworkConfig[], demandSeed: import('./types.js?v=20260418-sA').DemandPoint[], facilitySeed: import('./types.js?v=20260418-sA').Facility[] }>}
 */
