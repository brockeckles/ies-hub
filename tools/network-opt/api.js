 ...
 * @returns {Promise<import('./types.js').NetworkConfig[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js').NetworkConfig|null>}
 */
 ...
 * @param {import('./types.js').NetworkConfig} config
 * @returns {Promise<import('./types.js').NetworkConfig>}
 */
 ...
 * @returns {Promise<import('./types.js').DemandPoint[]>}
 */
 ...
 * @returns {Promise<import('./types.js').Facility[]>}
 */
 ...
 * @returns {Promise<{ configs: import('./types.js').NetworkConfig[], demandSeed: import('./types.js').DemandPoint[], facilitySeed: import('./types.js').Facility[] }>}
 */
