 ...
 * @returns {Promise<import('./types.js?v=20260417-p9').NetworkConfig[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260417-p9').NetworkConfig|null>}
 */
 ...
 * @param {import('./types.js?v=20260417-p9').NetworkConfig} config
 * @returns {Promise<import('./types.js?v=20260417-p9').NetworkConfig>}
 */
 ...
 * @param {string} configId
 * @param {string} name
 * @param {import('./types.js?v=20260417-p9').ScenarioResult} result
 ...
 * @returns {Promise<import('./types.js?v=20260417-p9').DemandPoint[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260417-p9').Facility[]>}
 */
 ...
 * @returns {Promise<{ configs: import('./types.js?v=20260417-p9').NetworkConfig[], demandSeed: import('./types.js?v=20260417-p9').DemandPoint[], facilitySeed: import('./types.js?v=20260417-p9').Facility[] }>}
 */
