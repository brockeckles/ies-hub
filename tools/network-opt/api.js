 ...
 * @returns {Promise<import('./types.js?v=20260418-s5').NetworkConfig[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260418-s5').NetworkConfig|null>}
 */
 ...
 * @param {import('./types.js?v=20260418-s5').NetworkConfig} config
 * @returns {Promise<import('./types.js?v=20260418-s5').NetworkConfig>}
 */
 ...
 * @param {string} configId
 * @param {string} name
 * @param {import('./types.js?v=20260418-s5').ScenarioResult} result
 ...
 * @returns {Promise<import('./types.js?v=20260418-s5').DemandPoint[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260418-s5').Facility[]>}
 */
 ...
 * @returns {Promise<{ configs: import('./types.js?v=20260418-s5').NetworkConfig[], demandSeed: import('./types.js?v=20260418-s5').DemandPoint[], facilitySeed: import('./types.js?v=20260418-s5').Facility[] }>}
 */
