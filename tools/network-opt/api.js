 ...
 * @returns {Promise<import('./types.js?v=20260418-s3').NetworkConfig[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260418-s3').NetworkConfig|null>}
 */
 ...
 * @param {import('./types.js?v=20260418-s3').NetworkConfig} config
 * @returns {Promise<import('./types.js?v=20260418-s3').NetworkConfig>}
 */
 ...
 * @param {string} configId
 * @param {string} name
 * @param {import('./types.js?v=20260418-s3').ScenarioResult} result
 ...
 * @returns {Promise<import('./types.js?v=20260418-s3').DemandPoint[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260418-s3').Facility[]>}
 */
 ...
 * @returns {Promise<{ configs: import('./types.js?v=20260418-s3').NetworkConfig[], demandSeed: import('./types.js?v=20260418-s3').DemandPoint[], facilitySeed: import('./types.js?v=20260418-s3').Facility[] }>}
 */
