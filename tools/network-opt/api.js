 ...
 * @returns {Promise<import('./types.js?v=20260418-s6').NetworkConfig[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260418-s6').NetworkConfig|null>}
 */
 ...
 * @param {import('./types.js?v=20260418-s6').NetworkConfig} config
 * @returns {Promise<import('./types.js?v=20260418-s6').NetworkConfig>}
 */
 ...
 * @param {string} configId
 * @param {string} name
 * @param {import('./types.js?v=20260418-s6').ScenarioResult} result
 ...
 * @returns {Promise<import('./types.js?v=20260418-s6').DemandPoint[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260418-s6').Facility[]>}
 */
 ...
 * @returns {Promise<{ configs: import('./types.js?v=20260418-s6').NetworkConfig[], demandSeed: import('./types.js?v=20260418-s6').DemandPoint[], facilitySeed: import('./types.js?v=20260418-s6').Facility[] }>}
 */
