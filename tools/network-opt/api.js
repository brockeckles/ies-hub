 ...
 * @returns {Promise<import('./types.js?v=20260417-p7').NetworkConfig[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260417-p7').NetworkConfig|null>}
 */
 ...
 * @param {import('./types.js?v=20260417-p7').NetworkConfig} config
 * @returns {Promise<import('./types.js?v=20260417-p7').NetworkConfig>}
 */
 ...
 * @param {string} configId
 * @param {string} name
 * @param {import('./types.js?v=20260417-p7').ScenarioResult} result
 ...
 * @returns {Promise<import('./types.js?v=20260417-p7').DemandPoint[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260417-p7').Facility[]>}
 */
 ...
 * @returns {Promise<{ configs: import('./types.js?v=20260417-p7').NetworkConfig[], demandSeed: import('./types.js?v=20260417-p7').DemandPoint[], facilitySeed: import('./types.js?v=20260417-p7').Facility[] }>}
 */
