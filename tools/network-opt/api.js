 ...
 * @returns {Promise<import('./types.js?v=20260417-p4').NetworkConfig[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260417-p4').NetworkConfig|null>}
 */
 ...
 * @param {import('./types.js?v=20260417-p4').NetworkConfig} config
 * @returns {Promise<import('./types.js?v=20260417-p4').NetworkConfig>}
 */
 ...
 * @param {string} configId
 * @param {string} name
 * @param {import('./types.js?v=20260417-p4').ScenarioResult} result
 ...
 * @returns {Promise<import('./types.js?v=20260417-p4').DemandPoint[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260417-p4').Facility[]>}
 */
 ...
 * @returns {Promise<{ configs: import('./types.js?v=20260417-p4').NetworkConfig[], demandSeed: import('./types.js?v=20260417-p4').DemandPoint[], facilitySeed: import('./types.js?v=20260417-p4').Facility[] }>}
 */
