 ...
 * @returns {Promise<import('./types.js?v=20260418-s8').NetworkConfig[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260418-s8').NetworkConfig|null>}
 */
 ...
 * @param {import('./types.js?v=20260418-s8').NetworkConfig} config
 * @returns {Promise<import('./types.js?v=20260418-s8').NetworkConfig>}
 */
 ...
 * @param {string} configId
 * @param {string} name
 * @param {import('./types.js?v=20260418-s8').ScenarioResult} result
 ...
 * @returns {Promise<import('./types.js?v=20260418-s8').DemandPoint[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260418-s8').Facility[]>}
 */
 ...
 * @returns {Promise<{ configs: import('./types.js?v=20260418-s8').NetworkConfig[], demandSeed: import('./types.js?v=20260418-s8').DemandPoint[], facilitySeed: import('./types.js?v=20260418-s8').Facility[] }>}
 */
