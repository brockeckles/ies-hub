 ...
 * @returns {Promise<import('./types.js?v=20260417-p3').NetworkConfig[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260417-p3').NetworkConfig|null>}
 */
 ...
 * @param {import('./types.js?v=20260417-p3').NetworkConfig} config
 * @returns {Promise<import('./types.js?v=20260417-p3').NetworkConfig>}
 */
 ...
 * @param {string} configId
 * @param {string} name
 * @param {import('./types.js?v=20260417-p3').ScenarioResult} result
 ...
 * @returns {Promise<import('./types.js?v=20260417-p3').DemandPoint[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260417-p3').Facility[]>}
 */
 ...
 * @returns {Promise<{ configs: import('./types.js?v=20260417-p3').NetworkConfig[], demandSeed: import('./types.js?v=20260417-p3').DemandPoint[], facilitySeed: import('./types.js?v=20260417-p3').Facility[] }>}
 */
