 ...
 * @returns {Promise<import('./types.js?v=20260417-p6').NetworkConfig[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260417-p6').NetworkConfig|null>}
 */
 ...
 * @param {import('./types.js?v=20260417-p6').NetworkConfig} config
 * @returns {Promise<import('./types.js?v=20260417-p6').NetworkConfig>}
 */
 ...
 * @param {string} configId
 * @param {string} name
 * @param {import('./types.js?v=20260417-p6').ScenarioResult} result
 ...
 * @returns {Promise<import('./types.js?v=20260417-p6').DemandPoint[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260417-p6').Facility[]>}
 */
 ...
 * @returns {Promise<{ configs: import('./types.js?v=20260417-p6').NetworkConfig[], demandSeed: import('./types.js?v=20260417-p6').DemandPoint[], facilitySeed: import('./types.js?v=20260417-p6').Facility[] }>}
 */
