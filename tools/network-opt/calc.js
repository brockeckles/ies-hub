 ...
 * @param {import('./types.js?v=20260417-m9').ModeMix} modeMix
 * @param {import('./types.js?v=20260417-m9').RateCard} [rateCard]
 ...
 * @param {import('./types.js?v=20260417-m9').Facility[]} facilities
 * @param {import('./types.js?v=20260417-m9').DemandPoint[]} demands
 * @param {import('./types.js?v=20260417-m9').ModeMix} modeMix
 * @param {import('./types.js?v=20260417-m9').RateCard} [rateCard]
 * @param {import('./types.js?v=20260417-m9').ServiceConfig} [serviceConfig]
 * @returns {import('./types.js?v=20260417-m9').LaneCost[]}
 */
 ...
 * @param {import('./types.js?v=20260417-m9').RateCard} [rateCard]
 * @param {import('./types.js?v=20260417-m9').ServiceConfig} [serviceConfig]
 * @returns {import('./types.js?v=20260417-m9').ScenarioResult}
 */
 ...
 * @param {import('./types.js?v=20260417-m9').ScenarioResult[]} scenarios
 * @returns {Array<import('./types.js?v=20260417-m9').ScenarioResult & { verdict: string, deltaPct: number }>}
 */
 ...
 * @param {import('./types.js?v=20260417-m9').RateCard} [rateCard]
 * @param {import('./types.js?v=20260417-m9').ServiceConfig} [serviceConfig]
 * @returns {{scenarios: import('./types.js?v=20260417-m9').ScenarioResult[], optimal: import('./types.js?v=20260417-m9').ScenarioResult|null} | null}
 */
 ...
 * @param {import('./types.js?v=20260417-m9').ScenarioResult[]} comparisonResults
