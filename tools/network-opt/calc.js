 ...
 * @param {import('./types.js?v=20260417-m4').ModeMix} modeMix
 * @param {import('./types.js?v=20260417-m4').RateCard} [rateCard]
 ...
 * @param {import('./types.js?v=20260417-m4').Facility[]} facilities
 * @param {import('./types.js?v=20260417-m4').DemandPoint[]} demands
 * @param {import('./types.js?v=20260417-m4').ModeMix} modeMix
 * @param {import('./types.js?v=20260417-m4').RateCard} [rateCard]
 * @param {import('./types.js?v=20260417-m4').ServiceConfig} [serviceConfig]
 * @returns {import('./types.js?v=20260417-m4').LaneCost[]}
 */
 ...
 * @param {import('./types.js?v=20260417-m4').RateCard} [rateCard]
 * @param {import('./types.js?v=20260417-m4').ServiceConfig} [serviceConfig]
 * @returns {import('./types.js?v=20260417-m4').ScenarioResult}
 */
 ...
 * @param {import('./types.js?v=20260417-m4').ScenarioResult[]} scenarios
 * @returns {Array<import('./types.js?v=20260417-m4').ScenarioResult & { verdict: string, deltaPct: number }>}
 */
 ...
 * @param {import('./types.js?v=20260417-m4').RateCard} [rateCard]
 * @param {import('./types.js?v=20260417-m4').ServiceConfig} [serviceConfig]
 * @returns {{scenarios: import('./types.js?v=20260417-m4').ScenarioResult[], optimal: import('./types.js?v=20260417-m4').ScenarioResult|null} | null}
 */
 ...
 * @param {import('./types.js?v=20260417-m4').ScenarioResult[]} comparisonResults
