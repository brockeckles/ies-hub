 ...
 * @param {import('./types.js?v=20260417-p8').ModeMix} modeMix
 * @param {import('./types.js?v=20260417-p8').RateCard} [rateCard]
 ...
 * @param {import('./types.js?v=20260417-p8').Facility[]} facilities
 * @param {import('./types.js?v=20260417-p8').DemandPoint[]} demands
 * @param {import('./types.js?v=20260417-p8').ModeMix} modeMix
 * @param {import('./types.js?v=20260417-p8').RateCard} [rateCard]
 * @param {import('./types.js?v=20260417-p8').ServiceConfig} [serviceConfig]
 * @returns {import('./types.js?v=20260417-p8').LaneCost[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p8').RateCard} [rateCard]
 * @param {import('./types.js?v=20260417-p8').ServiceConfig} [serviceConfig]
 * @returns {import('./types.js?v=20260417-p8').ScenarioResult}
 */
 ...
 * @param {import('./types.js?v=20260417-p8').ScenarioResult[]} scenarios
 * @returns {Array<import('./types.js?v=20260417-p8').ScenarioResult & { verdict: string, deltaPct: number }>}
 */
 ...
 * @param {import('./types.js?v=20260417-p8').RateCard} [rateCard]
 * @param {import('./types.js?v=20260417-p8').ServiceConfig} [serviceConfig]
 * @returns {{scenarios: import('./types.js?v=20260417-p8').ScenarioResult[], optimal: import('./types.js?v=20260417-p8').ScenarioResult|null} | null}
 */
 ...
 * @param {import('./types.js?v=20260417-p8').ScenarioResult[]} comparisonResults
