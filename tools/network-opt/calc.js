 ...
 * @param {import('./types.js?v=20260417-m5').ModeMix} modeMix
 * @param {import('./types.js?v=20260417-m5').RateCard} [rateCard]
 ...
 * @param {import('./types.js?v=20260417-m5').Facility[]} facilities
 * @param {import('./types.js?v=20260417-m5').DemandPoint[]} demands
 * @param {import('./types.js?v=20260417-m5').ModeMix} modeMix
 * @param {import('./types.js?v=20260417-m5').RateCard} [rateCard]
 * @param {import('./types.js?v=20260417-m5').ServiceConfig} [serviceConfig]
 * @returns {import('./types.js?v=20260417-m5').LaneCost[]}
 */
 ...
 * @param {import('./types.js?v=20260417-m5').RateCard} [rateCard]
 * @param {import('./types.js?v=20260417-m5').ServiceConfig} [serviceConfig]
 * @returns {import('./types.js?v=20260417-m5').ScenarioResult}
 */
 ...
 * @param {import('./types.js?v=20260417-m5').ScenarioResult[]} scenarios
 * @returns {Array<import('./types.js?v=20260417-m5').ScenarioResult & { verdict: string, deltaPct: number }>}
 */
 ...
 * @param {import('./types.js?v=20260417-m5').RateCard} [rateCard]
 * @param {import('./types.js?v=20260417-m5').ServiceConfig} [serviceConfig]
 * @returns {{scenarios: import('./types.js?v=20260417-m5').ScenarioResult[], optimal: import('./types.js?v=20260417-m5').ScenarioResult|null} | null}
 */
 ...
 * @param {import('./types.js?v=20260417-m5').ScenarioResult[]} comparisonResults
