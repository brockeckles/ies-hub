 ...
 * @param {import('./types.js?v=20260417-p1').ModeMix} modeMix
 * @param {import('./types.js?v=20260417-p1').RateCard} [rateCard]
 ...
 * @param {import('./types.js?v=20260417-p1').Facility[]} facilities
 * @param {import('./types.js?v=20260417-p1').DemandPoint[]} demands
 * @param {import('./types.js?v=20260417-p1').ModeMix} modeMix
 * @param {import('./types.js?v=20260417-p1').RateCard} [rateCard]
 * @param {import('./types.js?v=20260417-p1').ServiceConfig} [serviceConfig]
 * @returns {import('./types.js?v=20260417-p1').LaneCost[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p1').RateCard} [rateCard]
 * @param {import('./types.js?v=20260417-p1').ServiceConfig} [serviceConfig]
 * @returns {import('./types.js?v=20260417-p1').ScenarioResult}
 */
 ...
 * @param {import('./types.js?v=20260417-p1').ScenarioResult[]} scenarios
 * @returns {Array<import('./types.js?v=20260417-p1').ScenarioResult & { verdict: string, deltaPct: number }>}
 */
 ...
 * @param {import('./types.js?v=20260417-p1').RateCard} [rateCard]
 * @param {import('./types.js?v=20260417-p1').ServiceConfig} [serviceConfig]
 * @returns {{scenarios: import('./types.js?v=20260417-p1').ScenarioResult[], optimal: import('./types.js?v=20260417-p1').ScenarioResult|null} | null}
 */
 ...
 * @param {import('./types.js?v=20260417-p1').ScenarioResult[]} comparisonResults
