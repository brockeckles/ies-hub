 ...
 * @param {import('./types.js?v=20260417-p6').ModeMix} modeMix
 * @param {import('./types.js?v=20260417-p6').RateCard} [rateCard]
 ...
 * @param {import('./types.js?v=20260417-p6').Facility[]} facilities
 * @param {import('./types.js?v=20260417-p6').DemandPoint[]} demands
 * @param {import('./types.js?v=20260417-p6').ModeMix} modeMix
 * @param {import('./types.js?v=20260417-p6').RateCard} [rateCard]
 * @param {import('./types.js?v=20260417-p6').ServiceConfig} [serviceConfig]
 * @returns {import('./types.js?v=20260417-p6').LaneCost[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p6').RateCard} [rateCard]
 * @param {import('./types.js?v=20260417-p6').ServiceConfig} [serviceConfig]
 * @returns {import('./types.js?v=20260417-p6').ScenarioResult}
 */
 ...
 * @param {import('./types.js?v=20260417-p6').ScenarioResult[]} scenarios
 * @returns {Array<import('./types.js?v=20260417-p6').ScenarioResult & { verdict: string, deltaPct: number }>}
 */
 ...
 * @param {import('./types.js?v=20260417-p6').RateCard} [rateCard]
 * @param {import('./types.js?v=20260417-p6').ServiceConfig} [serviceConfig]
 * @returns {{scenarios: import('./types.js?v=20260417-p6').ScenarioResult[], optimal: import('./types.js?v=20260417-p6').ScenarioResult|null} | null}
 */
 ...
 * @param {import('./types.js?v=20260417-p6').ScenarioResult[]} comparisonResults
