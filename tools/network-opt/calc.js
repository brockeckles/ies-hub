 ...
 * @param {import('./types.js?v=20260417-m8').ModeMix} modeMix
 * @param {import('./types.js?v=20260417-m8').RateCard} [rateCard]
 ...
 * @param {import('./types.js?v=20260417-m8').Facility[]} facilities
 * @param {import('./types.js?v=20260417-m8').DemandPoint[]} demands
 * @param {import('./types.js?v=20260417-m8').ModeMix} modeMix
 * @param {import('./types.js?v=20260417-m8').RateCard} [rateCard]
 * @param {import('./types.js?v=20260417-m8').ServiceConfig} [serviceConfig]
 * @returns {import('./types.js?v=20260417-m8').LaneCost[]}
 */
 ...
 * @param {import('./types.js?v=20260417-m8').RateCard} [rateCard]
 * @param {import('./types.js?v=20260417-m8').ServiceConfig} [serviceConfig]
 * @returns {import('./types.js?v=20260417-m8').ScenarioResult}
 */
 ...
 * @param {import('./types.js?v=20260417-m8').ScenarioResult[]} scenarios
 * @returns {Array<import('./types.js?v=20260417-m8').ScenarioResult & { verdict: string, deltaPct: number }>}
 */
 ...
 * @param {import('./types.js?v=20260417-m8').RateCard} [rateCard]
 * @param {import('./types.js?v=20260417-m8').ServiceConfig} [serviceConfig]
 * @returns {{scenarios: import('./types.js?v=20260417-m8').ScenarioResult[], optimal: import('./types.js?v=20260417-m8').ScenarioResult|null} | null}
 */
 ...
 * @param {import('./types.js?v=20260417-m8').ScenarioResult[]} comparisonResults
