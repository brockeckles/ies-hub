 ...
 * @param {import('./types.js?v=20260417-p3').ModeMix} modeMix
 * @param {import('./types.js?v=20260417-p3').RateCard} [rateCard]
 ...
 * @param {import('./types.js?v=20260417-p3').Facility[]} facilities
 * @param {import('./types.js?v=20260417-p3').DemandPoint[]} demands
 * @param {import('./types.js?v=20260417-p3').ModeMix} modeMix
 * @param {import('./types.js?v=20260417-p3').RateCard} [rateCard]
 * @param {import('./types.js?v=20260417-p3').ServiceConfig} [serviceConfig]
 * @returns {import('./types.js?v=20260417-p3').LaneCost[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p3').RateCard} [rateCard]
 * @param {import('./types.js?v=20260417-p3').ServiceConfig} [serviceConfig]
 * @returns {import('./types.js?v=20260417-p3').ScenarioResult}
 */
 ...
 * @param {import('./types.js?v=20260417-p3').ScenarioResult[]} scenarios
 * @returns {Array<import('./types.js?v=20260417-p3').ScenarioResult & { verdict: string, deltaPct: number }>}
 */
 ...
 * @param {import('./types.js?v=20260417-p3').RateCard} [rateCard]
 * @param {import('./types.js?v=20260417-p3').ServiceConfig} [serviceConfig]
 * @returns {{scenarios: import('./types.js?v=20260417-p3').ScenarioResult[], optimal: import('./types.js?v=20260417-p3').ScenarioResult|null} | null}
 */
 ...
 * @param {import('./types.js?v=20260417-p3').ScenarioResult[]} comparisonResults
