 ...
 * @param {import('./types.js?v=20260417-m2').ModeMix} modeMix
 * @param {import('./types.js?v=20260417-m2').RateCard} [rateCard]
 ...
 * @param {import('./types.js?v=20260417-m2').Facility[]} facilities
 * @param {import('./types.js?v=20260417-m2').DemandPoint[]} demands
 * @param {import('./types.js?v=20260417-m2').ModeMix} modeMix
 * @param {import('./types.js?v=20260417-m2').RateCard} [rateCard]
 * @param {import('./types.js?v=20260417-m2').ServiceConfig} [serviceConfig]
 * @returns {import('./types.js?v=20260417-m2').LaneCost[]}
 */
 ...
 * @param {import('./types.js?v=20260417-m2').RateCard} [rateCard]
 * @param {import('./types.js?v=20260417-m2').ServiceConfig} [serviceConfig]
 * @returns {import('./types.js?v=20260417-m2').ScenarioResult}
 */
 ...
 * @param {import('./types.js?v=20260417-m2').ScenarioResult[]} scenarios
 * @returns {Array<import('./types.js?v=20260417-m2').ScenarioResult & { verdict: string, deltaPct: number }>}
 */
 ...
 * @param {import('./types.js?v=20260417-m2').RateCard} [rateCard]
 * @param {import('./types.js?v=20260417-m2').ServiceConfig} [serviceConfig]
 * @returns {{scenarios: import('./types.js?v=20260417-m2').ScenarioResult[], optimal: import('./types.js?v=20260417-m2').ScenarioResult|null} | null}
 */
 ...
 * @param {import('./types.js?v=20260417-m2').ScenarioResult[]} comparisonResults
