 ...
 * @param {import('./types.js?v=20260418-sA').ModeMix} modeMix
 * @param {import('./types.js?v=20260418-sA').RateCard} [rateCard]
 ...
 * @param {import('./types.js?v=20260418-sA').Facility[]} facilities
 * @param {import('./types.js?v=20260418-sA').DemandPoint[]} demands
 * @param {import('./types.js?v=20260418-sA').ModeMix} modeMix
 * @param {import('./types.js?v=20260418-sA').RateCard} [rateCard]
 * @param {import('./types.js?v=20260418-sA').ServiceConfig} [serviceConfig]
 * @returns {import('./types.js?v=20260418-sA').LaneCost[]}
 */
 ...
 * @param {import('./types.js?v=20260418-sA').RateCard} [rateCard]
 * @param {import('./types.js?v=20260418-sA').ServiceConfig} [serviceConfig]
 * @returns {import('./types.js?v=20260418-sA').ScenarioResult}
 */
 ...
 * @param {import('./types.js?v=20260418-sA').ScenarioResult[]} scenarios
 * @returns {Array<import('./types.js?v=20260418-sA').ScenarioResult & { verdict: string, deltaPct: number }>}
 */
 ...
 * @param {import('./types.js?v=20260418-sA').RateCard} [rateCard]
 * @param {import('./types.js?v=20260418-sA').ServiceConfig} [serviceConfig]
 * @returns {{scenarios: import('./types.js?v=20260418-sA').ScenarioResult[], optimal: import('./types.js?v=20260418-sA').ScenarioResult|null} | null}
 */
 ...
 * @param {import('./types.js?v=20260418-sA').ScenarioResult[]} comparisonResults
