 ...
 * @param {import('./types.js?v=20260418-sC').ModeMix} modeMix
 * @param {import('./types.js?v=20260418-sC').RateCard} [rateCard]
 ...
 * @param {import('./types.js?v=20260418-sC').Facility[]} facilities
 * @param {import('./types.js?v=20260418-sC').DemandPoint[]} demands
 * @param {import('./types.js?v=20260418-sC').ModeMix} modeMix
 * @param {import('./types.js?v=20260418-sC').RateCard} [rateCard]
 * @param {import('./types.js?v=20260418-sC').ServiceConfig} [serviceConfig]
 * @returns {import('./types.js?v=20260418-sC').LaneCost[]}
 */
 ...
 * @param {import('./types.js?v=20260418-sC').RateCard} [rateCard]
 * @param {import('./types.js?v=20260418-sC').ServiceConfig} [serviceConfig]
 * @returns {import('./types.js?v=20260418-sC').ScenarioResult}
 */
 ...
 * @param {import('./types.js?v=20260418-sC').ScenarioResult[]} scenarios
 * @returns {Array<import('./types.js?v=20260418-sC').ScenarioResult & { verdict: string, deltaPct: number }>}
 */
 ...
 * @param {import('./types.js?v=20260418-sC').RateCard} [rateCard]
 * @param {import('./types.js?v=20260418-sC').ServiceConfig} [serviceConfig]
 * @returns {{scenarios: import('./types.js?v=20260418-sC').ScenarioResult[], optimal: import('./types.js?v=20260418-sC').ScenarioResult|null} | null}
 */
 ...
 * @param {import('./types.js?v=20260418-sC').ScenarioResult[]} comparisonResults
