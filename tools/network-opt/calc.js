 ...
 * @param {import('./types.js?v=20260417-m3').ModeMix} modeMix
 * @param {import('./types.js?v=20260417-m3').RateCard} [rateCard]
 ...
 * @param {import('./types.js?v=20260417-m3').Facility[]} facilities
 * @param {import('./types.js?v=20260417-m3').DemandPoint[]} demands
 * @param {import('./types.js?v=20260417-m3').ModeMix} modeMix
 * @param {import('./types.js?v=20260417-m3').RateCard} [rateCard]
 * @param {import('./types.js?v=20260417-m3').ServiceConfig} [serviceConfig]
 * @returns {import('./types.js?v=20260417-m3').LaneCost[]}
 */
 ...
 * @param {import('./types.js?v=20260417-m3').RateCard} [rateCard]
 * @param {import('./types.js?v=20260417-m3').ServiceConfig} [serviceConfig]
 * @returns {import('./types.js?v=20260417-m3').ScenarioResult}
 */
 ...
 * @param {import('./types.js?v=20260417-m3').ScenarioResult[]} scenarios
 * @returns {Array<import('./types.js?v=20260417-m3').ScenarioResult & { verdict: string, deltaPct: number }>}
 */
 ...
 * @param {import('./types.js?v=20260417-m3').RateCard} [rateCard]
 * @param {import('./types.js?v=20260417-m3').ServiceConfig} [serviceConfig]
 * @returns {{scenarios: import('./types.js?v=20260417-m3').ScenarioResult[], optimal: import('./types.js?v=20260417-m3').ScenarioResult|null} | null}
 */
 ...
 * @param {import('./types.js?v=20260417-m3').ScenarioResult[]} comparisonResults
