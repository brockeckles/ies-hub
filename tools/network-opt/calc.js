 ...
 * @param {import('./types.js?v=20260417-m7').ModeMix} modeMix
 * @param {import('./types.js?v=20260417-m7').RateCard} [rateCard]
 ...
 * @param {import('./types.js?v=20260417-m7').Facility[]} facilities
 * @param {import('./types.js?v=20260417-m7').DemandPoint[]} demands
 * @param {import('./types.js?v=20260417-m7').ModeMix} modeMix
 * @param {import('./types.js?v=20260417-m7').RateCard} [rateCard]
 * @param {import('./types.js?v=20260417-m7').ServiceConfig} [serviceConfig]
 * @returns {import('./types.js?v=20260417-m7').LaneCost[]}
 */
 ...
 * @param {import('./types.js?v=20260417-m7').RateCard} [rateCard]
 * @param {import('./types.js?v=20260417-m7').ServiceConfig} [serviceConfig]
 * @returns {import('./types.js?v=20260417-m7').ScenarioResult}
 */
 ...
 * @param {import('./types.js?v=20260417-m7').ScenarioResult[]} scenarios
 * @returns {Array<import('./types.js?v=20260417-m7').ScenarioResult & { verdict: string, deltaPct: number }>}
 */
 ...
 * @param {import('./types.js?v=20260417-m7').RateCard} [rateCard]
 * @param {import('./types.js?v=20260417-m7').ServiceConfig} [serviceConfig]
 * @returns {{scenarios: import('./types.js?v=20260417-m7').ScenarioResult[], optimal: import('./types.js?v=20260417-m7').ScenarioResult|null} | null}
 */
 ...
 * @param {import('./types.js?v=20260417-m7').ScenarioResult[]} comparisonResults
