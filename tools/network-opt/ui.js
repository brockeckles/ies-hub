...
/** @type {import('./types.js?v=20260417-mG').Facility[]} */
let facilities = [];

/** @type {import('./types.js?v=20260417-mG').DemandPoint[]} */
let demands = [];

/** @type {import('./types.js?v=20260417-mG').ModeMix} */
let modeMix = { tlPct: 30, ltlPct: 40, parcelPct: 30 };

/** @type {import('./types.js?v=20260417-mG').RateCard} */
let rateCard = { ...calc.DEFAULT_RATES };

/** @type {import('./types.js?v=20260417-mG').ServiceConfig} */
let serviceConfig = { ...calc.DEFAULT_SERVICE };

/** @type {import('./types.js?v=20260417-mG').ScenarioResult[]} */
let scenarios = [];

/** @type {import('./types.js?v=20260417-mG').ScenarioResult|null} */
