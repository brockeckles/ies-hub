...
/** @type {import('./types.js?v=20260418-s2').Facility[]} */
let facilities = [];

/** @type {import('./types.js?v=20260418-s2').DemandPoint[]} */
let demands = [];

/** @type {import('./types.js?v=20260418-s2').ModeMix} */
let modeMix = { tlPct: 30, ltlPct: 40, parcelPct: 30 };

/** @type {import('./types.js?v=20260418-s2').RateCard} */
let rateCard = { ...calc.DEFAULT_RATES };

/** @type {import('./types.js?v=20260418-s2').ServiceConfig} */
let serviceConfig = { ...calc.DEFAULT_SERVICE };

/** @type {import('./types.js?v=20260418-s2').ScenarioResult[]} */
let scenarios = [];

/** @type {import('./types.js?v=20260418-s2').ScenarioResult|null} */
