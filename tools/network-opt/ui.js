...
/** @type {import('./types.js?v=20260417-p7').Facility[]} */
let facilities = [];

/** @type {import('./types.js?v=20260417-p7').DemandPoint[]} */
let demands = [];

/** @type {import('./types.js?v=20260417-p7').ModeMix} */
let modeMix = { tlPct: 30, ltlPct: 40, parcelPct: 30 };

/** @type {import('./types.js?v=20260417-p7').RateCard} */
let rateCard = { ...calc.DEFAULT_RATES };

/** @type {import('./types.js?v=20260417-p7').ServiceConfig} */
let serviceConfig = { ...calc.DEFAULT_SERVICE };

/** @type {import('./types.js?v=20260417-p7').ScenarioResult[]} */
let scenarios = [];

/** @type {import('./types.js?v=20260417-p7').ScenarioResult|null} */
