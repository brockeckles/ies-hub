...
/** @type {import('./types.js?v=20260417-mH').Facility[]} */
let facilities = [];

/** @type {import('./types.js?v=20260417-mH').DemandPoint[]} */
let demands = [];

/** @type {import('./types.js?v=20260417-mH').ModeMix} */
let modeMix = { tlPct: 30, ltlPct: 40, parcelPct: 30 };

/** @type {import('./types.js?v=20260417-mH').RateCard} */
let rateCard = { ...calc.DEFAULT_RATES };

/** @type {import('./types.js?v=20260417-mH').ServiceConfig} */
let serviceConfig = { ...calc.DEFAULT_SERVICE };

/** @type {import('./types.js?v=20260417-mH').ScenarioResult[]} */
let scenarios = [];

/** @type {import('./types.js?v=20260417-mH').ScenarioResult|null} */
