...
async function handleSaveNetopt() {
  try {
    ...
    if (!activeConfigId) {
      ...
      // sweep). Use the async showPrompt modal from shared/confirm-modal.js?v=20260601-prompt2.
  ...
  el.querySelector('#no-demand-csv-input')?.addEventListener('change', (e) => {
    ...
    reader.onload = async (ev) => {
      try {
        ...
        const cogCalc = await import('../center-of-gravity/calc.js?v=20260704-ux2c');
