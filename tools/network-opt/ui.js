...
/** @type {import('./types.js?v=20260417-mF').Facility[]} */
let facilities = [];

/** @type {import('./types.js?v=20260417-mF').DemandPoint[]} */
let demands = [];

/** @type {import('./types.js?v=20260417-mF').ModeMix} */
let modeMix = { tlPct: 30, ltlPct: 40, parcelPct: 30 };

/** @type {import('./types.js?v=20260417-mF').RateCard} */
let rateCard = { ...calc.DEFAULT_RATES };

/** @type {import('./types.js?v=20260417-mF').ServiceConfig} */
let serviceConfig = { ...calc.DEFAULT_SERVICE };

/** @type {import('./types.js?v=20260417-mF').ScenarioResult[]} */
let scenarios = [];

/** @type {import('./types.js?v=20260417-mF').ScenarioResult|null} */
