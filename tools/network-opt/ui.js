...
/** @type {import('./types.js?v=20260418-s8').Facility[]} */
let facilities = [];

/** @type {import('./types.js?v=20260418-s8').DemandPoint[]} */
let demands = [];

/** @type {import('./types.js?v=20260418-s8').ModeMix} */
let modeMix = { tlPct: 30, ltlPct: 40, parcelPct: 30 };

/** @type {import('./types.js?v=20260418-s8').RateCard} */
let rateCard = { ...calc.DEFAULT_RATES };

/** @type {import('./types.js?v=20260418-s8').ServiceConfig} */
let serviceConfig = { ...calc.DEFAULT_SERVICE };

/** @type {import('./types.js?v=20260418-s8').ScenarioResult[]} */
let scenarios = [];

/** @type {import('./types.js?v=20260418-s8').ScenarioResult|null} */
