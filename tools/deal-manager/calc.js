 ...
 * @param {import('./types.js?v=20260417-p2').Site} site
 * @returns {import('./types.js?v=20260417-p2').SiteFinancials}
 */
 ...
 * @param {import('./types.js?v=20260417-p2').Site[]} sites
 * @param {number} [contractTermYears]
 * @returns {import('./types.js?v=20260417-p2').DealFinancials}
 */
 ...
 * @param {import('./types.js?v=20260417-p2').DealFinancials} fin
 * @param {number} [years]
 * @param {number} [escalationPct]
 * @returns {import('./types.js?v=20260417-p2').MultiYearRow[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p2').DosStage[]} stages
 * @returns {import('./types.js?v=20260417-p2').StageProgress[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p2').StageProgress[]} progress
 ...
 * @param {import('./types.js?v=20260417-p2').SiteFinancials[]} siteFins
 * @returns {Array<import('./types.js?v=20260417-p2').SiteFinancials & { rank: number }>}
 */
 ...
 * @param {import('./types.js?v=20260417-p2').HoursEntry[]} hours
 * @returns {import('./types.js?v=20260417-p2').HoursSummary}
 */
 ...
 * @param {import('./types.js?v=20260417-p2').Task[]} tasks
 * @returns {import('./types.js?v=20260417-p2').TaskSummary}
 */
