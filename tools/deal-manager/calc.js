 ...
 * @param {import('./types.js?v=20260417-p4').Site} site
 * @returns {import('./types.js?v=20260417-p4').SiteFinancials}
 */
 ...
 * @param {import('./types.js?v=20260417-p4').Site[]} sites
 * @param {number} [contractTermYears]
 * @returns {import('./types.js?v=20260417-p4').DealFinancials}
 */
 ...
 * @param {import('./types.js?v=20260417-p4').DealFinancials} fin
 * @param {number} [years]
 * @param {number} [escalationPct]
 * @returns {import('./types.js?v=20260417-p4').MultiYearRow[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p4').DosStage[]} stages
 * @returns {import('./types.js?v=20260417-p4').StageProgress[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p4').StageProgress[]} progress
 ...
 * @param {import('./types.js?v=20260417-p4').SiteFinancials[]} siteFins
 * @returns {Array<import('./types.js?v=20260417-p4').SiteFinancials & { rank: number }>}
 */
 ...
 * @param {import('./types.js?v=20260417-p4').HoursEntry[]} hours
 * @returns {import('./types.js?v=20260417-p4').HoursSummary}
 */
 ...
 * @param {import('./types.js?v=20260417-p4').Task[]} tasks
 * @returns {import('./types.js?v=20260417-p4').TaskSummary}
 */
