 ...
 * @param {import('./types.js?v=20260417-p3').Site} site
 * @returns {import('./types.js?v=20260417-p3').SiteFinancials}
 */
 ...
 * @param {import('./types.js?v=20260417-p3').Site[]} sites
 * @param {number} [contractTermYears]
 * @returns {import('./types.js?v=20260417-p3').DealFinancials}
 */
 ...
 * @param {import('./types.js?v=20260417-p3').DealFinancials} fin
 * @param {number} [years]
 * @param {number} [escalationPct]
 * @returns {import('./types.js?v=20260417-p3').MultiYearRow[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p3').DosStage[]} stages
 * @returns {import('./types.js?v=20260417-p3').StageProgress[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p3').StageProgress[]} progress
 ...
 * @param {import('./types.js?v=20260417-p3').SiteFinancials[]} siteFins
 * @returns {Array<import('./types.js?v=20260417-p3').SiteFinancials & { rank: number }>}
 */
 ...
 * @param {import('./types.js?v=20260417-p3').HoursEntry[]} hours
 * @returns {import('./types.js?v=20260417-p3').HoursSummary}
 */
 ...
 * @param {import('./types.js?v=20260417-p3').Task[]} tasks
 * @returns {import('./types.js?v=20260417-p3').TaskSummary}
 */
