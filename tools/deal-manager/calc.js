 ...
 * @param {import('./types.js?v=20260418-sK').Site} site
 * @returns {import('./types.js?v=20260418-sK').SiteFinancials}
 */
 ...
 * @param {import('./types.js?v=20260418-sK').Site[]} sites
 * @param {number} [contractTermYears]
 * @returns {import('./types.js?v=20260418-sK').DealFinancials}
 */
 ...
 * @param {import('./types.js?v=20260418-sK').DealFinancials} fin
 * @param {number} [years]
 * @param {number} [escalationPct]
 * @returns {import('./types.js?v=20260418-sK').MultiYearRow[]}
 */
 ...
 * @param {import('./types.js?v=20260418-sK').DosStage[]} stages
 * @returns {import('./types.js?v=20260418-sK').StageProgress[]}
 */
 ...
 * @param {import('./types.js?v=20260418-sK').StageProgress[]} progress
 ...
 * @param {import('./types.js?v=20260418-sK').SiteFinancials[]} siteFins
 * @returns {Array<import('./types.js?v=20260418-sK').SiteFinancials & { rank: number }>}
 */
 ...
 * @param {import('./types.js?v=20260418-sK').HoursEntry[]} hours
 * @returns {import('./types.js?v=20260418-sK').HoursSummary}
 */
 ...
 * @param {import('./types.js?v=20260418-sK').Task[]} tasks
 * @returns {import('./types.js?v=20260418-sK').TaskSummary}
 */
