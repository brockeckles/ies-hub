 ...
 * @param {import('./types.js?v=20260418-sA').Site} site
 * @returns {import('./types.js?v=20260418-sA').SiteFinancials}
 */
 ...
 * @param {import('./types.js?v=20260418-sA').Site[]} sites
 * @param {number} [contractTermYears]
 * @returns {import('./types.js?v=20260418-sA').DealFinancials}
 */
 ...
 * @param {import('./types.js?v=20260418-sA').DealFinancials} fin
 * @param {number} [years]
 * @param {number} [escalationPct]
 * @returns {import('./types.js?v=20260418-sA').MultiYearRow[]}
 */
 ...
 * @param {import('./types.js?v=20260418-sA').DosStage[]} stages
 * @returns {import('./types.js?v=20260418-sA').StageProgress[]}
 */
 ...
 * @param {import('./types.js?v=20260418-sA').StageProgress[]} progress
 ...
 * @param {import('./types.js?v=20260418-sA').SiteFinancials[]} siteFins
 * @returns {Array<import('./types.js?v=20260418-sA').SiteFinancials & { rank: number }>}
 */
...
/** @type {import('./types.js?v=20260418-sA').Deal} */
...
/** @type {import('./types.js?v=20260418-sA').Site[]} */
 ...
 * @param {import('./types.js?v=20260418-sA').HoursEntry[]} hours
 * @returns {import('./types.js?v=20260418-sA').HoursSummary}
 */
 ...
 * @param {import('./types.js?v=20260418-sA').Task[]} tasks
 * @returns {import('./types.js?v=20260418-sA').TaskSummary}
 */
