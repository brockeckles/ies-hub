 ...
 * @param {import('./types.js?v=20260417-p6').Site} site
 * @returns {import('./types.js?v=20260417-p6').SiteFinancials}
 */
 ...
 * @param {import('./types.js?v=20260417-p6').Site[]} sites
 * @param {number} [contractTermYears]
 * @returns {import('./types.js?v=20260417-p6').DealFinancials}
 */
 ...
 * @param {import('./types.js?v=20260417-p6').DealFinancials} fin
 * @param {number} [years]
 * @param {number} [escalationPct]
 * @returns {import('./types.js?v=20260417-p6').MultiYearRow[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p6').DosStage[]} stages
 * @returns {import('./types.js?v=20260417-p6').StageProgress[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p6').StageProgress[]} progress
 ...
 * @param {import('./types.js?v=20260417-p6').SiteFinancials[]} siteFins
 * @returns {Array<import('./types.js?v=20260417-p6').SiteFinancials & { rank: number }>}
 */
...
/** @type {import('./types.js?v=20260417-p6').Deal} */
...
/** @type {import('./types.js?v=20260417-p6').Site[]} */
 ...
 * @param {import('./types.js?v=20260417-p6').HoursEntry[]} hours
 * @returns {import('./types.js?v=20260417-p6').HoursSummary}
 */
 ...
 * @param {import('./types.js?v=20260417-p6').Task[]} tasks
 * @returns {import('./types.js?v=20260417-p6').TaskSummary}
 */
