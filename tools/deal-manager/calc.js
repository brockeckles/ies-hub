 ...
 * @param {import('./types.js?v=20260417-p5').Site} site
 * @returns {import('./types.js?v=20260417-p5').SiteFinancials}
 */
 ...
 * @param {import('./types.js?v=20260417-p5').Site[]} sites
 * @param {number} [contractTermYears]
 * @returns {import('./types.js?v=20260417-p5').DealFinancials}
 */
 ...
 * @param {import('./types.js?v=20260417-p5').DealFinancials} fin
 * @param {number} [years]
 * @param {number} [escalationPct]
 * @returns {import('./types.js?v=20260417-p5').MultiYearRow[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p5').DosStage[]} stages
 * @returns {import('./types.js?v=20260417-p5').StageProgress[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p5').StageProgress[]} progress
 ...
 * @param {import('./types.js?v=20260417-p5').SiteFinancials[]} siteFins
 * @returns {Array<import('./types.js?v=20260417-p5').SiteFinancials & { rank: number }>}
 */
...
/** @type {import('./types.js?v=20260417-p5').Deal} */
...
/** @type {import('./types.js?v=20260417-p5').Site[]} */
 ...
 * @param {import('./types.js?v=20260417-p5').HoursEntry[]} hours
 * @returns {import('./types.js?v=20260417-p5').HoursSummary}
 */
 ...
 * @param {import('./types.js?v=20260417-p5').Task[]} tasks
 * @returns {import('./types.js?v=20260417-p5').TaskSummary}
 */
