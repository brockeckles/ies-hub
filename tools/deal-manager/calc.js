 ...
 * @param {import('./types.js?v=20260418-s2').Site} site
 * @returns {import('./types.js?v=20260418-s2').SiteFinancials}
 */
 ...
 * @param {import('./types.js?v=20260418-s2').Site[]} sites
 * @param {number} [contractTermYears]
 * @returns {import('./types.js?v=20260418-s2').DealFinancials}
 */
 ...
 * @param {import('./types.js?v=20260418-s2').DealFinancials} fin
 * @param {number} [years]
 * @param {number} [escalationPct]
 * @returns {import('./types.js?v=20260418-s2').MultiYearRow[]}
 */
 ...
 * @param {import('./types.js?v=20260418-s2').DosStage[]} stages
 * @returns {import('./types.js?v=20260418-s2').StageProgress[]}
 */
 ...
 * @param {import('./types.js?v=20260418-s2').StageProgress[]} progress
 ...
 * @param {import('./types.js?v=20260418-s2').SiteFinancials[]} siteFins
 * @returns {Array<import('./types.js?v=20260418-s2').SiteFinancials & { rank: number }>}
 */
...
/** @type {import('./types.js?v=20260418-s2').Deal} */
...
/** @type {import('./types.js?v=20260418-s2').Site[]} */
 ...
 * @param {import('./types.js?v=20260418-s2').HoursEntry[]} hours
 * @returns {import('./types.js?v=20260418-s2').HoursSummary}
 */
 ...
 * @param {import('./types.js?v=20260418-s2').Task[]} tasks
 * @returns {import('./types.js?v=20260418-s2').TaskSummary}
 */
