 ...
 * @param {import('./types.js?v=20260418-s8').Site} site
 * @returns {import('./types.js?v=20260418-s8').SiteFinancials}
 */
 ...
 * @param {import('./types.js?v=20260418-s8').Site[]} sites
 * @param {number} [contractTermYears]
 * @returns {import('./types.js?v=20260418-s8').DealFinancials}
 */
 ...
 * @param {import('./types.js?v=20260418-s8').DealFinancials} fin
 * @param {number} [years]
 * @param {number} [escalationPct]
 * @returns {import('./types.js?v=20260418-s8').MultiYearRow[]}
 */
 ...
 * @param {import('./types.js?v=20260418-s8').DosStage[]} stages
 * @returns {import('./types.js?v=20260418-s8').StageProgress[]}
 */
 ...
 * @param {import('./types.js?v=20260418-s8').StageProgress[]} progress
 ...
 * @param {import('./types.js?v=20260418-s8').SiteFinancials[]} siteFins
 * @returns {Array<import('./types.js?v=20260418-s8').SiteFinancials & { rank: number }>}
 */
...
/** @type {import('./types.js?v=20260418-s8').Deal} */
...
/** @type {import('./types.js?v=20260418-s8').Site[]} */
 ...
 * @param {import('./types.js?v=20260418-s8').HoursEntry[]} hours
 * @returns {import('./types.js?v=20260418-s8').HoursSummary}
 */
 ...
 * @param {import('./types.js?v=20260418-s8').Task[]} tasks
 * @returns {import('./types.js?v=20260418-s8').TaskSummary}
 */
