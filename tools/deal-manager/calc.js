 ...
 * @param {import('./types.js?v=20260418-s4').Site} site
 * @returns {import('./types.js?v=20260418-s4').SiteFinancials}
 */
 ...
 * @param {import('./types.js?v=20260418-s4').Site[]} sites
 * @param {number} [contractTermYears]
 * @returns {import('./types.js?v=20260418-s4').DealFinancials}
 */
 ...
 * @param {import('./types.js?v=20260418-s4').DealFinancials} fin
 * @param {number} [years]
 * @param {number} [escalationPct]
 * @returns {import('./types.js?v=20260418-s4').MultiYearRow[]}
 */
 ...
 * @param {import('./types.js?v=20260418-s4').DosStage[]} stages
 * @returns {import('./types.js?v=20260418-s4').StageProgress[]}
 */
 ...
 * @param {import('./types.js?v=20260418-s4').StageProgress[]} progress
 ...
 * @param {import('./types.js?v=20260418-s4').SiteFinancials[]} siteFins
 * @returns {Array<import('./types.js?v=20260418-s4').SiteFinancials & { rank: number }>}
 */
...
/** @type {import('./types.js?v=20260418-s4').Deal} */
...
/** @type {import('./types.js?v=20260418-s4').Site[]} */
 ...
 * @param {import('./types.js?v=20260418-s4').HoursEntry[]} hours
 * @returns {import('./types.js?v=20260418-s4').HoursSummary}
 */
 ...
 * @param {import('./types.js?v=20260418-s4').Task[]} tasks
 * @returns {import('./types.js?v=20260418-s4').TaskSummary}
 */
