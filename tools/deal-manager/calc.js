 ...
 * @param {import('./types.js?v=20260418-sH').Site} site
 * @returns {import('./types.js?v=20260418-sH').SiteFinancials}
 */
 ...
 * @param {import('./types.js?v=20260418-sH').Site[]} sites
 * @param {number} [contractTermYears]
 * @returns {import('./types.js?v=20260418-sH').DealFinancials}
 */
 ...
 * @param {import('./types.js?v=20260418-sH').DealFinancials} fin
 * @param {number} [years]
 * @param {number} [escalationPct]
 * @returns {import('./types.js?v=20260418-sH').MultiYearRow[]}
 */
 ...
 * @param {import('./types.js?v=20260418-sH').DosStage[]} stages
 * @returns {import('./types.js?v=20260418-sH').StageProgress[]}
 */
 ...
 * @param {import('./types.js?v=20260418-sH').StageProgress[]} progress
 ...
 * @param {import('./types.js?v=20260418-sH').SiteFinancials[]} siteFins
 * @returns {Array<import('./types.js?v=20260418-sH').SiteFinancials & { rank: number }>}
 */
...
/** @type {import('./types.js?v=20260418-sH').Deal} */
...
/** @type {import('./types.js?v=20260418-sH').Site[]} */
 ...
 * @param {import('./types.js?v=20260418-sH').HoursEntry[]} hours
 * @returns {import('./types.js?v=20260418-sH').HoursSummary}
 */
 ...
 * @param {import('./types.js?v=20260418-sH').Task[]} tasks
 * @returns {import('./types.js?v=20260418-sH').TaskSummary}
 */
