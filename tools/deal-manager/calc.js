 ...
 * @param {import('./types.js?v=20260418-s3').Site} site
 * @returns {import('./types.js?v=20260418-s3').SiteFinancials}
 */
 ...
 * @param {import('./types.js?v=20260418-s3').Site[]} sites
 * @param {number} [contractTermYears]
 * @returns {import('./types.js?v=20260418-s3').DealFinancials}
 */
 ...
 * @param {import('./types.js?v=20260418-s3').DealFinancials} fin
 * @param {number} [years]
 * @param {number} [escalationPct]
 * @returns {import('./types.js?v=20260418-s3').MultiYearRow[]}
 */
 ...
 * @param {import('./types.js?v=20260418-s3').DosStage[]} stages
 * @returns {import('./types.js?v=20260418-s3').StageProgress[]}
 */
 ...
 * @param {import('./types.js?v=20260418-s3').StageProgress[]} progress
 ...
 * @param {import('./types.js?v=20260418-s3').SiteFinancials[]} siteFins
 * @returns {Array<import('./types.js?v=20260418-s3').SiteFinancials & { rank: number }>}
 */
...
/** @type {import('./types.js?v=20260418-s3').Deal} */
...
/** @type {import('./types.js?v=20260418-s3').Site[]} */
 ...
 * @param {import('./types.js?v=20260418-s3').HoursEntry[]} hours
 * @returns {import('./types.js?v=20260418-s3').HoursSummary}
 */
 ...
 * @param {import('./types.js?v=20260418-s3').Task[]} tasks
 * @returns {import('./types.js?v=20260418-s3').TaskSummary}
 */
