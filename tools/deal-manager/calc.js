 ...
 * @param {import('./types.js?v=20260417-pc').Site} site
 * @returns {import('./types.js?v=20260417-pc').SiteFinancials}
 */
 ...
 * @param {import('./types.js?v=20260417-pc').Site[]} sites
 * @param {number} [contractTermYears]
 * @returns {import('./types.js?v=20260417-pc').DealFinancials}
 */
 ...
 * @param {import('./types.js?v=20260417-pc').DealFinancials} fin
 * @param {number} [years]
 * @param {number} [escalationPct]
 * @returns {import('./types.js?v=20260417-pc').MultiYearRow[]}
 */
 ...
 * @param {import('./types.js?v=20260417-pc').DosStage[]} stages
 * @returns {import('./types.js?v=20260417-pc').StageProgress[]}
 */
 ...
 * @param {import('./types.js?v=20260417-pc').StageProgress[]} progress
 ...
 * @param {import('./types.js?v=20260417-pc').SiteFinancials[]} siteFins
 * @returns {Array<import('./types.js?v=20260417-pc').SiteFinancials & { rank: number }>}
 */
...
/** @type {import('./types.js?v=20260417-pc').Deal} */
...
/** @type {import('./types.js?v=20260417-pc').Site[]} */
 ...
 * @param {import('./types.js?v=20260417-pc').HoursEntry[]} hours
 * @returns {import('./types.js?v=20260417-pc').HoursSummary}
 */
 ...
 * @param {import('./types.js?v=20260417-pc').Task[]} tasks
 * @returns {import('./types.js?v=20260417-pc').TaskSummary}
 */
