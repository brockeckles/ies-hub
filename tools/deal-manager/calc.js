 ...
 * @param {import('./types.js?v=20260418-s1').Site} site
 * @returns {import('./types.js?v=20260418-s1').SiteFinancials}
 */
 ...
 * @param {import('./types.js?v=20260418-s1').Site[]} sites
 * @param {number} [contractTermYears]
 * @returns {import('./types.js?v=20260418-s1').DealFinancials}
 */
 ...
 * @param {import('./types.js?v=20260418-s1').DealFinancials} fin
 * @param {number} [years]
 * @param {number} [escalationPct]
 * @returns {import('./types.js?v=20260418-s1').MultiYearRow[]}
 */
 ...
 * @param {import('./types.js?v=20260418-s1').DosStage[]} stages
 * @returns {import('./types.js?v=20260418-s1').StageProgress[]}
 */
 ...
 * @param {import('./types.js?v=20260418-s1').StageProgress[]} progress
 ...
 * @param {import('./types.js?v=20260418-s1').SiteFinancials[]} siteFins
 * @returns {Array<import('./types.js?v=20260418-s1').SiteFinancials & { rank: number }>}
 */
...
/** @type {import('./types.js?v=20260418-s1').Deal} */
...
/** @type {import('./types.js?v=20260418-s1').Site[]} */
 ...
 * @param {import('./types.js?v=20260418-s1').HoursEntry[]} hours
 * @returns {import('./types.js?v=20260418-s1').HoursSummary}
 */
 ...
 * @param {import('./types.js?v=20260418-s1').Task[]} tasks
 * @returns {import('./types.js?v=20260418-s1').TaskSummary}
 */
