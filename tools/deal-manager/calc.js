 ...
 * @param {import('./types.js?v=20260417-p8').Site} site
 * @returns {import('./types.js?v=20260417-p8').SiteFinancials}
 */
 ...
 * @param {import('./types.js?v=20260417-p8').Site[]} sites
 * @param {number} [contractTermYears]
 * @returns {import('./types.js?v=20260417-p8').DealFinancials}
 */
 ...
 * @param {import('./types.js?v=20260417-p8').DealFinancials} fin
 * @param {number} [years]
 * @param {number} [escalationPct]
 * @returns {import('./types.js?v=20260417-p8').MultiYearRow[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p8').DosStage[]} stages
 * @returns {import('./types.js?v=20260417-p8').StageProgress[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p8').StageProgress[]} progress
 ...
 * @param {import('./types.js?v=20260417-p8').SiteFinancials[]} siteFins
 * @returns {Array<import('./types.js?v=20260417-p8').SiteFinancials & { rank: number }>}
 */
...
/** @type {import('./types.js?v=20260417-p8').Deal} */
...
/** @type {import('./types.js?v=20260417-p8').Site[]} */
 ...
 * @param {import('./types.js?v=20260417-p8').HoursEntry[]} hours
 * @returns {import('./types.js?v=20260417-p8').HoursSummary}
 */
 ...
 * @param {import('./types.js?v=20260417-p8').Task[]} tasks
 * @returns {import('./types.js?v=20260417-p8').TaskSummary}
 */
