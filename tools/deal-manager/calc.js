 ...
 * @param {import('./types.js?v=20260418-s6').Site} site
 * @returns {import('./types.js?v=20260418-s6').SiteFinancials}
 */
 ...
 * @param {import('./types.js?v=20260418-s6').Site[]} sites
 * @param {number} [contractTermYears]
 * @returns {import('./types.js?v=20260418-s6').DealFinancials}
 */
 ...
 * @param {import('./types.js?v=20260418-s6').DealFinancials} fin
 * @param {number} [years]
 * @param {number} [escalationPct]
 * @returns {import('./types.js?v=20260418-s6').MultiYearRow[]}
 */
 ...
 * @param {import('./types.js?v=20260418-s6').DosStage[]} stages
 * @returns {import('./types.js?v=20260418-s6').StageProgress[]}
 */
 ...
 * @param {import('./types.js?v=20260418-s6').StageProgress[]} progress
 ...
 * @param {import('./types.js?v=20260418-s6').SiteFinancials[]} siteFins
 * @returns {Array<import('./types.js?v=20260418-s6').SiteFinancials & { rank: number }>}
 */
...
/** @type {import('./types.js?v=20260418-s6').Deal} */
...
/** @type {import('./types.js?v=20260418-s6').Site[]} */
 ...
 * @param {import('./types.js?v=20260418-s6').HoursEntry[]} hours
 * @returns {import('./types.js?v=20260418-s6').HoursSummary}
 */
 ...
 * @param {import('./types.js?v=20260418-s6').Task[]} tasks
 * @returns {import('./types.js?v=20260418-s6').TaskSummary}
 */
