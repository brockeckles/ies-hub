 ...
 * @param {import('./types.js?v=20260418-s9').Site} site
 * @returns {import('./types.js?v=20260418-s9').SiteFinancials}
 */
 ...
 * @param {import('./types.js?v=20260418-s9').Site[]} sites
 * @param {number} [contractTermYears]
 * @returns {import('./types.js?v=20260418-s9').DealFinancials}
 */
 ...
 * @param {import('./types.js?v=20260418-s9').DealFinancials} fin
 * @param {number} [years]
 * @param {number} [escalationPct]
 * @returns {import('./types.js?v=20260418-s9').MultiYearRow[]}
 */
 ...
 * @param {import('./types.js?v=20260418-s9').DosStage[]} stages
 * @returns {import('./types.js?v=20260418-s9').StageProgress[]}
 */
 ...
 * @param {import('./types.js?v=20260418-s9').StageProgress[]} progress
 ...
 * @param {import('./types.js?v=20260418-s9').SiteFinancials[]} siteFins
 * @returns {Array<import('./types.js?v=20260418-s9').SiteFinancials & { rank: number }>}
 */
...
/** @type {import('./types.js?v=20260418-s9').Deal} */
...
/** @type {import('./types.js?v=20260418-s9').Site[]} */
 ...
 * @param {import('./types.js?v=20260418-s9').HoursEntry[]} hours
 * @returns {import('./types.js?v=20260418-s9').HoursSummary}
 */
 ...
 * @param {import('./types.js?v=20260418-s9').Task[]} tasks
 * @returns {import('./types.js?v=20260418-s9').TaskSummary}
 */
