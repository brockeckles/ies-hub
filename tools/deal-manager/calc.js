 ...
 * @param {import('./types.js?v=20260417-p7').Site} site
 * @returns {import('./types.js?v=20260417-p7').SiteFinancials}
 */
 ...
 * @param {import('./types.js?v=20260417-p7').Site[]} sites
 * @param {number} [contractTermYears]
 * @returns {import('./types.js?v=20260417-p7').DealFinancials}
 */
 ...
 * @param {import('./types.js?v=20260417-p7').DealFinancials} fin
 * @param {number} [years]
 * @param {number} [escalationPct]
 * @returns {import('./types.js?v=20260417-p7').MultiYearRow[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p7').DosStage[]} stages
 * @returns {import('./types.js?v=20260417-p7').StageProgress[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p7').StageProgress[]} progress
 ...
 * @param {import('./types.js?v=20260417-p7').SiteFinancials[]} siteFins
 * @returns {Array<import('./types.js?v=20260417-p7').SiteFinancials & { rank: number }>}
 */
...
/** @type {import('./types.js?v=20260417-p7').Deal} */
...
/** @type {import('./types.js?v=20260417-p7').Site[]} */
 ...
 * @param {import('./types.js?v=20260417-p7').HoursEntry[]} hours
 * @returns {import('./types.js?v=20260417-p7').HoursSummary}
 */
 ...
 * @param {import('./types.js?v=20260417-p7').Task[]} tasks
 * @returns {import('./types.js?v=20260417-p7').TaskSummary}
 */
