 ...
 * @param {import('./types.js?v=20260418-sG').Site} site
 * @returns {import('./types.js?v=20260418-sG').SiteFinancials}
 */
 ...
 * @param {import('./types.js?v=20260418-sG').Site[]} sites
 * @param {number} [contractTermYears]
 * @returns {import('./types.js?v=20260418-sG').DealFinancials}
 */
 ...
 * @param {import('./types.js?v=20260418-sG').DealFinancials} fin
 * @param {number} [years]
 * @param {number} [escalationPct]
 * @returns {import('./types.js?v=20260418-sG').MultiYearRow[]}
 */
 ...
 * @param {import('./types.js?v=20260418-sG').DosStage[]} stages
 * @returns {import('./types.js?v=20260418-sG').StageProgress[]}
 */
 ...
 * @param {import('./types.js?v=20260418-sG').StageProgress[]} progress
 ...
 * @param {import('./types.js?v=20260418-sG').SiteFinancials[]} siteFins
 * @returns {Array<import('./types.js?v=20260418-sG').SiteFinancials & { rank: number }>}
 */
...
/** @type {import('./types.js?v=20260418-sG').Deal} */
...
/** @type {import('./types.js?v=20260418-sG').Site[]} */
 ...
 * @param {import('./types.js?v=20260418-sG').HoursEntry[]} hours
 * @returns {import('./types.js?v=20260418-sG').HoursSummary}
 */
 ...
 * @param {import('./types.js?v=20260418-sG').Task[]} tasks
 * @returns {import('./types.js?v=20260418-sG').TaskSummary}
 */
