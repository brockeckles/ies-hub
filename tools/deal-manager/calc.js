 ...
 * @param {import('./types.js?v=20260417-p1').Site} site
 * @returns {import('./types.js?v=20260417-p1').SiteFinancials}
 */
 ...
 * @param {import('./types.js?v=20260417-p1').Site[]} sites
 * @param {number} [contractTermYears]
 * @returns {import('./types.js?v=20260417-p1').DealFinancials}
 */
 ...
 * @param {import('./types.js?v=20260417-p1').DealFinancials} fin
 * @param {number} [years]
 * @param {number} [escalationPct]
 * @returns {import('./types.js?v=20260417-p1').MultiYearRow[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p1').DosStage[]} stages
 * @returns {import('./types.js?v=20260417-p1').StageProgress[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p1').StageProgress[]} progress
 ...
 * @param {import('./types.js?v=20260417-p1').SiteFinancials[]} siteFins
 * @returns {Array<import('./types.js?v=20260417-p1').SiteFinancials & { rank: number }>}
 */
 ...
 * @param {import('./types.js?v=20260417-p1').HoursEntry[]} hours
 * @returns {import('./types.js?v=20260417-p1').HoursSummary}
 */
 ...
 * @param {import('./types.js?v=20260417-p1').Task[]} tasks
 * @returns {import('./types.js?v=20260417-p1').TaskSummary}
 */
