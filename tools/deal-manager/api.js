...
import { db } from '../../shared/supabase.js?v=20260417-pc';
...
/**
 * List all deals.
 * @returns {Promise<import('./types.js?v=20260417-pc').Deal[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260417-pc').Deal|null>}
 */
 ...
 * @param {import('./types.js?v=20260417-pc').Deal} deal
 * @returns {Promise<import('./types.js?v=20260417-pc').Deal>}
 */
 ...
 * @param {string} dealId
 * @returns {Promise<import('./types.js?v=20260417-pc').Site[]>}
 */
 ...
 * @param {object} row
 * @returns {import('./types.js?v=20260417-pc').Site}
 */
 ...
 * @param {string} dealId
 * @returns {Promise<import('./types.js?v=20260417-pc').DosStage[]>}
 */
 ...
 * @param {string} dealId
 * @returns {Promise<import('./types.js?v=20260417-pc').DealArtifact[]>}
 */
 ...
 * @returns {Promise<{ deals: import('./types.js?v=20260417-pc').Deal[] }>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260417-pc').HoursEntry[]>}
 */
...
/**
 * Log new hours entry.
 * @param {import('./types.js?v=20260417-pc').HoursEntry} entry
 * @returns {Promise<import('./types.js?v=20260417-pc').HoursEntry>}
 */
 ...
 * @param {string} opportunityId
 * @returns {Promise<import('./types.js?v=20260417-pc').Task[]>}
 */
...
/**
 * Create a new task.
 * @param {import('./types.js?v=20260417-pc').Task} task
 * @returns {Promise<import('./types.js?v=20260417-pc').Task>}
 */
 ...
 * Update a task.
 * @param {string} id
 * @param {Partial<import('./types.js?v=20260417-pc').Task>} fields
 * @returns {Promise<void>}
 */
 ...
 * @param {string} opportunityId
 * @returns {Promise<import('./types.js?v=20260417-pc').WeeklyUpdate[]>}
 */
...
/**
 * Create a new update.
 * @param {import('./types.js?v=20260417-pc').WeeklyUpdate} update
 * @returns {Promise<import('./types.js?v=20260417-pc').WeeklyUpdate>}
 */
