...
import { db } from '../../shared/supabase.js?v=20260418-s2';
...
/**
 * List all deals.
 * @returns {Promise<import('./types.js?v=20260418-s2').Deal[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260418-s2').Deal|null>}
 */
 ...
 * @param {import('./types.js?v=20260418-s2').Deal} deal
 * @returns {Promise<import('./types.js?v=20260418-s2').Deal>}
 */
 ...
 * @param {string} dealId
 * @returns {Promise<import('./types.js?v=20260418-s2').Site[]>}
 */
 ...
 * @param {object} row
 * @returns {import('./types.js?v=20260418-s2').Site}
 */
 ...
 * @param {string} dealId
 * @returns {Promise<import('./types.js?v=20260418-s2').DosStage[]>}
 */
 ...
 * @param {string} dealId
 * @returns {Promise<import('./types.js?v=20260418-s2').DealArtifact[]>}
 */
 ...
 * @returns {Promise<{ deals: import('./types.js?v=20260418-s2').Deal[] }>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260418-s2').HoursEntry[]>}
 */
...
/**
 * Log new hours entry.
 * @param {import('./types.js?v=20260418-s2').HoursEntry} entry
 * @returns {Promise<import('./types.js?v=20260418-s2').HoursEntry>}
 */
 ...
 * @param {string} opportunityId
 * @returns {Promise<import('./types.js?v=20260418-s2').Task[]>}
 */
...
/**
 * Create a new task.
 * @param {import('./types.js?v=20260418-s2').Task} task
 * @returns {Promise<import('./types.js?v=20260418-s2').Task>}
 */
 ...
 * Update a task.
 * @param {string} id
 * @param {Partial<import('./types.js?v=20260418-s2').Task>} fields
 * @returns {Promise<void>}
 */
 ...
 * @param {string} opportunityId
 * @returns {Promise<import('./types.js?v=20260418-s2').WeeklyUpdate[]>}
 */
...
/**
 * Create a new update.
 * @param {import('./types.js?v=20260418-s2').WeeklyUpdate} update
 * @returns {Promise<import('./types.js?v=20260418-s2').WeeklyUpdate>}
 */
