...
import { db } from '../../shared/supabase.js?v=20260417-p8';
...
/**
 * List all deals.
 * @returns {Promise<import('./types.js?v=20260417-p8').Deal[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260417-p8').Deal|null>}
 */
 ...
 * @param {import('./types.js?v=20260417-p8').Deal} deal
 * @returns {Promise<import('./types.js?v=20260417-p8').Deal>}
 */
 ...
 * @param {string} dealId
 * @returns {Promise<import('./types.js?v=20260417-p8').Site[]>}
 */
 ...
 * @param {object} row
 * @returns {import('./types.js?v=20260417-p8').Site}
 */
 ...
 * @param {string} dealId
 * @returns {Promise<import('./types.js?v=20260417-p8').DosStage[]>}
 */
 ...
 * @param {string} dealId
 * @returns {Promise<import('./types.js?v=20260417-p8').DealArtifact[]>}
 */
 ...
 * @returns {Promise<{ deals: import('./types.js?v=20260417-p8').Deal[] }>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260417-p8').HoursEntry[]>}
 */
...
/**
 * Log new hours entry.
 * @param {import('./types.js?v=20260417-p8').HoursEntry} entry
 * @returns {Promise<import('./types.js?v=20260417-p8').HoursEntry>}
 */
 ...
 * @param {string} opportunityId
 * @returns {Promise<import('./types.js?v=20260417-p8').Task[]>}
 */
...
/**
 * Create a new task.
 * @param {import('./types.js?v=20260417-p8').Task} task
 * @returns {Promise<import('./types.js?v=20260417-p8').Task>}
 */
 ...
 * Update a task.
 * @param {string} id
 * @param {Partial<import('./types.js?v=20260417-p8').Task>} fields
 * @returns {Promise<void>}
 */
 ...
 * @param {string} opportunityId
 * @returns {Promise<import('./types.js?v=20260417-p8').WeeklyUpdate[]>}
 */
...
/**
 * Create a new update.
 * @param {import('./types.js?v=20260417-p8').WeeklyUpdate} update
 * @returns {Promise<import('./types.js?v=20260417-p8').WeeklyUpdate>}
 */
