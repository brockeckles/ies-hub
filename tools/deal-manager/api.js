...
import { db } from '../../shared/supabase.js?v=20260417-mG';
...
/**
 * List all deals.
 * @returns {Promise<import('./types.js?v=20260417-mG').Deal[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260417-mG').Deal|null>}
 */
 ...
 * @param {import('./types.js?v=20260417-mG').Deal} deal
 * @returns {Promise<import('./types.js?v=20260417-mG').Deal>}
 */
 ...
 * @param {string} dealId
 * @returns {Promise<import('./types.js?v=20260417-mG').Site[]>}
 */
 ...
 * @param {object} row
 * @returns {import('./types.js?v=20260417-mG').Site}
 */
 ...
 * @param {string} dealId
 * @returns {Promise<import('./types.js?v=20260417-mG').DosStage[]>}
 */
 ...
 * @param {string} dealId
 * @returns {Promise<import('./types.js?v=20260417-mG').DealArtifact[]>}
 */
 ...
 * @returns {Promise<{ deals: import('./types.js?v=20260417-mG').Deal[] }>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260417-mG').HoursEntry[]>}
 */
...
/**
 * Log new hours entry.
 * @param {import('./types.js?v=20260417-mG').HoursEntry} entry
 * @returns {Promise<import('./types.js?v=20260417-mG').HoursEntry>}
 */
 ...
 * @param {string} opportunityId
 * @returns {Promise<import('./types.js?v=20260417-mG').Task[]>}
 */
...
/**
 * Create a new task.
 * @param {import('./types.js?v=20260417-mG').Task} task
 * @returns {Promise<import('./types.js?v=20260417-mG').Task>}
 */
 ...
 * Update a task.
 * @param {string} id
 * @param {Partial<import('./types.js?v=20260417-mG').Task>} fields
 * @returns {Promise<void>}
 */
 ...
 * @param {string} opportunityId
 * @returns {Promise<import('./types.js?v=20260417-mG').WeeklyUpdate[]>}
 */
...
/**
 * Create a new update.
 * @param {import('./types.js?v=20260417-mG').WeeklyUpdate} update
 * @returns {Promise<import('./types.js?v=20260417-mG').WeeklyUpdate>}
 */
