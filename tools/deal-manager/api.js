...
import { db } from '../../shared/supabase.js?v=20260417-pb';
...
/**
 * List all deals.
 * @returns {Promise<import('./types.js?v=20260417-pb').Deal[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260417-pb').Deal|null>}
 */
 ...
 * @param {import('./types.js?v=20260417-pb').Deal} deal
 * @returns {Promise<import('./types.js?v=20260417-pb').Deal>}
 */
 ...
 * @param {string} dealId
 * @returns {Promise<import('./types.js?v=20260417-pb').Site[]>}
 */
 ...
 * @param {object} row
 * @returns {import('./types.js?v=20260417-pb').Site}
 */
 ...
 * @param {string} dealId
 * @returns {Promise<import('./types.js?v=20260417-pb').DosStage[]>}
 */
 ...
 * @param {string} dealId
 * @returns {Promise<import('./types.js?v=20260417-pb').DealArtifact[]>}
 */
 ...
 * @returns {Promise<{ deals: import('./types.js?v=20260417-pb').Deal[] }>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260417-pb').HoursEntry[]>}
 */
...
/**
 * Log new hours entry.
 * @param {import('./types.js?v=20260417-pb').HoursEntry} entry
 * @returns {Promise<import('./types.js?v=20260417-pb').HoursEntry>}
 */
 ...
 * @param {string} opportunityId
 * @returns {Promise<import('./types.js?v=20260417-pb').Task[]>}
 */
...
/**
 * Create a new task.
 * @param {import('./types.js?v=20260417-pb').Task} task
 * @returns {Promise<import('./types.js?v=20260417-pb').Task>}
 */
 ...
 * Update a task.
 * @param {string} id
 * @param {Partial<import('./types.js?v=20260417-pb').Task>} fields
 * @returns {Promise<void>}
 */
 ...
 * @param {string} opportunityId
 * @returns {Promise<import('./types.js?v=20260417-pb').WeeklyUpdate[]>}
 */
...
/**
 * Create a new update.
 * @param {import('./types.js?v=20260417-pb').WeeklyUpdate} update
 * @returns {Promise<import('./types.js?v=20260417-pb').WeeklyUpdate>}
 */
