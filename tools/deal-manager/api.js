...
/**
 * List all deals.
 * @returns {Promise<import('./types.js?v=20260417-m9').Deal[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260417-m9').Deal|null>}
 */
 ...
 * @param {import('./types.js?v=20260417-m9').Deal} deal
 * @returns {Promise<import('./types.js?v=20260417-m9').Deal>}
 */
 ...
 * @param {string} dealId
 * @returns {Promise<import('./types.js?v=20260417-m9').Site[]>}
 */
 ...
 * @param {object} row
 * @returns {import('./types.js?v=20260417-m9').Site}
 */
 ...
 * @param {string} dealId
 * @returns {Promise<import('./types.js?v=20260417-m9').DosStage[]>}
 */
 ...
 * @param {string} dealId
 * @returns {Promise<import('./types.js?v=20260417-m9').DealArtifact[]>}
 */
 ...
 * @returns {Promise<{ deals: import('./types.js?v=20260417-m9').Deal[] }>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260417-m9').HoursEntry[]>}
 */
...
/**
 * Log new hours entry.
 * @param {import('./types.js?v=20260417-m9').HoursEntry} entry
 * @returns {Promise<import('./types.js?v=20260417-m9').HoursEntry>}
 */
 ...
 * @param {string} opportunityId
 * @returns {Promise<import('./types.js?v=20260417-m9').Task[]>}
 */
...
/**
 * Create a new task.
 * @param {import('./types.js?v=20260417-m9').Task} task
 * @returns {Promise<import('./types.js?v=20260417-m9').Task>}
 */
 ...
 * Update a task.
 * @param {string} id
 * @param {Partial<import('./types.js?v=20260417-m9').Task>} fields
 * @returns {Promise<void>}
 */
 ...
 * @param {string} opportunityId
 * @returns {Promise<import('./types.js?v=20260417-m9').WeeklyUpdate[]>}
 */
...
/**
 * Create a new update.
 * @param {import('./types.js?v=20260417-m9').WeeklyUpdate} update
 * @returns {Promise<import('./types.js?v=20260417-m9').WeeklyUpdate>}
 */
