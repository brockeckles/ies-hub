...
import { db } from '../../shared/supabase.js?v=20260418-s5';
...
/**
 * List all deals.
 * @returns {Promise<import('./types.js?v=20260418-s5').Deal[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260418-s5').Deal|null>}
 */
 ...
 * @param {import('./types.js?v=20260418-s5').Deal} deal
 * @returns {Promise<import('./types.js?v=20260418-s5').Deal>}
 */
 ...
 * @param {string} dealId
 * @returns {Promise<import('./types.js?v=20260418-s5').Site[]>}
 */
 ...
 * @param {object} row
 * @returns {import('./types.js?v=20260418-s5').Site}
 */
 ...
 * @param {string} dealId
 * @returns {Promise<import('./types.js?v=20260418-s5').DosStage[]>}
 */
 ...
 * @param {string} dealId
 * @returns {Promise<import('./types.js?v=20260418-s5').DealArtifact[]>}
 */
 ...
 * @returns {Promise<{ deals: import('./types.js?v=20260418-s5').Deal[] }>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260418-s5').HoursEntry[]>}
 */
...
/**
 * Log new hours entry.
 * @param {import('./types.js?v=20260418-s5').HoursEntry} entry
 * @returns {Promise<import('./types.js?v=20260418-s5').HoursEntry>}
 */
 ...
 * @param {string} opportunityId
 * @returns {Promise<import('./types.js?v=20260418-s5').Task[]>}
 */
...
/**
 * Create a new task.
 * @param {import('./types.js?v=20260418-s5').Task} task
 * @returns {Promise<import('./types.js?v=20260418-s5').Task>}
 */
 ...
 * Update a task.
 * @param {string} id
 * @param {Partial<import('./types.js?v=20260418-s5').Task>} fields
 * @returns {Promise<void>}
 */
 ...
 * @param {string} opportunityId
 * @returns {Promise<import('./types.js?v=20260418-s5').WeeklyUpdate[]>}
 */
...
/**
 * Create a new update.
 * @param {import('./types.js?v=20260418-s5').WeeklyUpdate} update
 * @returns {Promise<import('./types.js?v=20260418-s5').WeeklyUpdate>}
 */
