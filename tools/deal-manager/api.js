...
import { db } from '../../shared/supabase.js?v=20260418-sA';
...
/**
 * List all deals.
 * @returns {Promise<import('./types.js?v=20260418-sA').Deal[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260418-sA').Deal|null>}
 */
 ...
 * @param {import('./types.js?v=20260418-sA').Deal} deal
 * @returns {Promise<import('./types.js?v=20260418-sA').Deal>}
 */
 ...
 * @param {string} dealId
 * @returns {Promise<import('./types.js?v=20260418-sA').Site[]>}
 */
 ...
 * @param {object} row
 * @returns {import('./types.js?v=20260418-sA').Site}
 */
 ...
 * @param {string} dealId
 * @returns {Promise<import('./types.js?v=20260418-sA').DosStage[]>}
 */
 ...
 * @param {string} dealId
 * @returns {Promise<import('./types.js?v=20260418-sA').DealArtifact[]>}
 */
 ...
 * @returns {Promise<{ deals: import('./types.js?v=20260418-sA').Deal[] }>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260418-sA').HoursEntry[]>}
 */
...
/**
 * Log new hours entry.
 * @param {import('./types.js?v=20260418-sA').HoursEntry} entry
 * @returns {Promise<import('./types.js?v=20260418-sA').HoursEntry>}
 */
 ...
 * @param {string} opportunityId
 * @returns {Promise<import('./types.js?v=20260418-sA').Task[]>}
 */
...
/**
 * Create a new task.
 * @param {import('./types.js?v=20260418-sA').Task} task
 * @returns {Promise<import('./types.js?v=20260418-sA').Task>}
 */
 ...
 * Update a task.
 * @param {string} id
 * @param {Partial<import('./types.js?v=20260418-sA').Task>} fields
 * @returns {Promise<void>}
 */
 ...
 * @param {string} opportunityId
 * @returns {Promise<import('./types.js?v=20260418-sA').WeeklyUpdate[]>}
 */
...
/**
 * Create a new update.
 * @param {import('./types.js?v=20260418-sA').WeeklyUpdate} update
 * @returns {Promise<import('./types.js?v=20260418-sA').WeeklyUpdate>}
 */
