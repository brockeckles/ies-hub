...
/**
 * List all deals.
 * @returns {Promise<import('./types.js?v=20260418-s3').Deal[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260418-s3').Deal|null>}
 */
 ...
 * @param {import('./types.js?v=20260418-s3').Deal} deal
 * @returns {Promise<import('./types.js?v=20260418-s3').Deal>}
 */
 ...
 * @param {string} dealId
 * @returns {Promise<import('./types.js?v=20260418-s3').Site[]>}
 */
 ...
 * @param {object} row
 * @returns {import('./types.js?v=20260418-s3').Site}
 */
 ...
 * @param {string} dealId
 * @returns {Promise<import('./types.js?v=20260418-s3').DosStage[]>}
 */
 ...
 * @param {string} dealId
 * @returns {Promise<import('./types.js?v=20260418-s3').DealArtifact[]>}
 */
 ...
 * @returns {Promise<{ deals: import('./types.js?v=20260418-s3').Deal[] }>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260418-s3').HoursEntry[]>}
 */
...
/**
 * Log new hours entry.
 * @param {import('./types.js?v=20260418-s3').HoursEntry} entry
 * @returns {Promise<import('./types.js?v=20260418-s3').HoursEntry>}
 */
 ...
 * @param {string} opportunityId
 * @returns {Promise<import('./types.js?v=20260418-s3').Task[]>}
 */
...
/**
 * Create a new task.
 * @param {import('./types.js?v=20260418-s3').Task} task
 * @returns {Promise<import('./types.js?v=20260418-s3').Task>}
 */
 ...
 * Update a task.
 * @param {string} id
 * @param {Partial<import('./types.js?v=20260418-s3').Task>} fields
 * @returns {Promise<void>}
 */
 ...
 * @param {string} opportunityId
 * @returns {Promise<import('./types.js?v=20260418-s3').WeeklyUpdate[]>}
 */
...
/**
 * Create a new update.
 * @param {import('./types.js?v=20260418-s3').WeeklyUpdate} update
 * @returns {Promise<import('./types.js?v=20260418-s3').WeeklyUpdate>}
 */
