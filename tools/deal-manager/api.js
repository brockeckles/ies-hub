...
import { db } from '../../shared/supabase.js?v=20260417-mH';
...
/**
 * List all deals.
 * @returns {Promise<import('./types.js?v=20260417-mH').Deal[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260417-mH').Deal|null>}
 */
 ...
 * @param {import('./types.js?v=20260417-mH').Deal} deal
 * @returns {Promise<import('./types.js?v=20260417-mH').Deal>}
 */
 ...
 * @param {string} dealId
 * @returns {Promise<import('./types.js?v=20260417-mH').Site[]>}
 */
 ...
 * @param {object} row
 * @returns {import('./types.js?v=20260417-mH').Site}
 */
 ...
 * @param {string} dealId
 * @returns {Promise<import('./types.js?v=20260417-mH').DosStage[]>}
 */
 ...
 * @param {string} dealId
 * @returns {Promise<import('./types.js?v=20260417-mH').DealArtifact[]>}
 */
 ...
 * @returns {Promise<{ deals: import('./types.js?v=20260417-mH').Deal[] }>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260417-mH').HoursEntry[]>}
 */
...
/**
 * Log new hours entry.
 * @param {import('./types.js?v=20260417-mH').HoursEntry} entry
 * @returns {Promise<import('./types.js?v=20260417-mH').HoursEntry>}
 */
 ...
 * @param {string} opportunityId
 * @returns {Promise<import('./types.js?v=20260417-mH').Task[]>}
 */
...
/**
 * Create a new task.
 * @param {import('./types.js?v=20260417-mH').Task} task
 * @returns {Promise<import('./types.js?v=20260417-mH').Task>}
 */
 ...
 * Update a task.
 * @param {string} id
 * @param {Partial<import('./types.js?v=20260417-mH').Task>} fields
 * @returns {Promise<void>}
 */
 ...
 * @param {string} opportunityId
 * @returns {Promise<import('./types.js?v=20260417-mH').WeeklyUpdate[]>}
 */
...
/**
 * Create a new update.
 * @param {import('./types.js?v=20260417-mH').WeeklyUpdate} update
 * @returns {Promise<import('./types.js?v=20260417-mH').WeeklyUpdate>}
 */
