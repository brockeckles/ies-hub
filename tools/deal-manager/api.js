...
/**
 * List all deals.
 * @returns {Promise<import('./types.js?v=20260417-p6').Deal[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260417-p6').Deal|null>}
 */
 ...
 * @param {import('./types.js?v=20260417-p6').Deal} deal
 * @returns {Promise<import('./types.js?v=20260417-p6').Deal>}
 */
 ...
 * @param {string} dealId
 * @returns {Promise<import('./types.js?v=20260417-p6').Site[]>}
 */
 ...
 * @param {object} row
 * @returns {import('./types.js?v=20260417-p6').Site}
 */
 ...
 * @param {string} dealId
 * @returns {Promise<import('./types.js?v=20260417-p6').DosStage[]>}
 */
 ...
 * @param {string} dealId
 * @returns {Promise<import('./types.js?v=20260417-p6').DealArtifact[]>}
 */
 ...
 * @returns {Promise<{ deals: import('./types.js?v=20260417-p6').Deal[] }>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260417-p6').HoursEntry[]>}
 */
...
/**
 * Log new hours entry.
 * @param {import('./types.js?v=20260417-p6').HoursEntry} entry
 * @returns {Promise<import('./types.js?v=20260417-p6').HoursEntry>}
 */
 ...
 * @param {string} opportunityId
 * @returns {Promise<import('./types.js?v=20260417-p6').Task[]>}
 */
...
/**
 * Create a new task.
 * @param {import('./types.js?v=20260417-p6').Task} task
 * @returns {Promise<import('./types.js?v=20260417-p6').Task>}
 */
 ...
 * Update a task.
 * @param {string} id
 * @param {Partial<import('./types.js?v=20260417-p6').Task>} fields
 * @returns {Promise<void>}
 */
 ...
 * @param {string} opportunityId
 * @returns {Promise<import('./types.js?v=20260417-p6').WeeklyUpdate[]>}
 */
...
/**
 * Create a new update.
 * @param {import('./types.js?v=20260417-p6').WeeklyUpdate} update
 * @returns {Promise<import('./types.js?v=20260417-p6').WeeklyUpdate>}
 */
