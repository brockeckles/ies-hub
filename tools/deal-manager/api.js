...
/**
 * List all deals.
 * @returns {Promise<import('./types.js?v=20260418-s8').Deal[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260418-s8').Deal|null>}
 */
 ...
 * @param {import('./types.js?v=20260418-s8').Deal} deal
 * @returns {Promise<import('./types.js?v=20260418-s8').Deal>}
 */
 ...
 * @param {string} dealId
 * @returns {Promise<import('./types.js?v=20260418-s8').Site[]>}
 */
 ...
 * @param {object} row
 * @returns {import('./types.js?v=20260418-s8').Site}
 */
 ...
 * @param {string} dealId
 * @returns {Promise<import('./types.js?v=20260418-s8').DosStage[]>}
 */
 ...
 * @param {string} dealId
 * @returns {Promise<import('./types.js?v=20260418-s8').DealArtifact[]>}
 */
 ...
 * @returns {Promise<{ deals: import('./types.js?v=20260418-s8').Deal[] }>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260418-s8').HoursEntry[]>}
 */
...
/**
 * Log new hours entry.
 * @param {import('./types.js?v=20260418-s8').HoursEntry} entry
 * @returns {Promise<import('./types.js?v=20260418-s8').HoursEntry>}
 */
 ...
 * @param {string} opportunityId
 * @returns {Promise<import('./types.js?v=20260418-s8').Task[]>}
 */
...
/**
 * Create a new task.
 * @param {import('./types.js?v=20260418-s8').Task} task
 * @returns {Promise<import('./types.js?v=20260418-s8').Task>}
 */
 ...
 * Update a task.
 * @param {string} id
 * @param {Partial<import('./types.js?v=20260418-s8').Task>} fields
 * @returns {Promise<void>}
 */
 ...
 * @param {string} opportunityId
 * @returns {Promise<import('./types.js?v=20260418-s8').WeeklyUpdate[]>}
 */
...
/**
 * Create a new update.
 * @param {import('./types.js?v=20260418-s8').WeeklyUpdate} update
 * @returns {Promise<import('./types.js?v=20260418-s8').WeeklyUpdate>}
 */
