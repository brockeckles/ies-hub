...
import { db } from '../../shared/supabase.js?v=20260417-mF';
...
/**
 * List all deals.
 * @returns {Promise<import('./types.js?v=20260417-mF').Deal[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260417-mF').Deal|null>}
 */
 ...
 * @param {import('./types.js?v=20260417-mF').Deal} deal
 * @returns {Promise<import('./types.js?v=20260417-mF').Deal>}
 */
 ...
 * @param {string} dealId
 * @returns {Promise<import('./types.js?v=20260417-mF').Site[]>}
 */
 ...
 * @param {object} row
 * @returns {import('./types.js?v=20260417-mF').Site}
 */
 ...
 * @param {string} dealId
 * @returns {Promise<import('./types.js?v=20260417-mF').DosStage[]>}
 */
 ...
 * @param {string} dealId
 * @returns {Promise<import('./types.js?v=20260417-mF').DealArtifact[]>}
 */
 ...
 * @returns {Promise<{ deals: import('./types.js?v=20260417-mF').Deal[] }>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260417-mF').HoursEntry[]>}
 */
...
/**
 * Log new hours entry.
 * @param {import('./types.js?v=20260417-mF').HoursEntry} entry
 * @returns {Promise<import('./types.js?v=20260417-mF').HoursEntry>}
 */
 ...
 * @param {string} opportunityId
 * @returns {Promise<import('./types.js?v=20260417-mF').Task[]>}
 */
...
/**
 * Create a new task.
 * @param {import('./types.js?v=20260417-mF').Task} task
 * @returns {Promise<import('./types.js?v=20260417-mF').Task>}
 */
 ...
 * Update a task.
 * @param {string} id
 * @param {Partial<import('./types.js?v=20260417-mF').Task>} fields
 * @returns {Promise<void>}
 */
 ...
 * @param {string} opportunityId
 * @returns {Promise<import('./types.js?v=20260417-mF').WeeklyUpdate[]>}
 */
...
/**
 * Create a new update.
 * @param {import('./types.js?v=20260417-mF').WeeklyUpdate} update
 * @returns {Promise<import('./types.js?v=20260417-mF').WeeklyUpdate>}
 */
