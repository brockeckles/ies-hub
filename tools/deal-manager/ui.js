...
/** @type {import('./types.js?v=20260418-s6').Deal|null} */
let activeDeal = null;

/** @type {import('./types.js?v=20260418-s6').Site[]} */
let sites = [];

/** @type {import('./types.js?v=20260418-s6').DealFinancials|null} */
let financials = null;

/** @type {import('./types.js?v=20260418-s6').DosStage[]} */
let dosStages = [];

/** @type {import('./types.js?v=20260418-s6').Deal[]} */
let allDeals = [];

/** @type {import('./types.js?v=20260418-s6').HoursEntry[]} */
let hoursEntries = [];

/** @type {import('./types.js?v=20260418-s6').Task[]} */
let tasks = [];

/** @type {import('./types.js?v=20260418-s6').WeeklyUpdate[]} */
let updates = [];
