...
/** @type {import('./types.js?v=20260417-m4').Deal|null} */
let activeDeal = null;

/** @type {import('./types.js?v=20260417-m4').Site[]} */
let sites = [];

/** @type {import('./types.js?v=20260417-m4').DealFinancials|null} */
let financials = null;

/** @type {import('./types.js?v=20260417-m4').DosStage[]} */
let dosStages = [];

/** @type {import('./types.js?v=20260417-m4').Deal[]} */
let allDeals = [];

/** @type {import('./types.js?v=20260417-m4').HoursEntry[]} */
let hoursEntries = [];

/** @type {import('./types.js?v=20260417-m4').Task[]} */
let tasks = [];

/** @type {import('./types.js?v=20260417-m4').WeeklyUpdate[]} */
let updates = [];
