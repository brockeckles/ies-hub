...
/** @type {import('./types.js?v=20260417-m9').Deal|null} */
let activeDeal = null;

/** @type {import('./types.js?v=20260417-m9').Site[]} */
let sites = [];

/** @type {import('./types.js?v=20260417-m9').DealFinancials|null} */
let financials = null;

/** @type {import('./types.js?v=20260417-m9').DosStage[]} */
let dosStages = [];

/** @type {import('./types.js?v=20260417-m9').Deal[]} */
let allDeals = [];

/** @type {import('./types.js?v=20260417-m9').HoursEntry[]} */
let hoursEntries = [];

/** @type {import('./types.js?v=20260417-m9').Task[]} */
let tasks = [];

/** @type {import('./types.js?v=20260417-m9').WeeklyUpdate[]} */
let updates = [];
