...
/** @type {import('./types.js?v=20260418-s8').CostModelData} */
 ...
 * @param {import('../most-standards/types.js?v=20260418-s8').MostToCmPayload} payload
 */
 ...
 * @param {import('../warehouse-sizing/types.js?v=20260418-s8').WscToCmPayload} payload
 */
