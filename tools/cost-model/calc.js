 ...
 * @param {import('./types.js?v=20260417-p5').ShiftConfig} shifts
 ...
 * @param {import('./types.js?v=20260417-p5').DirectLaborLine | import('./types.js?v=20260417-p5').IndirectLaborLine} line
 * @param {Object} [opts]
 ...
 * @param {import('./types.js?v=20260417-p5').DirectLaborLine} line
 * @param {Object} [opts]
 ...
 * @param {import('./types.js?v=20260417-p5').IndirectLaborLine} line
 * @param {Object} opts
 ...
 * @param {import('./types.js?v=20260417-p5').DirectLaborLine[]} directLines
 * @param {import('./types.js?v=20260417-p5').IndirectLaborLine[]} indirectLines
 * @param {Object} opts
 ...
 * @param {import('./types.js?v=20260417-p5').EquipmentLine} line
 * @returns {number}
 */
 ...
 * @param {import('./types.js?v=20260417-p5').EquipmentLine[]} lines
 * @returns {number}
 */
 ...
 * @param {import('./types.js?v=20260417-p5').OverheadLine} line
 * @returns {number}
 */
 ...
 * @param {import('./types.js?v=20260417-p5').OverheadLine[]} lines
 * @returns {number}
 */
 ...
 * @param {import('./types.js?v=20260417-p5').VASLine} line
 * @returns {number}
 */
 ...
 * @param {import('./types.js?v=20260417-p5').VASLine[]} lines
 * @returns {number}
 */
 ...
 * @param {import('./types.js?v=20260417-p5').FacilityConfig} facility
 * @param {import('./types.js?v=20260417-p5').FacilityRate} [facilityRate]
 * @param {import('./types.js?v=20260417-p5').UtilityRate} [utilityRate]
 * @returns {number}
 */
 ...
 * @param {import('./types.js?v=20260417-p5').StartupLine[]} lines
 ...
 * @param {Object} params
 * @param {import('./types.js?v=20260417-p5').DirectLaborLine[]} params.laborLines
 * @param {import('./types.js?v=20260417-p5').IndirectLaborLine[]} params.indirectLaborLines
 * @param {import('./types.js?v=20260417-p5').EquipmentLine[]} params.equipmentLines
 * @param {import('./types.js?v=20260417-p5').OverheadLine[]} params.overheadLines
 * @param {import('./types.js?v=20260417-p5').VASLine[]} params.vasLines
 * @param {import('./types.js?v=20260417-p5').StartupLine[]} params.startupLines
 * @param {import('./types.js?v=20260417-p5').FacilityConfig} params.facility
 * @param {import('./types.js?v=20260417-p5').ShiftConfig} params.shifts
 * @param {import('./types.js?v=20260417-p5').FacilityRate} [params.facilityRate]
 * @param {import('./types.js?v=20260417-p5').UtilityRate} [params.utilityRate]
 ...
 * @returns {import('./types.js?v=20260417-p5').CostSummary}
 */
 ...
 * @param {import('./types.js?v=20260417-p5').DirectLaborLine[]} [params.laborLines] — for learning curve calc
 * @returns {{ projections: import('./types.js?v=20260417-p5').YearlyProjection[], startupCapital: number }}
 */
export function buildYearlyProjections(params) {
  ...
  /** @type {import('./types.js?v=20260417-p5').YearlyProjection[]} */
  const projections = [];
 ...
 * @param {import('./types.js?v=20260417-p5').YearlyProjection[]} projections
 * @param {Object} opts
 ...
 * @returns {import('./types.js?v=20260417-p5').FinancialMetrics}
 */
 ...
 * @param {Object} params
 * @param {import('./types.js?v=20260417-p5').PricingBucket[]} params.buckets
 * @param {import('./types.js?v=20260417-p5').DirectLaborLine[]} params.laborLines
 * @param {import('./types.js?v=20260417-p5').IndirectLaborLine[]} params.indirectLaborLines
 * @param {import('./types.js?v=20260417-p5').EquipmentLine[]} params.equipmentLines
 * @param {import('./types.js?v=20260417-p5').OverheadLine[]} params.overheadLines
 ...
 * @param {import('./types.js?v=20260417-p5').CostModelData} model
 * @param {Object} [opts]
 * @param {number} [opts.operatingHours]
 * @returns {import('./types.js?v=20260417-p5').ValidationWarning[]}
 */
export function validateModel(model, opts = {}) {
  /** @type {import('./types.js?v=20260417-p5').ValidationWarning[]} */
  const warnings = [];
 ...
 * @returns {import('./types.js?v=20260417-p5').IndirectLaborLine[]}
 */
 ...
 * @param {Object} state
 * @returns {import('./types.js?v=20260417-p5').EquipmentLine[]}
 */
 ...
 * @param {Object} state
 * @returns {import('./types.js?v=20260417-p5').OverheadLine[]}
 */
 ...
 * @param {Object} state
 * @returns {import('./types.js?v=20260417-p5').StartupLine[]}
 */
 ...
 * @param {Object} state
 * @param {import('./types.js?v=20260417-p5').CostSummary} summary
