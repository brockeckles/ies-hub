 ...
 * @param {import('./types.js?v=20260417-p3').ShiftConfig} shifts
 ...
 * @param {import('./types.js?v=20260417-p3').DirectLaborLine | import('./types.js?v=20260417-p3').IndirectLaborLine} line
 * @param {Object} [opts]
 ...
 * @param {import('./types.js?v=20260417-p3').DirectLaborLine} line
 * @param {Object} [opts]
 ...
 * @param {import('./types.js?v=20260417-p3').IndirectLaborLine} line
 * @param {Object} opts
 ...
 * @param {import('./types.js?v=20260417-p3').DirectLaborLine[]} directLines
 * @param {import('./types.js?v=20260417-p3').IndirectLaborLine[]} indirectLines
 * @param {Object} opts
 ...
 * @param {import('./types.js?v=20260417-p3').EquipmentLine} line
 * @returns {number}
 */
 ...
 * @param {import('./types.js?v=20260417-p3').EquipmentLine[]} lines
 * @returns {number}
 */
 ...
 * @param {import('./types.js?v=20260417-p3').OverheadLine} line
 * @returns {number}
 */
 ...
 * @param {import('./types.js?v=20260417-p3').OverheadLine[]} lines
 * @returns {number}
 */
 ...
 * @param {import('./types.js?v=20260417-p3').VASLine} line
 * @returns {number}
 */
 ...
 * @param {import('./types.js?v=20260417-p3').VASLine[]} lines
 * @returns {number}
 */
 ...
 * @param {import('./types.js?v=20260417-p3').FacilityConfig} facility
 * @param {import('./types.js?v=20260417-p3').FacilityRate} [facilityRate]
 * @param {import('./types.js?v=20260417-p3').UtilityRate} [utilityRate]
 * @returns {number}
 */
 ...
 * @param {import('./types.js?v=20260417-p3').StartupLine[]} lines
 ...
 * @param {Object} params
 * @param {import('./types.js?v=20260417-p3').DirectLaborLine[]} params.laborLines
 * @param {import('./types.js?v=20260417-p3').IndirectLaborLine[]} params.indirectLaborLines
 * @param {import('./types.js?v=20260417-p3').EquipmentLine[]} params.equipmentLines
 * @param {import('./types.js?v=20260417-p3').OverheadLine[]} params.overheadLines
 * @param {import('./types.js?v=20260417-p3').VASLine[]} params.vasLines
 * @param {import('./types.js?v=20260417-p3').StartupLine[]} params.startupLines
 * @param {import('./types.js?v=20260417-p3').FacilityConfig} params.facility
 * @param {import('./types.js?v=20260417-p3').ShiftConfig} params.shifts
 * @param {import('./types.js?v=20260417-p3').FacilityRate} [params.facilityRate]
 * @param {import('./types.js?v=20260417-p3').UtilityRate} [params.utilityRate]
 ...
 * @returns {import('./types.js?v=20260417-p3').CostSummary}
 */
 ...
 * @param {import('./types.js?v=20260417-p3').DirectLaborLine[]} [params.laborLines] — for learning curve calc
 * @returns {{ projections: import('./types.js?v=20260417-p3').YearlyProjection[], startupCapital: number }}
 */
export function buildYearlyProjections(params) {
  ...
  /** @type {import('./types.js?v=20260417-p3').YearlyProjection[]} */
  const projections = [];
 ...
 * @param {import('./types.js?v=20260417-p3').YearlyProjection[]} projections
 * @param {Object} opts
 ...
 * @returns {import('./types.js?v=20260417-p3').FinancialMetrics}
 */
 ...
 * @param {Object} params
 * @param {import('./types.js?v=20260417-p3').PricingBucket[]} params.buckets
 * @param {import('./types.js?v=20260417-p3').DirectLaborLine[]} params.laborLines
 * @param {import('./types.js?v=20260417-p3').IndirectLaborLine[]} params.indirectLaborLines
 * @param {import('./types.js?v=20260417-p3').EquipmentLine[]} params.equipmentLines
 * @param {import('./types.js?v=20260417-p3').OverheadLine[]} params.overheadLines
 ...
 * @param {import('./types.js?v=20260417-p3').CostModelData} model
 * @param {Object} [opts]
 * @param {number} [opts.operatingHours]
 * @returns {import('./types.js?v=20260417-p3').ValidationWarning[]}
 */
export function validateModel(model, opts = {}) {
  /** @type {import('./types.js?v=20260417-p3').ValidationWarning[]} */
  const warnings = [];
 ...
 * @returns {import('./types.js?v=20260417-p3').IndirectLaborLine[]}
 */
 ...
 * @param {Object} state
 * @returns {import('./types.js?v=20260417-p3').EquipmentLine[]}
 */
 ...
 * @param {Object} state
 * @returns {import('./types.js?v=20260417-p3').OverheadLine[]}
 */
 ...
 * @param {Object} state
 * @returns {import('./types.js?v=20260417-p3').StartupLine[]}
 */
 ...
 * @param {Object} state
 * @param {import('./types.js?v=20260417-p3').CostSummary} summary
