 ...
 * @returns {Promise<import('./types.js').CogScenario[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js').CogScenario|null>}
 */
 ...
 * @param {import('./types.js').CogScenario} scenario
 * @returns {Promise<import('./types.js').CogScenario>}
 */
 ...
 * @returns {Promise<{ scenarios: import('./types.js').CogScenario[] }>}
 */
