...
/** @type {import('./types.js').MajorCity[]} */
 ...
 * @param {import('./types.js').WeightedPoint[]} points
 * @returns {import('./types.js').CogResult}
 */
 ...
 * @returns {import('./types.js').MultiCogResult}
 */
 ...
 * @param {import('./types.js').MultiCogResult} cogResult
 * @param {import('./types.js').WeightedPoint[]} points
