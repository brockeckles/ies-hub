...
/** @type {import('./types.js?v=20260418-s5').FacilityConfig} */
let facility = createDefaultFacility();

/** @type {import('./types.js?v=20260418-s5').ZoneConfig} */
let zones = createDefaultZones();

/** @type {import('./types.js?v=20260418-s5').VolumeInputs} */
...
function pushToCm() {
  /** @type {import('./types.js?v=20260418-s5').WscToCmPayload} */
  const payload = {
 ...
 * @param {import('./types.js?v=20260418-s5').CmToWscPayload} payload
 */
