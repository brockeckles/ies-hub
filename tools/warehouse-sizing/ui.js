...
/** @type {import('./types.js?v=20260417-p6').FacilityConfig} */
let facility = createDefaultFacility();

/** @type {import('./types.js?v=20260417-p6').ZoneConfig} */
let zones = createDefaultZones();

/** @type {import('./types.js?v=20260417-p6').VolumeInputs} */
...
function pushToCm() {
  /** @type {import('./types.js?v=20260417-p6').WscToCmPayload} */
  const payload = {
 ...
 * @param {import('./types.js?v=20260417-p6').CmToWscPayload} payload
 */
