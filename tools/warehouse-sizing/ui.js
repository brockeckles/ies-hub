...
/** @type {import('./types.js?v=20260417-m4').FacilityConfig} */
let facility = createDefaultFacility();

/** @type {import('./types.js?v=20260417-m4').ZoneConfig} */
let zones = createDefaultZones();

/** @type {import('./types.js?v=20260417-m4').VolumeInputs} */
...
function pushToCm() {
  /** @type {import('./types.js?v=20260417-m4').WscToCmPayload} */
  const payload = {
 ...
 * @param {import('./types.js?v=20260417-m4').CmToWscPayload} payload
 */
