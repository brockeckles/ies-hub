...
/** @type {import('./types.js?v=20260417-pb').FacilityConfig} */
let facility = createDefaultFacility();

/** @type {import('./types.js?v=20260417-pb').ZoneConfig} */
let zones = createDefaultZones();

/** @type {import('./types.js?v=20260417-pb').VolumeInputs} */
...
function pushToCm() {
  /** @type {import('./types.js?v=20260417-pb').WscToCmPayload} */
  const payload = {
 ...
 * @param {import('./types.js?v=20260417-pb').CmToWscPayload} payload
 */
