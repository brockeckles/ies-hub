...
/** @type {import('./types.js?v=20260417-p4').FacilityConfig} */
let facility = createDefaultFacility();

/** @type {import('./types.js?v=20260417-p4').ZoneConfig} */
let zones = createDefaultZones();

/** @type {import('./types.js?v=20260417-p4').VolumeInputs} */
...
function pushToCm() {
  /** @type {import('./types.js?v=20260417-p4').WscToCmPayload} */
  const payload = {
 ...
 * @param {import('./types.js?v=20260417-p4').CmToWscPayload} payload
 */
