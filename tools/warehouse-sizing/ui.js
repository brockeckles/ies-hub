...
/** @type {import('./types.js?v=20260417-m3').FacilityConfig} */
let facility = createDefaultFacility();

/** @type {import('./types.js?v=20260417-m3').ZoneConfig} */
let zones = createDefaultZones();

/** @type {import('./types.js?v=20260417-m3').VolumeInputs} */
...
function pushToCm() {
  /** @type {import('./types.js?v=20260417-m3').WscToCmPayload} */
  const payload = {
 ...
 * @param {import('./types.js?v=20260417-m3').CmToWscPayload} payload
 */
