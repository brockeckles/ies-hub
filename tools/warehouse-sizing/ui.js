...
/** @type {import('./types.js?v=20260417-mC').FacilityConfig} */
let facility = createDefaultFacility();

/** @type {import('./types.js?v=20260417-mC').ZoneConfig} */
let zones = createDefaultZones();

/** @type {import('./types.js?v=20260417-mC').VolumeInputs} */
...
function pushToCm() {
  /** @type {import('./types.js?v=20260417-mC').WscToCmPayload} */
  const payload = {
 ...
 * @param {import('./types.js?v=20260417-mC').CmToWscPayload} payload
 */
