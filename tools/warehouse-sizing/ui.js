...
/** @type {import('./types.js?v=20260417-p5').FacilityConfig} */
let facility = createDefaultFacility();

/** @type {import('./types.js?v=20260417-p5').ZoneConfig} */
let zones = createDefaultZones();

/** @type {import('./types.js?v=20260417-p5').VolumeInputs} */
...
function pushToCm() {
  /** @type {import('./types.js?v=20260417-p5').WscToCmPayload} */
  const payload = {
 ...
 * @param {import('./types.js?v=20260417-p5').CmToWscPayload} payload
 */
