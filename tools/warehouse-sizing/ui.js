...
/** @type {import('./types.js?v=20260417-m7').FacilityConfig} */
let facility = createDefaultFacility();

/** @type {import('./types.js?v=20260417-m7').ZoneConfig} */
let zones = createDefaultZones();

/** @type {import('./types.js?v=20260417-m7').VolumeInputs} */
...
function pushToCm() {
  /** @type {import('./types.js?v=20260417-m7').WscToCmPayload} */
  const payload = {
 ...
 * @param {import('./types.js?v=20260417-m7').CmToWscPayload} payload
 */
