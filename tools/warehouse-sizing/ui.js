...
/** @type {import('./types.js?v=20260418-s1').FacilityConfig} */
let facility = createDefaultFacility();

/** @type {import('./types.js?v=20260418-s1').ZoneConfig} */
let zones = createDefaultZones();

/** @type {import('./types.js?v=20260418-s1').VolumeInputs} */
...
function pushToCm() {
  /** @type {import('./types.js?v=20260418-s1').WscToCmPayload} */
  const payload = {
 ...
 * @param {import('./types.js?v=20260418-s1').CmToWscPayload} payload
 */
