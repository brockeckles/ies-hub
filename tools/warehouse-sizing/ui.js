...
/** @type {import('./types.js?v=20260418-s2').FacilityConfig} */
let facility = createDefaultFacility();

/** @type {import('./types.js?v=20260418-s2').ZoneConfig} */
let zones = createDefaultZones();

/** @type {import('./types.js?v=20260418-s2').VolumeInputs} */
...
function pushToCm() {
  /** @type {import('./types.js?v=20260418-s2').WscToCmPayload} */
  const payload = {
 ...
 * @param {import('./types.js?v=20260418-s2').CmToWscPayload} payload
 */
