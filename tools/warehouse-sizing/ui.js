...
/** @type {import('./types.js?v=20260417-p7').FacilityConfig} */
let facility = createDefaultFacility();

/** @type {import('./types.js?v=20260417-p7').ZoneConfig} */
let zones = createDefaultZones();

/** @type {import('./types.js?v=20260417-p7').VolumeInputs} */
...
function pushToCm() {
  /** @type {import('./types.js?v=20260417-p7').WscToCmPayload} */
  const payload = {
 ...
 * @param {import('./types.js?v=20260417-p7').CmToWscPayload} payload
 */
