...
/** @type {import('./types.js?v=20260417-p2').FacilityConfig} */
let facility = createDefaultFacility();

/** @type {import('./types.js?v=20260417-p2').ZoneConfig} */
let zones = createDefaultZones();

/** @type {import('./types.js?v=20260417-p2').VolumeInputs} */
...
function pushToCm() {
  /** @type {import('./types.js?v=20260417-p2').WscToCmPayload} */
  const payload = {
 ...
 * @param {import('./types.js?v=20260417-p2').CmToWscPayload} payload
 */
