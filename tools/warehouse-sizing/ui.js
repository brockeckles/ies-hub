...
/** @type {import('./types.js?v=20260418-s6').FacilityConfig} */
let facility = createDefaultFacility();

/** @type {import('./types.js?v=20260418-s6').ZoneConfig} */
let zones = createDefaultZones();

/** @type {import('./types.js?v=20260418-s6').VolumeInputs} */
...
function pushToCm() {
  /** @type {import('./types.js?v=20260418-s6').WscToCmPayload} */
  const payload = {
 ...
 * @param {import('./types.js?v=20260418-s6').CmToWscPayload} payload
 */
