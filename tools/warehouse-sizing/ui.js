...
/** @type {import('./types.js?v=20260417-p8').FacilityConfig} */
let facility = createDefaultFacility();

/** @type {import('./types.js?v=20260417-p8').ZoneConfig} */
let zones = createDefaultZones();

/** @type {import('./types.js?v=20260417-p8').VolumeInputs} */
...
function pushToCm() {
  /** @type {import('./types.js?v=20260417-p8').WscToCmPayload} */
  const payload = {
 ...
 * @param {import('./types.js?v=20260417-p8').CmToWscPayload} payload
 */
