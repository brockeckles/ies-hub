...
/** @type {import('./types.js?v=20260417-m1').FacilityConfig} */
let facility = createDefaultFacility();

/** @type {import('./types.js?v=20260417-m1').ZoneConfig} */
let zones = createDefaultZones();

/** @type {import('./types.js?v=20260417-m1').VolumeInputs} */
...
function pushToCm() {
  /** @type {import('./types.js?v=20260417-m1').WscToCmPayload} */
  const payload = {
 ...
 * @param {import('./types.js?v=20260417-m1').CmToWscPayload} payload
 */
