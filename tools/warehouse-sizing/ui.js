...
import * as cmApi from '../cost-model/api.js?v=20260722-s3b';
...
import { renderConfigHtml, renderQuickConfigHtml, bindConfigEvents } from './ui-config.js?v=20260722-s3b';
 ...
 *
 * @returns {import('./calc.js?v=20260722-s2').SizingInputs}
 */
