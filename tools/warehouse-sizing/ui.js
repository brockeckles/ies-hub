...
/** @type {import('./types.js?v=20260418-s9').FacilityConfig} */
let facility = createDefaultFacility();

/** @type {import('./types.js?v=20260418-s9').ZoneConfig} */
let zones = createDefaultZones();

/** @type {import('./types.js?v=20260418-s9').VolumeInputs} */
...
function pushToCm() {
  /** @type {import('./types.js?v=20260418-s9').WscToCmPayload} */
  const payload = {
 ...
 * @param {import('./types.js?v=20260418-s9').CmToWscPayload} payload
 */
