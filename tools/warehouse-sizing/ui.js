...
/** @type {import('./types.js?v=20260417-pc').FacilityConfig} */
let facility = createDefaultFacility();

/** @type {import('./types.js?v=20260417-pc').ZoneConfig} */
let zones = createDefaultZones();

/** @type {import('./types.js?v=20260417-pc').VolumeInputs} */
...
function pushToCm() {
  /** @type {import('./types.js?v=20260417-pc').WscToCmPayload} */
  const payload = {
 ...
 * @param {import('./types.js?v=20260417-pc').CmToWscPayload} payload
 */
