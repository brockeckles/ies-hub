...
/** @type {import('./types.js?v=20260417-m6').FacilityConfig} */
let facility = createDefaultFacility();

/** @type {import('./types.js?v=20260417-m6').ZoneConfig} */
let zones = createDefaultZones();

/** @type {import('./types.js?v=20260417-m6').VolumeInputs} */
...
function pushToCm() {
  /** @type {import('./types.js?v=20260417-m6').WscToCmPayload} */
  const payload = {
 ...
 * @param {import('./types.js?v=20260417-m6').CmToWscPayload} payload
 */
