...
/** @type {import('./types.js?v=20260417-m5').FacilityConfig} */
let facility = createDefaultFacility();

/** @type {import('./types.js?v=20260417-m5').ZoneConfig} */
let zones = createDefaultZones();

/** @type {import('./types.js?v=20260417-m5').VolumeInputs} */
...
function pushToCm() {
  /** @type {import('./types.js?v=20260417-m5').WscToCmPayload} */
  const payload = {
 ...
 * @param {import('./types.js?v=20260417-m5').CmToWscPayload} payload
 */
