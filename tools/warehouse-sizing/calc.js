 ...
 * @param {import('./types.js?v=20260418-s9').ZoneConfig} zones
 * @returns {import('./types.js?v=20260418-s9').StorageCalcResult}
 */
 ...
 * @param {import('./types.js?v=20260418-s9').FacilityConfig} facility
 * @param {import('./types.js?v=20260418-s9').ZoneConfig} zones
 * @param {import('./types.js?v=20260418-s9').VolumeInputs} volumes
 * @returns {import('./types.js?v=20260418-s9').CapacitySummary}
 */
 ...
 * @param {import('./types.js?v=20260418-s9').FacilityConfig} facility
 * @returns {import('./types.js?v=20260418-s9').ElevationParams}
 */
