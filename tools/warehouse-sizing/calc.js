 ...
 * @param {import('./types.js?v=20260417-p9').ZoneConfig} zones
 * @returns {import('./types.js?v=20260417-p9').StorageCalcResult}
 */
 ...
 * @param {import('./types.js?v=20260417-p9').FacilityConfig} facility
 * @param {import('./types.js?v=20260417-p9').ZoneConfig} zones
 * @param {import('./types.js?v=20260417-p9').VolumeInputs} volumes
 * @returns {import('./types.js?v=20260417-p9').CapacitySummary}
 */
 ...
 * @param {import('./types.js?v=20260417-p9').FacilityConfig} facility
 * @returns {import('./types.js?v=20260417-p9').ElevationParams}
 */
