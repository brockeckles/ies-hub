 ...
 * @param {import('./types.js?v=20260418-s8').ZoneConfig} zones
 * @returns {import('./types.js?v=20260418-s8').StorageCalcResult}
 */
 ...
 * @param {import('./types.js?v=20260418-s8').FacilityConfig} facility
 * @param {import('./types.js?v=20260418-s8').ZoneConfig} zones
 * @param {import('./types.js?v=20260418-s8').VolumeInputs} volumes
 * @returns {import('./types.js?v=20260418-s8').CapacitySummary}
 */
 ...
 * @param {import('./types.js?v=20260418-s8').FacilityConfig} facility
 * @returns {import('./types.js?v=20260418-s8').ElevationParams}
 */
