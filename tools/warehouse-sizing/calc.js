 ...
 * @param {import('./types.js?v=20260418-s6').ZoneConfig} zones
 * @returns {import('./types.js?v=20260418-s6').StorageCalcResult}
 */
 ...
 * @param {import('./types.js?v=20260418-s6').FacilityConfig} facility
 * @param {import('./types.js?v=20260418-s6').ZoneConfig} zones
 * @param {import('./types.js?v=20260418-s6').VolumeInputs} volumes
 * @returns {import('./types.js?v=20260418-s6').CapacitySummary}
 */
 ...
 * @param {import('./types.js?v=20260418-s6').FacilityConfig} facility
 * @returns {import('./types.js?v=20260418-s6').ElevationParams}
 */
