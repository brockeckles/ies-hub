 ...
 * @param {import('./types.js?v=20260418-s4').ZoneConfig} zones
 * @returns {import('./types.js?v=20260418-s4').StorageCalcResult}
 */
 ...
 * @param {import('./types.js?v=20260418-s4').FacilityConfig} facility
 * @param {import('./types.js?v=20260418-s4').ZoneConfig} zones
 * @param {import('./types.js?v=20260418-s4').VolumeInputs} volumes
 * @returns {import('./types.js?v=20260418-s4').CapacitySummary}
 */
 ...
 * @param {import('./types.js?v=20260418-s4').FacilityConfig} facility
 * @returns {import('./types.js?v=20260418-s4').ElevationParams}
 */
