 ...
 * @param {import('./types.js?v=20260418-s3').ZoneConfig} zones
 * @returns {import('./types.js?v=20260418-s3').StorageCalcResult}
 */
 ...
 * @param {import('./types.js?v=20260418-s3').FacilityConfig} facility
 * @param {import('./types.js?v=20260418-s3').ZoneConfig} zones
 * @param {import('./types.js?v=20260418-s3').VolumeInputs} volumes
 * @returns {import('./types.js?v=20260418-s3').CapacitySummary}
 */
 ...
 * @param {import('./types.js?v=20260418-s3').FacilityConfig} facility
 * @returns {import('./types.js?v=20260418-s3').ElevationParams}
 */
