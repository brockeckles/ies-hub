 ...
 * @param {import('./types.js?v=20260418-s1').ZoneConfig} zones
 * @returns {import('./types.js?v=20260418-s1').StorageCalcResult}
 */
 ...
 * @param {import('./types.js?v=20260418-s1').FacilityConfig} facility
 * @param {import('./types.js?v=20260418-s1').ZoneConfig} zones
 * @param {import('./types.js?v=20260418-s1').VolumeInputs} volumes
 * @returns {import('./types.js?v=20260418-s1').CapacitySummary}
 */
 ...
 * @param {import('./types.js?v=20260418-s1').FacilityConfig} facility
 * @returns {import('./types.js?v=20260418-s1').ElevationParams}
 */
