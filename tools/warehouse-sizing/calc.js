 ...
 * @param {import('./types.js?v=20260418-s5').ZoneConfig} zones
 * @returns {import('./types.js?v=20260418-s5').StorageCalcResult}
 */
 ...
 * @param {import('./types.js?v=20260418-s5').FacilityConfig} facility
 * @param {import('./types.js?v=20260418-s5').ZoneConfig} zones
 * @param {import('./types.js?v=20260418-s5').VolumeInputs} volumes
 * @returns {import('./types.js?v=20260418-s5').CapacitySummary}
 */
 ...
 * @param {import('./types.js?v=20260418-s5').FacilityConfig} facility
 * @returns {import('./types.js?v=20260418-s5').ElevationParams}
 */
