 ...
 * @param {import('./types.js?v=20260418-s7').ZoneConfig} zones
 * @returns {import('./types.js?v=20260418-s7').StorageCalcResult}
 */
 ...
 * @param {import('./types.js?v=20260418-s7').FacilityConfig} facility
 * @param {import('./types.js?v=20260418-s7').ZoneConfig} zones
 * @param {import('./types.js?v=20260418-s7').VolumeInputs} volumes
 * @returns {import('./types.js?v=20260418-s7').CapacitySummary}
 */
 ...
 * @param {import('./types.js?v=20260418-s7').FacilityConfig} facility
 * @returns {import('./types.js?v=20260418-s7').ElevationParams}
 */
