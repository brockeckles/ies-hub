 ...
 * @property {import('./types.js?v=20260417-pb').StorageAllocation} [storageAllocation] — mix of storage types
 * @property {import('./types.js?v=20260417-pb').DockConfig} [dockConfig] — dock configuration
 * @property {import('./types.js?v=20260417-pb').ProductDimensions} [productDimensions] — product sizing
 * @property {import('./types.js?v=20260417-pb').ForwardPickConfig} [forwardPick] — forward pick area config
 * @property {{ vas: OptionalZone, returns: OptionalZone, chargeback: OptionalZone }} [optionalZones] — optional functional zones
 * @property {import('./types.js?v=20260417-pb').CustomZone[]} [customZones] — user-defined zones
