 ...
 * @property {import('./types.js?v=20260418-s1').StorageAllocation} [storageAllocation] — mix of storage types
 * @property {import('./types.js?v=20260418-s1').DockConfig} [dockConfig] — dock configuration
 * @property {import('./types.js?v=20260418-s1').ProductDimensions} [productDimensions] — product sizing
 * @property {import('./types.js?v=20260418-s1').ForwardPickConfig} [forwardPick] — forward pick area config
 * @property {{ vas: OptionalZone, returns: OptionalZone, chargeback: OptionalZone }} [optionalZones] — optional functional zones
 * @property {import('./types.js?v=20260418-s1').CustomZone[]} [customZones] — user-defined zones
