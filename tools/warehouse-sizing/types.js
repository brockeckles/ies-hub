 ...
 * @property {import('./types.js?v=20260417-mA').StorageAllocation} [storageAllocation] — mix of storage types
 * @property {import('./types.js?v=20260417-mA').DockConfig} [dockConfig] — dock configuration
 * @property {import('./types.js?v=20260417-mA').ProductDimensions} [productDimensions] — product sizing
 * @property {import('./types.js?v=20260417-mA').ForwardPickConfig} [forwardPick] — forward pick area config
 * @property {{ vas: OptionalZone, returns: OptionalZone, chargeback: OptionalZone }} [optionalZones] — optional functional zones
 * @property {import('./types.js?v=20260417-mA').CustomZone[]} [customZones] — user-defined zones
