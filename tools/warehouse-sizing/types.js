 ...
 * @property {import('./types.js?v=20260417-mE').StorageAllocation} [storageAllocation] — mix of storage types
 * @property {import('./types.js?v=20260417-mE').DockConfig} [dockConfig] — dock configuration
 * @property {import('./types.js?v=20260417-mE').ProductDimensions} [productDimensions] — product sizing
 * @property {import('./types.js?v=20260417-mE').ForwardPickConfig} [forwardPick] — forward pick area config
 * @property {{ vas: OptionalZone, returns: OptionalZone, chargeback: OptionalZone }} [optionalZones] — optional functional zones
 * @property {import('./types.js?v=20260417-mE').CustomZone[]} [customZones] — user-defined zones
