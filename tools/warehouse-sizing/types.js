 ...
 * @property {import('./types.js?v=20260417-pc').StorageAllocation} [storageAllocation] — mix of storage types
 * @property {import('./types.js?v=20260417-pc').DockConfig} [dockConfig] — dock configuration
 * @property {import('./types.js?v=20260417-pc').ProductDimensions} [productDimensions] — product sizing
 * @property {import('./types.js?v=20260417-pc').ForwardPickConfig} [forwardPick] — forward pick area config
 * @property {{ vas: OptionalZone, returns: OptionalZone, chargeback: OptionalZone }} [optionalZones] — optional functional zones
 * @property {import('./types.js?v=20260417-pc').CustomZone[]} [customZones] — user-defined zones
