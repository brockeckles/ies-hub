 ...
 * @property {import('./types.js?v=20260417-mD').StorageAllocation} [storageAllocation] — mix of storage types
 * @property {import('./types.js?v=20260417-mD').DockConfig} [dockConfig] — dock configuration
 * @property {import('./types.js?v=20260417-mD').ProductDimensions} [productDimensions] — product sizing
 * @property {import('./types.js?v=20260417-mD').ForwardPickConfig} [forwardPick] — forward pick area config
 * @property {{ vas: OptionalZone, returns: OptionalZone, chargeback: OptionalZone }} [optionalZones] — optional functional zones
 * @property {import('./types.js?v=20260417-mD').CustomZone[]} [customZones] — user-defined zones
