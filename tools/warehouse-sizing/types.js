 ...
 * @property {import('./types.js?v=20260417-mH').StorageAllocation} [storageAllocation] — mix of storage types
 * @property {import('./types.js?v=20260417-mH').DockConfig} [dockConfig] — dock configuration
 * @property {import('./types.js?v=20260417-mH').ProductDimensions} [productDimensions] — product sizing
 * @property {import('./types.js?v=20260417-mH').ForwardPickConfig} [forwardPick] — forward pick area config
 * @property {{ vas: OptionalZone, returns: OptionalZone, chargeback: OptionalZone }} [optionalZones] — optional functional zones
 * @property {import('./types.js?v=20260417-mH').CustomZone[]} [customZones] — user-defined zones
