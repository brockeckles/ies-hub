 ...
 * @property {import('./types.js?v=20260417-mI').StorageAllocation} [storageAllocation] — mix of storage types
 * @property {import('./types.js?v=20260417-mI').DockConfig} [dockConfig] — dock configuration
 * @property {import('./types.js?v=20260417-mI').ProductDimensions} [productDimensions] — product sizing
 * @property {import('./types.js?v=20260417-mI').ForwardPickConfig} [forwardPick] — forward pick area config
 * @property {{ vas: OptionalZone, returns: OptionalZone, chargeback: OptionalZone }} [optionalZones] — optional functional zones
 * @property {import('./types.js?v=20260417-mI').CustomZone[]} [customZones] — user-defined zones
