 ...
 * @property {import('./types.js?v=20260417-p8').StorageAllocation} [storageAllocation] — mix of storage types
 * @property {import('./types.js?v=20260417-p8').DockConfig} [dockConfig] — dock configuration
 * @property {import('./types.js?v=20260417-p8').ProductDimensions} [productDimensions] — product sizing
 * @property {import('./types.js?v=20260417-p8').ForwardPickConfig} [forwardPick] — forward pick area config
 * @property {{ vas: OptionalZone, returns: OptionalZone, chargeback: OptionalZone }} [optionalZones] — optional functional zones
 * @property {import('./types.js?v=20260417-p8').CustomZone[]} [customZones] — user-defined zones
