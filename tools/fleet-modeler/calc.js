...
/** @type {import('./types.js?v=20260417-m6').VehicleSpec[]} */
...
/** @type {import('./types.js?v=20260417-m6').FleetConfig} */
 ...
 * @param {import('./types.js?v=20260417-m6').VehicleSpec[]} vehicles
 * @returns {import('./types.js?v=20260417-m6').VehicleSpec|null}
 */
 ...
 * @param {import('./types.js?v=20260417-m6').Lane[]} lanes
 * @param {import('./types.js?v=20260417-m6').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-m6').FleetConfig} config
 * @returns {import('./types.js?v=20260417-m6').LaneAssignment[]}
 */
 ...
 * @param {import('./types.js?v=20260417-m6').LaneAssignment[]} assignments
 * @param {import('./types.js?v=20260417-m6').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-m6').FleetConfig} config
 * @returns {import('./types.js?v=20260417-m6').FleetSummary[]}
 */
export function computeFleetComposition(assignments, vehicles = DEFAULT_VEHICLES, config = DEFAULT_CONFIG) {
  ...
  /** @type {Map<string, import('./types.js?v=20260417-m6').LaneAssignment[]>} */
 ...
 * @param {import('./types.js?v=20260417-m6').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-m6').FleetConfig} config
 * @returns {import('./types.js?v=20260417-m6').FleetResult}
 */
 ...
 * @returns {import('./types.js?v=20260417-m6').AtriBenchmark}
 */
 ...
 * @param {import('./types.js?v=20260417-m6').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-m6').FleetConfig} config
 * @returns {import('./types.js?v=20260417-m6').SensitivityMatrix}
 */
 ...
 * @param {import('./types.js?v=20260417-m6').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-m6').FleetConfig} config
 * @returns {import('./types.js?v=20260417-m6').VolumeSensitivity[]}
 */
...
/** @type {import('./types.js?v=20260417-m6').Lane[]} */
