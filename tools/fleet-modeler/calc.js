...
/** @type {import('./types.js?v=20260417-m7').VehicleSpec[]} */
...
/** @type {import('./types.js?v=20260417-m7').FleetConfig} */
 ...
 * @param {import('./types.js?v=20260417-m7').VehicleSpec[]} vehicles
 * @returns {import('./types.js?v=20260417-m7').VehicleSpec|null}
 */
 ...
 * @param {import('./types.js?v=20260417-m7').Lane[]} lanes
 * @param {import('./types.js?v=20260417-m7').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-m7').FleetConfig} config
 * @returns {import('./types.js?v=20260417-m7').LaneAssignment[]}
 */
 ...
 * @param {import('./types.js?v=20260417-m7').LaneAssignment[]} assignments
 * @param {import('./types.js?v=20260417-m7').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-m7').FleetConfig} config
 * @returns {import('./types.js?v=20260417-m7').FleetSummary[]}
 */
export function computeFleetComposition(assignments, vehicles = DEFAULT_VEHICLES, config = DEFAULT_CONFIG) {
  ...
  /** @type {Map<string, import('./types.js?v=20260417-m7').LaneAssignment[]>} */
 ...
 * @param {import('./types.js?v=20260417-m7').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-m7').FleetConfig} config
 * @returns {import('./types.js?v=20260417-m7').FleetResult}
 */
 ...
 * @returns {import('./types.js?v=20260417-m7').AtriBenchmark}
 */
 ...
 * @param {import('./types.js?v=20260417-m7').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-m7').FleetConfig} config
 * @returns {import('./types.js?v=20260417-m7').SensitivityMatrix}
 */
 ...
 * @param {import('./types.js?v=20260417-m7').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-m7').FleetConfig} config
 * @returns {import('./types.js?v=20260417-m7').VolumeSensitivity[]}
 */
...
/** @type {import('./types.js?v=20260417-m7').Lane[]} */
