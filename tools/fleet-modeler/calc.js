...
/** @type {import('./types.js?v=20260417-p4').VehicleSpec[]} */
...
/** @type {import('./types.js?v=20260417-p4').FleetConfig} */
 ...
 * @param {import('./types.js?v=20260417-p4').VehicleSpec[]} vehicles
 * @returns {import('./types.js?v=20260417-p4').VehicleSpec|null}
 */
 ...
 * @param {import('./types.js?v=20260417-p4').Lane[]} lanes
 * @param {import('./types.js?v=20260417-p4').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-p4').FleetConfig} config
 * @returns {import('./types.js?v=20260417-p4').LaneAssignment[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p4').LaneAssignment[]} assignments
 * @param {import('./types.js?v=20260417-p4').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-p4').FleetConfig} config
 * @returns {import('./types.js?v=20260417-p4').FleetSummary[]}
 */
export function computeFleetComposition(assignments, vehicles = DEFAULT_VEHICLES, config = DEFAULT_CONFIG) {
  ...
  /** @type {Map<string, import('./types.js?v=20260417-p4').LaneAssignment[]>} */
 ...
 * @param {import('./types.js?v=20260417-p4').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-p4').FleetConfig} config
 * @returns {import('./types.js?v=20260417-p4').FleetResult}
 */
 ...
 * @returns {import('./types.js?v=20260417-p4').AtriBenchmark}
 */
 ...
 * @param {import('./types.js?v=20260417-p4').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-p4').FleetConfig} config
 * @returns {import('./types.js?v=20260417-p4').SensitivityMatrix}
 */
 ...
 * @param {import('./types.js?v=20260417-p4').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-p4').FleetConfig} config
 * @returns {import('./types.js?v=20260417-p4').VolumeSensitivity[]}
 */
...
/** @type {import('./types.js?v=20260417-p4').Lane[]} */
