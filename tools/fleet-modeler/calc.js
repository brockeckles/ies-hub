...
/** @type {import('./types.js?v=20260417-mA').VehicleSpec[]} */
...
/** @type {import('./types.js?v=20260417-mA').FleetConfig} */
 ...
 * @param {import('./types.js?v=20260417-mA').VehicleSpec[]} vehicles
 * @returns {import('./types.js?v=20260417-mA').VehicleSpec|null}
 */
 ...
 * @param {import('./types.js?v=20260417-mA').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-mA').FleetConfig} config
 * @returns {import('./types.js?v=20260417-mA').LaneAssignment[]}
 */
 ...
 * @param {import('./types.js?v=20260417-mA').LaneAssignment[]} assignments
 * @param {import('./types.js?v=20260417-mA').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-mA').FleetConfig} config
 * @returns {import('./types.js?v=20260417-mA').FleetSummary[]}
 */
export function computeFleetComposition(assignments, vehicles = DEFAULT_VEHICLES, config = DEFAULT_CONFIG) {
  ...
  /** @type {Map<string, import('./types.js?v=20260417-mA').LaneAssignment[]>} */
 ...
 * @param {import('./types.js?v=20260417-mA').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-mA').FleetConfig} config
 * @returns {import('./types.js?v=20260417-mA').FleetResult}
 */
 ...
 * @returns {import('./types.js?v=20260417-mA').AtriBenchmark}
 */
 ...
 * @param {import('./types.js?v=20260417-mA').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-mA').FleetConfig} config
 * @returns {import('./types.js?v=20260417-mA').SensitivityMatrix}
 */
 ...
 * @param {import('./types.js?v=20260417-mA').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-mA').FleetConfig} config
 * @returns {import('./types.js?v=20260417-mA').VolumeSensitivity[]}
 */
...
/** @type {import('./types.js?v=20260417-mA').Lane[]} */
