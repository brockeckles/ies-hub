...
/** @type {import('./types.js?v=20260417-pa').VehicleSpec[]} */
...
/** @type {import('./types.js?v=20260417-pa').FleetConfig} */
 ...
 * @param {import('./types.js?v=20260417-pa').VehicleSpec[]} vehicles
 * @returns {import('./types.js?v=20260417-pa').VehicleSpec|null}
 */
 ...
 * @param {import('./types.js?v=20260417-pa').Lane[]} lanes
 * @param {import('./types.js?v=20260417-pa').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-pa').FleetConfig} config
 * @returns {import('./types.js?v=20260417-pa').LaneAssignment[]}
 */
 ...
 * @param {import('./types.js?v=20260417-pa').LaneAssignment[]} assignments
 * @param {import('./types.js?v=20260417-pa').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-pa').FleetConfig} config
 * @returns {import('./types.js?v=20260417-pa').FleetSummary[]}
 */
export function computeFleetComposition(assignments, vehicles = DEFAULT_VEHICLES, config = DEFAULT_CONFIG) {
  ...
  /** @type {Map<string, import('./types.js?v=20260417-pa').LaneAssignment[]>} */
 ...
 * @param {import('./types.js?v=20260417-pa').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-pa').FleetConfig} config
 * @returns {import('./types.js?v=20260417-pa').FleetResult}
 */
 ...
 * @returns {import('./types.js?v=20260417-pa').AtriBenchmark}
 */
 ...
 * @param {import('./types.js?v=20260417-pa').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-pa').FleetConfig} config
 * @returns {import('./types.js?v=20260417-pa').SensitivityMatrix}
 */
 ...
 * @param {import('./types.js?v=20260417-pa').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-pa').FleetConfig} config
 * @returns {import('./types.js?v=20260417-pa').VolumeSensitivity[]}
 */
...
/** @type {import('./types.js?v=20260417-pa').Lane[]} */
