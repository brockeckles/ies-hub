...
/** @type {import('./types.js?v=20260417-mG').VehicleSpec[]} */
...
/** @type {import('./types.js?v=20260417-mG').FleetConfig} */
 ...
 * @param {import('./types.js?v=20260417-mG').VehicleSpec[]} vehicles
 * @returns {import('./types.js?v=20260417-mG').VehicleSpec|null}
 */
 ...
 * @param {import('./types.js?v=20260417-mG').Lane[]} lanes
 * @param {import('./types.js?v=20260417-mG').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-mG').FleetConfig} config
 * @returns {import('./types.js?v=20260417-mG').LaneAssignment[]}
 */
 ...
 * @param {import('./types.js?v=20260417-mG').LaneAssignment[]} assignments
 * @param {import('./types.js?v=20260417-mG').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-mG').FleetConfig} config
 * @returns {import('./types.js?v=20260417-mG').FleetSummary[]}
 */
export function computeFleetComposition(assignments, vehicles = DEFAULT_VEHICLES, config = DEFAULT_CONFIG) {
  ...
  /** @type {Map<string, import('./types.js?v=20260417-mG').LaneAssignment[]>} */
 ...
 * @param {import('./types.js?v=20260417-mG').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-mG').FleetConfig} config
 * @returns {import('./types.js?v=20260417-mG').FleetResult}
 */
 ...
 * @returns {import('./types.js?v=20260417-mG').AtriBenchmark}
 */
 ...
 * @param {import('./types.js?v=20260417-mG').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-mG').FleetConfig} config
 * @returns {import('./types.js?v=20260417-mG').SensitivityMatrix}
 */
 ...
 * @param {import('./types.js?v=20260417-mG').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-mG').FleetConfig} config
 * @returns {import('./types.js?v=20260417-mG').VolumeSensitivity[]}
 */
...
/** @type {import('./types.js?v=20260417-mG').Lane[]} */
