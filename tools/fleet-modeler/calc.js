...
/** @type {import('./types.js?v=20260417-p2').VehicleSpec[]} */
...
/** @type {import('./types.js?v=20260417-p2').FleetConfig} */
 ...
 * @param {import('./types.js?v=20260417-p2').VehicleSpec[]} vehicles
 * @returns {import('./types.js?v=20260417-p2').VehicleSpec|null}
 */
 ...
 * @param {import('./types.js?v=20260417-p2').Lane[]} lanes
 * @param {import('./types.js?v=20260417-p2').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-p2').FleetConfig} config
 * @returns {import('./types.js?v=20260417-p2').LaneAssignment[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p2').LaneAssignment[]} assignments
 * @param {import('./types.js?v=20260417-p2').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-p2').FleetConfig} config
 * @returns {import('./types.js?v=20260417-p2').FleetSummary[]}
 */
export function computeFleetComposition(assignments, vehicles = DEFAULT_VEHICLES, config = DEFAULT_CONFIG) {
  ...
  /** @type {Map<string, import('./types.js?v=20260417-p2').LaneAssignment[]>} */
 ...
 * @param {import('./types.js?v=20260417-p2').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-p2').FleetConfig} config
 * @returns {import('./types.js?v=20260417-p2').FleetResult}
 */
 ...
 * @returns {import('./types.js?v=20260417-p2').AtriBenchmark}
 */
 ...
 * @param {import('./types.js?v=20260417-p2').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-p2').FleetConfig} config
 * @returns {import('./types.js?v=20260417-p2').SensitivityMatrix}
 */
 ...
 * @param {import('./types.js?v=20260417-p2').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-p2').FleetConfig} config
 * @returns {import('./types.js?v=20260417-p2').VolumeSensitivity[]}
 */
...
/** @type {import('./types.js?v=20260417-p2').Lane[]} */
