...
/** @type {import('./types.js?v=20260417-mH').VehicleSpec[]} */
...
/** @type {import('./types.js?v=20260417-mH').FleetConfig} */
 ...
 * @param {import('./types.js?v=20260417-mH').VehicleSpec[]} vehicles
 * @returns {import('./types.js?v=20260417-mH').VehicleSpec|null}
 */
 ...
 * @param {import('./types.js?v=20260417-mH').Lane[]} lanes
 * @param {import('./types.js?v=20260417-mH').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-mH').FleetConfig} config
 * @returns {import('./types.js?v=20260417-mH').LaneAssignment[]}
 */
 ...
 * @param {import('./types.js?v=20260417-mH').LaneAssignment[]} assignments
 * @param {import('./types.js?v=20260417-mH').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-mH').FleetConfig} config
 * @returns {import('./types.js?v=20260417-mH').FleetSummary[]}
 */
export function computeFleetComposition(assignments, vehicles = DEFAULT_VEHICLES, config = DEFAULT_CONFIG) {
  ...
  /** @type {Map<string, import('./types.js?v=20260417-mH').LaneAssignment[]>} */
 ...
 * @param {import('./types.js?v=20260417-mH').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-mH').FleetConfig} config
 * @returns {import('./types.js?v=20260417-mH').FleetResult}
 */
 ...
 * @returns {import('./types.js?v=20260417-mH').AtriBenchmark}
 */
 ...
 * @param {import('./types.js?v=20260417-mH').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-mH').FleetConfig} config
 * @returns {import('./types.js?v=20260417-mH').SensitivityMatrix}
 */
 ...
 * @param {import('./types.js?v=20260417-mH').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-mH').FleetConfig} config
 * @returns {import('./types.js?v=20260417-mH').VolumeSensitivity[]}
 */
...
/** @type {import('./types.js?v=20260417-mH').Lane[]} */
