...
/** @type {import('./types.js?v=20260417-p5').VehicleSpec[]} */
...
/** @type {import('./types.js?v=20260417-p5').FleetConfig} */
 ...
 * @param {import('./types.js?v=20260417-p5').VehicleSpec[]} vehicles
 * @returns {import('./types.js?v=20260417-p5').VehicleSpec|null}
 */
 ...
 * @param {import('./types.js?v=20260417-p5').Lane[]} lanes
 * @param {import('./types.js?v=20260417-p5').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-p5').FleetConfig} config
 * @returns {import('./types.js?v=20260417-p5').LaneAssignment[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p5').LaneAssignment[]} assignments
 * @param {import('./types.js?v=20260417-p5').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-p5').FleetConfig} config
 * @returns {import('./types.js?v=20260417-p5').FleetSummary[]}
 */
export function computeFleetComposition(assignments, vehicles = DEFAULT_VEHICLES, config = DEFAULT_CONFIG) {
  ...
  /** @type {Map<string, import('./types.js?v=20260417-p5').LaneAssignment[]>} */
 ...
 * @param {import('./types.js?v=20260417-p5').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-p5').FleetConfig} config
 * @returns {import('./types.js?v=20260417-p5').FleetResult}
 */
 ...
 * @returns {import('./types.js?v=20260417-p5').AtriBenchmark}
 */
 ...
 * @param {import('./types.js?v=20260417-p5').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-p5').FleetConfig} config
 * @returns {import('./types.js?v=20260417-p5').SensitivityMatrix}
 */
 ...
 * @param {import('./types.js?v=20260417-p5').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-p5').FleetConfig} config
 * @returns {import('./types.js?v=20260417-p5').VolumeSensitivity[]}
 */
...
/** @type {import('./types.js?v=20260417-p5').Lane[]} */
