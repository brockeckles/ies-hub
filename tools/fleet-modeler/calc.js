...
/** @type {import('./types.js?v=20260417-m8').VehicleSpec[]} */
...
/** @type {import('./types.js?v=20260417-m8').FleetConfig} */
 ...
 * @param {import('./types.js?v=20260417-m8').VehicleSpec[]} vehicles
 * @returns {import('./types.js?v=20260417-m8').VehicleSpec|null}
 */
 ...
 * @param {import('./types.js?v=20260417-m8').Lane[]} lanes
 * @param {import('./types.js?v=20260417-m8').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-m8').FleetConfig} config
 * @returns {import('./types.js?v=20260417-m8').LaneAssignment[]}
 */
 ...
 * @param {import('./types.js?v=20260417-m8').LaneAssignment[]} assignments
 * @param {import('./types.js?v=20260417-m8').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-m8').FleetConfig} config
 * @returns {import('./types.js?v=20260417-m8').FleetSummary[]}
 */
export function computeFleetComposition(assignments, vehicles = DEFAULT_VEHICLES, config = DEFAULT_CONFIG) {
  ...
  /** @type {Map<string, import('./types.js?v=20260417-m8').LaneAssignment[]>} */
 ...
 * @param {import('./types.js?v=20260417-m8').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-m8').FleetConfig} config
 * @returns {import('./types.js?v=20260417-m8').FleetResult}
 */
 ...
 * @returns {import('./types.js?v=20260417-m8').AtriBenchmark}
 */
 ...
 * @param {import('./types.js?v=20260417-m8').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-m8').FleetConfig} config
 * @returns {import('./types.js?v=20260417-m8').SensitivityMatrix}
 */
 ...
 * @param {import('./types.js?v=20260417-m8').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-m8').FleetConfig} config
 * @returns {import('./types.js?v=20260417-m8').VolumeSensitivity[]}
 */
...
/** @type {import('./types.js?v=20260417-m8').Lane[]} */
