...
/** @type {import('./types.js?v=20260417-mE').VehicleSpec[]} */
...
/** @type {import('./types.js?v=20260417-mE').FleetConfig} */
 ...
 * @param {import('./types.js?v=20260417-mE').VehicleSpec[]} vehicles
 * @returns {import('./types.js?v=20260417-mE').VehicleSpec|null}
 */
 ...
 * @param {import('./types.js?v=20260417-mE').Lane[]} lanes
 * @param {import('./types.js?v=20260417-mE').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-mE').FleetConfig} config
 * @returns {import('./types.js?v=20260417-mE').LaneAssignment[]}
 */
 ...
 * @param {import('./types.js?v=20260417-mE').LaneAssignment[]} assignments
 * @param {import('./types.js?v=20260417-mE').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-mE').FleetConfig} config
 * @returns {import('./types.js?v=20260417-mE').FleetSummary[]}
 */
export function computeFleetComposition(assignments, vehicles = DEFAULT_VEHICLES, config = DEFAULT_CONFIG) {
  ...
  /** @type {Map<string, import('./types.js?v=20260417-mE').LaneAssignment[]>} */
 ...
 * @param {import('./types.js?v=20260417-mE').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-mE').FleetConfig} config
 * @returns {import('./types.js?v=20260417-mE').FleetResult}
 */
 ...
 * @returns {import('./types.js?v=20260417-mE').AtriBenchmark}
 */
 ...
 * @param {import('./types.js?v=20260417-mE').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-mE').FleetConfig} config
 * @returns {import('./types.js?v=20260417-mE').SensitivityMatrix}
 */
 ...
 * @param {import('./types.js?v=20260417-mE').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-mE').FleetConfig} config
 * @returns {import('./types.js?v=20260417-mE').VolumeSensitivity[]}
 */
...
/** @type {import('./types.js?v=20260417-mE').Lane[]} */
