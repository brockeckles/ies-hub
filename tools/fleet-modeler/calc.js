 ...
 * @returns {import('./types.js?v=20260418-sI').VehicleSpec|null}
 */
 ...
 * @returns {import('./types.js?v=20260418-sI').LaneAssignment[]}
 */
 ...
 * @param {import('./types.js?v=20260418-sI').LaneAssignment[]} assignments
 * @param {import('./types.js?v=20260418-sI').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260418-sI').FleetConfig} config
 * @returns {import('./types.js?v=20260418-sI').FleetSummary[]}
 */
export function computeFleetComposition(assignments, vehicles = DEFAULT_VEHICLES, config = DEFAULT_CONFIG) {
  ...
  /** @type {Map<string, import('./types.js?v=20260418-sI').LaneAssignment[]>} */
 ...
 * @returns {import('./types.js?v=20260418-sI').AtriBenchmark}
 */
 ...
 * @param {import('./types.js?v=20260418-sI').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260418-sI').FleetConfig} config
 * @returns {import('./types.js?v=20260418-sI').SensitivityMatrix}
 */
 ...
 * @param {import('./types.js?v=20260418-sI').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260418-sI').FleetConfig} config
 * @returns {import('./types.js?v=20260418-sI').VolumeSensitivity[]}
 */
