...
/** @type {import('./types.js?v=20260417-mF').VehicleSpec[]} */
...
/** @type {import('./types.js?v=20260417-mF').FleetConfig} */
 ...
 * @param {import('./types.js?v=20260417-mF').VehicleSpec[]} vehicles
 * @returns {import('./types.js?v=20260417-mF').VehicleSpec|null}
 */
 ...
 * @param {import('./types.js?v=20260417-mF').Lane[]} lanes
 * @param {import('./types.js?v=20260417-mF').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-mF').FleetConfig} config
 * @returns {import('./types.js?v=20260417-mF').LaneAssignment[]}
 */
 ...
 * @param {import('./types.js?v=20260417-mF').LaneAssignment[]} assignments
 * @param {import('./types.js?v=20260417-mF').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-mF').FleetConfig} config
 * @returns {import('./types.js?v=20260417-mF').FleetSummary[]}
 */
export function computeFleetComposition(assignments, vehicles = DEFAULT_VEHICLES, config = DEFAULT_CONFIG) {
  ...
  /** @type {Map<string, import('./types.js?v=20260417-mF').LaneAssignment[]>} */
 ...
 * @param {import('./types.js?v=20260417-mF').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-mF').FleetConfig} config
 * @returns {import('./types.js?v=20260417-mF').FleetResult}
 */
 ...
 * @returns {import('./types.js?v=20260417-mF').AtriBenchmark}
 */
 ...
 * @param {import('./types.js?v=20260417-mF').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-mF').FleetConfig} config
 * @returns {import('./types.js?v=20260417-mF').SensitivityMatrix}
 */
 ...
 * @param {import('./types.js?v=20260417-mF').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-mF').FleetConfig} config
 * @returns {import('./types.js?v=20260417-mF').VolumeSensitivity[]}
 */
...
/** @type {import('./types.js?v=20260417-mF').Lane[]} */
