 ...
 * @param {import('./types.js?v=20260418-s3').VehicleSpec[]} vehicles
 * @returns {import('./types.js?v=20260418-s3').VehicleSpec|null}
 */
 ...
 * @param {import('./types.js?v=20260418-s3').Lane[]} lanes
 * @param {import('./types.js?v=20260418-s3').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260418-s3').FleetConfig} config
 * @returns {import('./types.js?v=20260418-s3').LaneAssignment[]}
 */
 ...
 * @param {import('./types.js?v=20260418-s3').LaneAssignment[]} assignments
 * @param {import('./types.js?v=20260418-s3').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260418-s3').FleetConfig} config
 * @returns {import('./types.js?v=20260418-s3').FleetSummary[]}
 */
export function computeFleetComposition(assignments, vehicles = DEFAULT_VEHICLES, config = DEFAULT_CONFIG) {
  ...
  /** @type {Map<string, import('./types.js?v=20260418-s3').LaneAssignment[]>} */
 ...
 * @param {import('./types.js?v=20260418-s3').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260418-s3').FleetConfig} config
 * @returns {import('./types.js?v=20260418-s3').FleetResult}
 */
 ...
 * @returns {import('./types.js?v=20260418-s3').AtriBenchmark}
 */
 ...
 * @param {import('./types.js?v=20260418-s3').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260418-s3').FleetConfig} config
 * @returns {import('./types.js?v=20260418-s3').SensitivityMatrix}
 */
 ...
 * @param {import('./types.js?v=20260418-s3').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260418-s3').FleetConfig} config
 * @returns {import('./types.js?v=20260418-s3').VolumeSensitivity[]}
 */
