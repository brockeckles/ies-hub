...
/** @type {import('./types.js?v=20260417-mI').VehicleSpec[]} */
...
/** @type {import('./types.js?v=20260417-mI').FleetConfig} */
 ...
 * @param {import('./types.js?v=20260417-mI').VehicleSpec[]} vehicles
 * @returns {import('./types.js?v=20260417-mI').VehicleSpec|null}
 */
 ...
 * @param {import('./types.js?v=20260417-mI').Lane[]} lanes
 * @param {import('./types.js?v=20260417-mI').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-mI').FleetConfig} config
 * @returns {import('./types.js?v=20260417-mI').LaneAssignment[]}
 */
 ...
 * @param {import('./types.js?v=20260417-mI').LaneAssignment[]} assignments
 * @param {import('./types.js?v=20260417-mI').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-mI').FleetConfig} config
 * @returns {import('./types.js?v=20260417-mI').FleetSummary[]}
 */
export function computeFleetComposition(assignments, vehicles = DEFAULT_VEHICLES, config = DEFAULT_CONFIG) {
  ...
  /** @type {Map<string, import('./types.js?v=20260417-mI').LaneAssignment[]>} */
 ...
 * @param {import('./types.js?v=20260417-mI').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-mI').FleetConfig} config
 * @returns {import('./types.js?v=20260417-mI').FleetResult}
 */
 ...
 * @returns {import('./types.js?v=20260417-mI').AtriBenchmark}
 */
 ...
 * @param {import('./types.js?v=20260417-mI').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-mI').FleetConfig} config
 * @returns {import('./types.js?v=20260417-mI').SensitivityMatrix}
 */
 ...
 * @param {import('./types.js?v=20260417-mI').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-mI').FleetConfig} config
 * @returns {import('./types.js?v=20260417-mI').VolumeSensitivity[]}
 */
...
/** @type {import('./types.js?v=20260417-mI').Lane[]} */
