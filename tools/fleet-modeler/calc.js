...
/** @type {import('./types.js?v=20260418-s8').VehicleSpec[]} */
...
/** @type {import('./types.js?v=20260418-s8').FleetConfig} */
 ...
 * @param {import('./types.js?v=20260418-s8').VehicleSpec[]} vehicles
 * @returns {import('./types.js?v=20260418-s8').VehicleSpec|null}
 */
 ...
 * @param {import('./types.js?v=20260418-s8').Lane[]} lanes
 * @param {import('./types.js?v=20260418-s8').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260418-s8').FleetConfig} config
 * @returns {import('./types.js?v=20260418-s8').LaneAssignment[]}
 */
 ...
 * @param {import('./types.js?v=20260418-s8').LaneAssignment[]} assignments
 * @param {import('./types.js?v=20260418-s8').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260418-s8').FleetConfig} config
 * @returns {import('./types.js?v=20260418-s8').FleetSummary[]}
 */
export function computeFleetComposition(assignments, vehicles = DEFAULT_VEHICLES, config = DEFAULT_CONFIG) {
  ...
  /** @type {Map<string, import('./types.js?v=20260418-s8').LaneAssignment[]>} */
 ...
 * @param {import('./types.js?v=20260418-s8').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260418-s8').FleetConfig} config
 * @returns {import('./types.js?v=20260418-s8').FleetResult}
 */
 ...
 * @returns {import('./types.js?v=20260418-s8').AtriBenchmark}
 */
 ...
 * @param {import('./types.js?v=20260418-s8').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260418-s8').FleetConfig} config
 * @returns {import('./types.js?v=20260418-s8').SensitivityMatrix}
 */
 ...
 * @param {import('./types.js?v=20260418-s8').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260418-s8').FleetConfig} config
 * @returns {import('./types.js?v=20260418-s8').VolumeSensitivity[]}
 */
...
/** @type {import('./types.js?v=20260418-s8').Lane[]} */
