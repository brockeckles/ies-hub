...
/** @type {import('./types.js?v=20260418-s9').VehicleSpec[]} */
...
/** @type {import('./types.js?v=20260418-s9').FleetConfig} */
 ...
 * @param {import('./types.js?v=20260418-s9').VehicleSpec[]} vehicles
 * @returns {import('./types.js?v=20260418-s9').VehicleSpec|null}
 */
 ...
 * @param {import('./types.js?v=20260418-s9').Lane[]} lanes
 * @param {import('./types.js?v=20260418-s9').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260418-s9').FleetConfig} config
 * @returns {import('./types.js?v=20260418-s9').LaneAssignment[]}
 */
 ...
 * @param {import('./types.js?v=20260418-s9').LaneAssignment[]} assignments
 * @param {import('./types.js?v=20260418-s9').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260418-s9').FleetConfig} config
 * @returns {import('./types.js?v=20260418-s9').FleetSummary[]}
 */
export function computeFleetComposition(assignments, vehicles = DEFAULT_VEHICLES, config = DEFAULT_CONFIG) {
  ...
  /** @type {Map<string, import('./types.js?v=20260418-s9').LaneAssignment[]>} */
 ...
 * @param {import('./types.js?v=20260418-s9').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260418-s9').FleetConfig} config
 * @returns {import('./types.js?v=20260418-s9').FleetResult}
 */
 ...
 * @returns {import('./types.js?v=20260418-s9').AtriBenchmark}
 */
 ...
 * @param {import('./types.js?v=20260418-s9').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260418-s9').FleetConfig} config
 * @returns {import('./types.js?v=20260418-s9').SensitivityMatrix}
 */
 ...
 * @param {import('./types.js?v=20260418-s9').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260418-s9').FleetConfig} config
 * @returns {import('./types.js?v=20260418-s9').VolumeSensitivity[]}
 */
...
/** @type {import('./types.js?v=20260418-s9').Lane[]} */
