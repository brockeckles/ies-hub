...
/** @type {import('./types.js?v=20260417-m4').VehicleSpec[]} */
...
/** @type {import('./types.js?v=20260417-m4').FleetConfig} */
 ...
 * @param {import('./types.js?v=20260417-m4').VehicleSpec[]} vehicles
 * @returns {import('./types.js?v=20260417-m4').VehicleSpec|null}
 */
 ...
 * @param {import('./types.js?v=20260417-m4').Lane[]} lanes
 * @param {import('./types.js?v=20260417-m4').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-m4').FleetConfig} config
 * @returns {import('./types.js?v=20260417-m4').LaneAssignment[]}
 */
 ...
 * @param {import('./types.js?v=20260417-m4').LaneAssignment[]} assignments
 * @param {import('./types.js?v=20260417-m4').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-m4').FleetConfig} config
 * @returns {import('./types.js?v=20260417-m4').FleetSummary[]}
 */
export function computeFleetComposition(assignments, vehicles = DEFAULT_VEHICLES, config = DEFAULT_CONFIG) {
  ...
  /** @type {Map<string, import('./types.js?v=20260417-m4').LaneAssignment[]>} */
 ...
 * @param {import('./types.js?v=20260417-m4').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-m4').FleetConfig} config
 * @returns {import('./types.js?v=20260417-m4').FleetResult}
 */
 ...
 * @returns {import('./types.js?v=20260417-m4').AtriBenchmark}
 */
 ...
 * @param {import('./types.js?v=20260417-m4').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-m4').FleetConfig} config
 * @returns {import('./types.js?v=20260417-m4').SensitivityMatrix}
 */
 ...
 * @param {import('./types.js?v=20260417-m4').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-m4').FleetConfig} config
 * @returns {import('./types.js?v=20260417-m4').VolumeSensitivity[]}
 */
...
/** @type {import('./types.js?v=20260417-m4').Lane[]} */
