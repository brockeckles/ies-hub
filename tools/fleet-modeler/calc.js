...
/** @type {import('./types.js?v=20260417-p7').VehicleSpec[]} */
...
/** @type {import('./types.js?v=20260417-p7').FleetConfig} */
 ...
 * @param {import('./types.js?v=20260417-p7').VehicleSpec[]} vehicles
 * @returns {import('./types.js?v=20260417-p7').VehicleSpec|null}
 */
 ...
 * @param {import('./types.js?v=20260417-p7').Lane[]} lanes
 * @param {import('./types.js?v=20260417-p7').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-p7').FleetConfig} config
 * @returns {import('./types.js?v=20260417-p7').LaneAssignment[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p7').LaneAssignment[]} assignments
 * @param {import('./types.js?v=20260417-p7').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-p7').FleetConfig} config
 * @returns {import('./types.js?v=20260417-p7').FleetSummary[]}
 */
export function computeFleetComposition(assignments, vehicles = DEFAULT_VEHICLES, config = DEFAULT_CONFIG) {
  ...
  /** @type {Map<string, import('./types.js?v=20260417-p7').LaneAssignment[]>} */
 ...
 * @param {import('./types.js?v=20260417-p7').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-p7').FleetConfig} config
 * @returns {import('./types.js?v=20260417-p7').FleetResult}
 */
 ...
 * @returns {import('./types.js?v=20260417-p7').AtriBenchmark}
 */
 ...
 * @param {import('./types.js?v=20260417-p7').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-p7').FleetConfig} config
 * @returns {import('./types.js?v=20260417-p7').SensitivityMatrix}
 */
 ...
 * @param {import('./types.js?v=20260417-p7').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-p7').FleetConfig} config
 * @returns {import('./types.js?v=20260417-p7').VolumeSensitivity[]}
 */
...
/** @type {import('./types.js?v=20260417-p7').Lane[]} */
