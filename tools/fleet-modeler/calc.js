...
/** @type {import('./types.js?v=20260418-s1').VehicleSpec[]} */
...
/** @type {import('./types.js?v=20260418-s1').FleetConfig} */
 ...
 * @param {import('./types.js?v=20260418-s1').VehicleSpec[]} vehicles
 * @returns {import('./types.js?v=20260418-s1').VehicleSpec|null}
 */
 ...
 * @param {import('./types.js?v=20260418-s1').Lane[]} lanes
 * @param {import('./types.js?v=20260418-s1').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260418-s1').FleetConfig} config
 * @returns {import('./types.js?v=20260418-s1').LaneAssignment[]}
 */
 ...
 * @param {import('./types.js?v=20260418-s1').LaneAssignment[]} assignments
 * @param {import('./types.js?v=20260418-s1').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260418-s1').FleetConfig} config
 * @returns {import('./types.js?v=20260418-s1').FleetSummary[]}
 */
export function computeFleetComposition(assignments, vehicles = DEFAULT_VEHICLES, config = DEFAULT_CONFIG) {
  ...
  /** @type {Map<string, import('./types.js?v=20260418-s1').LaneAssignment[]>} */
 ...
 * @param {import('./types.js?v=20260418-s1').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260418-s1').FleetConfig} config
 * @returns {import('./types.js?v=20260418-s1').FleetResult}
 */
 ...
 * @returns {import('./types.js?v=20260418-s1').AtriBenchmark}
 */
 ...
 * @param {import('./types.js?v=20260418-s1').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260418-s1').FleetConfig} config
 * @returns {import('./types.js?v=20260418-s1').SensitivityMatrix}
 */
 ...
 * @param {import('./types.js?v=20260418-s1').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260418-s1').FleetConfig} config
 * @returns {import('./types.js?v=20260418-s1').VolumeSensitivity[]}
 */
...
/** @type {import('./types.js?v=20260418-s1').Lane[]} */
