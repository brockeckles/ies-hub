...
/** @type {import('./types.js?v=20260417-p8').VehicleSpec[]} */
...
/** @type {import('./types.js?v=20260417-p8').FleetConfig} */
 ...
 * @param {import('./types.js?v=20260417-p8').VehicleSpec[]} vehicles
 * @returns {import('./types.js?v=20260417-p8').VehicleSpec|null}
 */
 ...
 * @param {import('./types.js?v=20260417-p8').Lane[]} lanes
 * @param {import('./types.js?v=20260417-p8').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-p8').FleetConfig} config
 * @returns {import('./types.js?v=20260417-p8').LaneAssignment[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p8').LaneAssignment[]} assignments
 * @param {import('./types.js?v=20260417-p8').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-p8').FleetConfig} config
 * @returns {import('./types.js?v=20260417-p8').FleetSummary[]}
 */
export function computeFleetComposition(assignments, vehicles = DEFAULT_VEHICLES, config = DEFAULT_CONFIG) {
  ...
  /** @type {Map<string, import('./types.js?v=20260417-p8').LaneAssignment[]>} */
 ...
 * @param {import('./types.js?v=20260417-p8').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-p8').FleetConfig} config
 * @returns {import('./types.js?v=20260417-p8').FleetResult}
 */
 ...
 * @returns {import('./types.js?v=20260417-p8').AtriBenchmark}
 */
 ...
 * @param {import('./types.js?v=20260417-p8').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-p8').FleetConfig} config
 * @returns {import('./types.js?v=20260417-p8').SensitivityMatrix}
 */
 ...
 * @param {import('./types.js?v=20260417-p8').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-p8').FleetConfig} config
 * @returns {import('./types.js?v=20260417-p8').VolumeSensitivity[]}
 */
...
/** @type {import('./types.js?v=20260417-p8').Lane[]} */
