 ...
 * @param {import('./types.js?v=20260418-s4').VehicleSpec[]} vehicles
 * @returns {import('./types.js?v=20260418-s4').VehicleSpec|null}
 */
 ...
 * @param {import('./types.js?v=20260418-s4').Lane[]} lanes
 * @param {import('./types.js?v=20260418-s4').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260418-s4').FleetConfig} config
 * @returns {import('./types.js?v=20260418-s4').LaneAssignment[]}
 */
 ...
 * @param {import('./types.js?v=20260418-s4').LaneAssignment[]} assignments
 * @param {import('./types.js?v=20260418-s4').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260418-s4').FleetConfig} config
 * @returns {import('./types.js?v=20260418-s4').FleetSummary[]}
 */
export function computeFleetComposition(assignments, vehicles = DEFAULT_VEHICLES, config = DEFAULT_CONFIG) {
  ...
  /** @type {Map<string, import('./types.js?v=20260418-s4').LaneAssignment[]>} */
 ...
 * @param {import('./types.js?v=20260418-s4').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260418-s4').FleetConfig} config
 * @returns {import('./types.js?v=20260418-s4').FleetResult}
 */
 ...
 * @returns {import('./types.js?v=20260418-s4').AtriBenchmark}
 */
 ...
 * @param {import('./types.js?v=20260418-s4').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260418-s4').FleetConfig} config
 * @returns {import('./types.js?v=20260418-s4').SensitivityMatrix}
 */
 ...
 * @param {import('./types.js?v=20260418-s4').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260418-s4').FleetConfig} config
 * @returns {import('./types.js?v=20260418-s4').VolumeSensitivity[]}
 */
