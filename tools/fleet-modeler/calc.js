 ...
 * @param {import('./types.js?v=20260418-sG').VehicleSpec[]} vehicles
 * @returns {import('./types.js?v=20260418-sG').VehicleSpec|null}
 */
 ...
 * @param {import('./types.js?v=20260418-sG').Lane[]} lanes
 * @param {import('./types.js?v=20260418-sG').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260418-sG').FleetConfig} config
 * @returns {import('./types.js?v=20260418-sG').LaneAssignment[]}
 */
 ...
 * @param {import('./types.js?v=20260418-sG').LaneAssignment[]} assignments
 * @param {import('./types.js?v=20260418-sG').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260418-sG').FleetConfig} config
 * @returns {import('./types.js?v=20260418-sG').FleetSummary[]}
 */
export function computeFleetComposition(assignments, vehicles = DEFAULT_VEHICLES, config = DEFAULT_CONFIG) {
  ...
  /** @type {Map<string, import('./types.js?v=20260418-sG').LaneAssignment[]>} */
 ...
 * @param {import('./types.js?v=20260418-sG').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260418-sG').FleetConfig} config
 * @returns {import('./types.js?v=20260418-sG').FleetResult}
 */
 ...
 * @returns {import('./types.js?v=20260418-sG').AtriBenchmark}
 */
 ...
 * @param {import('./types.js?v=20260418-sG').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260418-sG').FleetConfig} config
 * @returns {import('./types.js?v=20260418-sG').SensitivityMatrix}
 */
 ...
 * @param {import('./types.js?v=20260418-sG').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260418-sG').FleetConfig} config
 * @returns {import('./types.js?v=20260418-sG').VolumeSensitivity[]}
 */
