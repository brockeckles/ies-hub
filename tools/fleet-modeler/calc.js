...
/** @type {import('./types.js?v=20260417-mD').VehicleSpec[]} */
...
/** @type {import('./types.js?v=20260417-mD').FleetConfig} */
 ...
 * @param {import('./types.js?v=20260417-mD').VehicleSpec[]} vehicles
 * @returns {import('./types.js?v=20260417-mD').VehicleSpec|null}
 */
 ...
 * @param {import('./types.js?v=20260417-mD').Lane[]} lanes
 * @param {import('./types.js?v=20260417-mD').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-mD').FleetConfig} config
 * @returns {import('./types.js?v=20260417-mD').LaneAssignment[]}
 */
 ...
 * @param {import('./types.js?v=20260417-mD').LaneAssignment[]} assignments
 * @param {import('./types.js?v=20260417-mD').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-mD').FleetConfig} config
 * @returns {import('./types.js?v=20260417-mD').FleetSummary[]}
 */
export function computeFleetComposition(assignments, vehicles = DEFAULT_VEHICLES, config = DEFAULT_CONFIG) {
  ...
  /** @type {Map<string, import('./types.js?v=20260417-mD').LaneAssignment[]>} */
 ...
 * @param {import('./types.js?v=20260417-mD').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-mD').FleetConfig} config
 * @returns {import('./types.js?v=20260417-mD').FleetResult}
 */
 ...
 * @returns {import('./types.js?v=20260417-mD').AtriBenchmark}
 */
 ...
 * @param {import('./types.js?v=20260417-mD').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-mD').FleetConfig} config
 * @returns {import('./types.js?v=20260417-mD').SensitivityMatrix}
 */
 ...
 * @param {import('./types.js?v=20260417-mD').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-mD').FleetConfig} config
 * @returns {import('./types.js?v=20260417-mD').VolumeSensitivity[]}
 */
...
/** @type {import('./types.js?v=20260417-mD').Lane[]} */
