...
/** @type {import('./types.js?v=20260417-m1').VehicleSpec[]} */
...
/** @type {import('./types.js?v=20260417-m1').FleetConfig} */
 ...
 * @param {import('./types.js?v=20260417-m1').VehicleSpec[]} vehicles
 * @returns {import('./types.js?v=20260417-m1').VehicleSpec|null}
 */
 ...
 * @param {import('./types.js?v=20260417-m1').Lane[]} lanes
 * @param {import('./types.js?v=20260417-m1').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-m1').FleetConfig} config
 * @returns {import('./types.js?v=20260417-m1').LaneAssignment[]}
 */
 ...
 * @param {import('./types.js?v=20260417-m1').LaneAssignment[]} assignments
 * @param {import('./types.js?v=20260417-m1').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-m1').FleetConfig} config
 * @returns {import('./types.js?v=20260417-m1').FleetSummary[]}
 */
export function computeFleetComposition(assignments, vehicles = DEFAULT_VEHICLES, config = DEFAULT_CONFIG) {
  ...
  /** @type {Map<string, import('./types.js?v=20260417-m1').LaneAssignment[]>} */
 ...
 * @param {import('./types.js?v=20260417-m1').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-m1').FleetConfig} config
 * @returns {import('./types.js?v=20260417-m1').FleetResult}
 */
 ...
 * @returns {import('./types.js?v=20260417-m1').AtriBenchmark}
 */
 ...
 * @param {import('./types.js?v=20260417-m1').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-m1').FleetConfig} config
 * @returns {import('./types.js?v=20260417-m1').SensitivityMatrix}
 */
 ...
 * @param {import('./types.js?v=20260417-m1').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-m1').FleetConfig} config
 * @returns {import('./types.js?v=20260417-m1').VolumeSensitivity[]}
 */
...
/** @type {import('./types.js?v=20260417-m1').Lane[]} */
