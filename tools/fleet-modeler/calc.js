...
/** @type {import('./types.js?v=20260417-m3').VehicleSpec[]} */
...
/** @type {import('./types.js?v=20260417-m3').FleetConfig} */
 ...
 * @param {import('./types.js?v=20260417-m3').VehicleSpec[]} vehicles
 * @returns {import('./types.js?v=20260417-m3').VehicleSpec|null}
 */
 ...
 * @param {import('./types.js?v=20260417-m3').Lane[]} lanes
 * @param {import('./types.js?v=20260417-m3').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-m3').FleetConfig} config
 * @returns {import('./types.js?v=20260417-m3').LaneAssignment[]}
 */
 ...
 * @param {import('./types.js?v=20260417-m3').LaneAssignment[]} assignments
 * @param {import('./types.js?v=20260417-m3').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-m3').FleetConfig} config
 * @returns {import('./types.js?v=20260417-m3').FleetSummary[]}
 */
export function computeFleetComposition(assignments, vehicles = DEFAULT_VEHICLES, config = DEFAULT_CONFIG) {
  ...
  /** @type {Map<string, import('./types.js?v=20260417-m3').LaneAssignment[]>} */
 ...
 * @param {import('./types.js?v=20260417-m3').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-m3').FleetConfig} config
 * @returns {import('./types.js?v=20260417-m3').FleetResult}
 */
 ...
 * @returns {import('./types.js?v=20260417-m3').AtriBenchmark}
 */
 ...
 * @param {import('./types.js?v=20260417-m3').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-m3').FleetConfig} config
 * @returns {import('./types.js?v=20260417-m3').SensitivityMatrix}
 */
 ...
 * @param {import('./types.js?v=20260417-m3').VehicleSpec[]} vehicles
 * @param {import('./types.js?v=20260417-m3').FleetConfig} config
 * @returns {import('./types.js?v=20260417-m3').VolumeSensitivity[]}
 */
...
/** @type {import('./types.js?v=20260417-m3').Lane[]} */
