...
import { state } from '../../shared/state.js?v=20260418-s2';
import * as calc from './calc.js?v=20260418-s2';
import * as api from './api.js?v=20260418-s2';
...
/** @type {{ templates: import('./types.js?v=20260418-s2').MostTemplate[], allowanceProfiles: import('./types.js?v=20260418-s2').AllowanceProfile[] }} */
let refData = { templates: [], allowanceProfiles: [] };

/** @type {import('./types.js?v=20260418-s2').MostTemplate|null} */
let selectedTemplate = null;

/** @type {import('./types.js?v=20260418-s2').MostElement[]} */
...
// --- Analysis state ---
/** @type {import('./types.js?v=20260418-s2').LaborAnalysis} */
let analysis = createEmptyAnalysis();

// --- Workflow state ---
/** @type {import('./types.js?v=20260418-s2').Workflow} */
...
function pushToCostModel() {
  ...
  /** @type {import('./types.js?v=20260418-s2').MostToCmPayload} */
  const payload = {
    laborLines: cmLines,
    operatingDays: analysis.operating_days,
    shiftHours: analysis.shift_hours,
...
function groupByProcessArea(templates) {
  /** @type {Record<string, import('./types.js?v=20260418-s2').MostTemplate[]>} */
  const groups = {};
