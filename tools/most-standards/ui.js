...
/** @type {{ templates: import('./types.js?v=20260417-p3').MostTemplate[], allowanceProfiles: import('./types.js?v=20260417-p3').AllowanceProfile[] }} */
let refData = { templates: [], allowanceProfiles: [] };

/** @type {import('./types.js?v=20260417-p3').MostTemplate|null} */
let selectedTemplate = null;

/** @type {import('./types.js?v=20260417-p3').MostElement[]} */
...
// --- Analysis state ---
/** @type {import('./types.js?v=20260417-p3').LaborAnalysis} */
let analysis = createEmptyAnalysis();

// --- Workflow state ---
/** @type {import('./types.js?v=20260417-p3').Workflow} */
...
function pushToCostModel() {
  ...
  /** @type {import('./types.js?v=20260417-p3').MostToCmPayload} */
  const payload = {
    laborLines: cmLines,
    operatingDays: analysis.operating_days,
    shiftHours: analysis.shift_hours,
...
function groupByProcessArea(templates) {
  /** @type {Record<string, import('./types.js?v=20260417-p3').MostTemplate[]>} */
  const groups = {};
