...
/** @type {{ templates: import('./types.js?v=20260417-mF').MostTemplate[], allowanceProfiles: import('./types.js?v=20260417-mF').AllowanceProfile[] }} */
let refData = { templates: [], allowanceProfiles: [] };

/** @type {import('./types.js?v=20260417-mF').MostTemplate|null} */
let selectedTemplate = null;

/** @type {import('./types.js?v=20260417-mF').MostElement[]} */
...
// --- Analysis state ---
/** @type {import('./types.js?v=20260417-mF').LaborAnalysis} */
let analysis = createEmptyAnalysis();

// --- Workflow state ---
/** @type {import('./types.js?v=20260417-mF').Workflow} */
...
function pushToCostModel() {
  ...
  /** @type {import('./types.js?v=20260417-mF').MostToCmPayload} */
  const payload = {
    laborLines: cmLines,
    operatingDays: analysis.operating_days,
    shiftHours: analysis.shift_hours,
...
function groupByProcessArea(templates) {
  /** @type {Record<string, import('./types.js?v=20260417-mF').MostTemplate[]>} */
  const groups = {};
