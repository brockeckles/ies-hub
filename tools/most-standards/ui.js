...
import { bus } from '../../shared/event-bus.js?v=20260417-m3';
import { state } from '../../shared/state.js?v=20260417-m3';
import * as calc from './calc.js?v=20260417-m3';
import * as api from './api.js?v=20260417-m3';
...
/** @type {{ templates: import('./types.js?v=20260417-m3').MostTemplate[], allowanceProfiles: import('./types.js?v=20260417-m3').AllowanceProfile[] }} */
let refData = { templates: [], allowanceProfiles: [] };

/** @type {import('./types.js?v=20260417-m3').MostTemplate|null} */
let selectedTemplate = null;

/** @type {import('./types.js?v=20260417-m3').MostElement[]} */
...
// --- Analysis state ---
/** @type {import('./types.js?v=20260417-m3').LaborAnalysis} */
let analysis = createEmptyAnalysis();

// --- Workflow state ---
/** @type {import('./types.js?v=20260417-m3').Workflow} */
...
function pushToCostModel() {
  ...
  /** @type {import('./types.js?v=20260417-m3').MostToCmPayload} */
  const payload = {
    laborLines: cmLines,
    operatingDays: analysis.operating_days,
    shiftHours: analysis.shift_hours,
...
function groupByProcessArea(templates) {
  /** @type {Record<string, import('./types.js?v=20260417-m3').MostTemplate[]>} */
  const groups = {};
