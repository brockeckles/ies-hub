 ...
 * @param {import('./types.js?v=20260417-p5').AllowanceProfile | { personal_pct?: number, fatigue_pct?: number, delay_pct?: number }} profile
 ...
 * @param {import('./types.js?v=20260417-p5').MostElement[]} elements
 * @returns {number}
 */
 ...
 * @param {import('./types.js?v=20260417-p5').MostElement} element
 ...
 * @param {import('./types.js?v=20260417-p5').AnalysisLine[]} lines
 * @param {number} operatingDays — annual operating days
 * @returns {import('./types.js?v=20260417-p5').AnalysisSummary}
 */
 ...
 * @param {import('./types.js?v=20260417-p5').WorkflowStep[]} steps — with computed adjusted_uph
 * @returns {import('./types.js?v=20260417-p5').WorkflowResult}
 */
 ...
 * @param {import('./types.js?v=20260417-p5').WorkflowStep[]} steps
 ...
 * @returns {import('./types.js?v=20260417-p5').MostToCmPayload['laborLines']}
 */
