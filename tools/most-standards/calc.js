 ...
 * @param {import('./types.js?v=20260417-mE').AllowanceProfile | { personal_pct?: number, fatigue_pct?: number, delay_pct?: number }} profile
 ...
 * @param {import('./types.js?v=20260417-mE').MostElement[]} elements
 * @returns {number}
 */
 ...
 * @param {import('./types.js?v=20260417-mE').MostElement} element
 ...
 * @param {import('./types.js?v=20260417-mE').AnalysisLine[]} lines
 * @param {number} operatingDays — annual operating days
 * @returns {import('./types.js?v=20260417-mE').AnalysisSummary}
 */
 ...
 * @param {import('./types.js?v=20260417-mE').WorkflowStep[]} steps — with computed adjusted_uph
 * @returns {import('./types.js?v=20260417-mE').WorkflowResult}
 */
 ...
 * @param {import('./types.js?v=20260417-mE').WorkflowStep[]} steps
 ...
 * @returns {import('./types.js?v=20260417-mE').MostToCmPayload['laborLines']}
 */
