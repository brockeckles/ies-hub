 ...
 * @param {import('./types.js?v=20260418-s7').AllowanceProfile | { personal_pct?: number, fatigue_pct?: number, delay_pct?: number }} profile
 ...
 * @param {import('./types.js?v=20260418-s7').MostElement[]} elements
 * @returns {number}
 */
 ...
 * @param {import('./types.js?v=20260418-s7').MostElement} element
 ...
 * @param {import('./types.js?v=20260418-s7').AnalysisLine[]} lines
 * @param {number} operatingDays — annual operating days
 * @returns {import('./types.js?v=20260418-s7').AnalysisSummary}
 */
 ...
 * @param {import('./types.js?v=20260418-s7').WorkflowStep[]} steps — with computed adjusted_uph
 * @returns {import('./types.js?v=20260418-s7').WorkflowResult}
 */
 ...
 * @param {import('./types.js?v=20260418-s7').WorkflowStep[]} steps
 ...
 * @returns {import('./types.js?v=20260418-s7').MostToCmPayload['laborLines']}
 */
