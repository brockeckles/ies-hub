 ...
 * @param {import('./types.js?v=20260417-mD').AllowanceProfile | { personal_pct?: number, fatigue_pct?: number, delay_pct?: number }} profile
 ...
 * @param {import('./types.js?v=20260417-mD').MostElement[]} elements
 * @returns {number}
 */
 ...
 * @param {import('./types.js?v=20260417-mD').MostElement} element
 ...
 * @param {import('./types.js?v=20260417-mD').AnalysisLine[]} lines
 * @param {number} operatingDays — annual operating days
 * @returns {import('./types.js?v=20260417-mD').AnalysisSummary}
 */
 ...
 * @param {import('./types.js?v=20260417-mD').WorkflowStep[]} steps — with computed adjusted_uph
 * @returns {import('./types.js?v=20260417-mD').WorkflowResult}
 */
 ...
 * @param {import('./types.js?v=20260417-mD').WorkflowStep[]} steps
 ...
 * @returns {import('./types.js?v=20260417-mD').MostToCmPayload['laborLines']}
 */
