 ...
 * @param {import('./types.js?v=20260418-sH').AllowanceProfile | { personal_pct?: number, fatigue_pct?: number, delay_pct?: number }} profile
 ...
 * @param {import('./types.js?v=20260418-sH').MostElement[]} elements
 * @returns {number}
 */
 ...
 * @param {import('./types.js?v=20260418-sH').MostElement} element
 ...
 * @param {import('./types.js?v=20260418-sH').AnalysisLine[]} lines
 * @param {number} operatingDays — annual operating days
 * @returns {import('./types.js?v=20260418-sH').AnalysisSummary}
 */
 ...
 * @param {import('./types.js?v=20260418-sH').WorkflowStep[]} steps — with computed adjusted_uph
 * @returns {import('./types.js?v=20260418-sH').WorkflowResult}
 */
 ...
 * @param {import('./types.js?v=20260418-sH').WorkflowStep[]} steps
 ...
 * @returns {import('./types.js?v=20260418-sH').MostToCmPayload['laborLines']}
 */
