 ...
 * @param {import('./types.js?v=20260417-mH').AllowanceProfile | { personal_pct?: number, fatigue_pct?: number, delay_pct?: number }} profile
 ...
 * @param {import('./types.js?v=20260417-mH').MostElement[]} elements
 * @returns {number}
 */
 ...
 * @param {import('./types.js?v=20260417-mH').MostElement} element
 ...
 * @param {import('./types.js?v=20260417-mH').AnalysisLine[]} lines
 * @param {number} operatingDays — annual operating days
 * @returns {import('./types.js?v=20260417-mH').AnalysisSummary}
 */
 ...
 * @param {import('./types.js?v=20260417-mH').WorkflowStep[]} steps — with computed adjusted_uph
 * @returns {import('./types.js?v=20260417-mH').WorkflowResult}
 */
 ...
 * @param {import('./types.js?v=20260417-mH').WorkflowStep[]} steps
 ...
 * @returns {import('./types.js?v=20260417-mH').MostToCmPayload['laborLines']}
 */
