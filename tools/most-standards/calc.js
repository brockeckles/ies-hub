 ...
 * @param {import('./types.js?v=20260417-m3').AllowanceProfile | { personal_pct?: number, fatigue_pct?: number, delay_pct?: number }} profile
 ...
 * @param {import('./types.js?v=20260417-m3').MostElement[]} elements
 * @returns {number}
 */
 ...
 * @param {import('./types.js?v=20260417-m3').MostElement} element
 ...
 * @param {import('./types.js?v=20260417-m3').AnalysisLine[]} lines
 * @param {number} operatingDays — annual operating days
 * @returns {import('./types.js?v=20260417-m3').AnalysisSummary}
 */
 ...
 * @param {import('./types.js?v=20260417-m3').WorkflowStep[]} steps — with computed adjusted_uph
 * @returns {import('./types.js?v=20260417-m3').WorkflowResult}
 */
 ...
 * @param {import('./types.js?v=20260417-m3').WorkflowStep[]} steps
 ...
 * @returns {import('./types.js?v=20260417-m3').MostToCmPayload['laborLines']}
 */
