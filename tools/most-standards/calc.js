 ...
 * @param {import('./types.js?v=20260417-mC').AllowanceProfile | { personal_pct?: number, fatigue_pct?: number, delay_pct?: number }} profile
 ...
 * @param {import('./types.js?v=20260417-mC').MostElement[]} elements
 * @returns {number}
 */
 ...
 * @param {import('./types.js?v=20260417-mC').MostElement} element
 ...
 * @param {import('./types.js?v=20260417-mC').AnalysisLine[]} lines
 * @param {number} operatingDays — annual operating days
 * @returns {import('./types.js?v=20260417-mC').AnalysisSummary}
 */
 ...
 * @param {import('./types.js?v=20260417-mC').WorkflowStep[]} steps — with computed adjusted_uph
 * @returns {import('./types.js?v=20260417-mC').WorkflowResult}
 */
 ...
 * @param {import('./types.js?v=20260417-mC').WorkflowStep[]} steps
 ...
 * @returns {import('./types.js?v=20260417-mC').MostToCmPayload['laborLines']}
 */
