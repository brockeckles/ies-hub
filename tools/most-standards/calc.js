 ...
 * @param {import('./types.js?v=20260418-sE').AllowanceProfile | { personal_pct?: number, fatigue_pct?: number, delay_pct?: number }} profile
 ...
 * @param {import('./types.js?v=20260418-sE').MostElement[]} elements
 * @returns {number}
 */
 ...
 * @param {import('./types.js?v=20260418-sE').MostElement} element
 ...
 * @param {import('./types.js?v=20260418-sE').AnalysisLine[]} lines
 * @param {number} operatingDays — annual operating days
 * @returns {import('./types.js?v=20260418-sE').AnalysisSummary}
 */
 ...
 * @param {import('./types.js?v=20260418-sE').WorkflowStep[]} steps — with computed adjusted_uph
 * @returns {import('./types.js?v=20260418-sE').WorkflowResult}
 */
 ...
 * @param {import('./types.js?v=20260418-sE').WorkflowStep[]} steps
 ...
 * @returns {import('./types.js?v=20260418-sE').MostToCmPayload['laborLines']}
 */
