 ...
 * @param {import('./types.js?v=20260418-s8').AllowanceProfile | { personal_pct?: number, fatigue_pct?: number, delay_pct?: number }} profile
 ...
 * @param {import('./types.js?v=20260418-s8').MostElement[]} elements
 * @returns {number}
 */
 ...
 * @param {import('./types.js?v=20260418-s8').MostElement} element
 ...
 * @param {import('./types.js?v=20260418-s8').AnalysisLine[]} lines
 * @param {number} operatingDays — annual operating days
 * @returns {import('./types.js?v=20260418-s8').AnalysisSummary}
 */
 ...
 * @param {import('./types.js?v=20260418-s8').WorkflowStep[]} steps — with computed adjusted_uph
 * @returns {import('./types.js?v=20260418-s8').WorkflowResult}
 */
 ...
 * @param {import('./types.js?v=20260418-s8').WorkflowStep[]} steps
 ...
 * @returns {import('./types.js?v=20260418-s8').MostToCmPayload['laborLines']}
 */
