 ...
 * @param {import('./types.js?v=20260418-sA').AllowanceProfile | { personal_pct?: number, fatigue_pct?: number, delay_pct?: number }} profile
 ...
 * @param {import('./types.js?v=20260418-sA').MostElement[]} elements
 * @returns {number}
 */
 ...
 * @param {import('./types.js?v=20260418-sA').MostElement} element
 ...
 * @param {import('./types.js?v=20260418-sA').AnalysisLine[]} lines
 * @param {number} operatingDays — annual operating days
 * @returns {import('./types.js?v=20260418-sA').AnalysisSummary}
 */
 ...
 * @param {import('./types.js?v=20260418-sA').WorkflowStep[]} steps — with computed adjusted_uph
 * @returns {import('./types.js?v=20260418-sA').WorkflowResult}
 */
 ...
 * @param {import('./types.js?v=20260418-sA').WorkflowStep[]} steps
 ...
 * @returns {import('./types.js?v=20260418-sA').MostToCmPayload['laborLines']}
 */
