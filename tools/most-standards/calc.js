 ...
 * @param {import('./types.js?v=20260418-sG').AllowanceProfile | { personal_pct?: number, fatigue_pct?: number, delay_pct?: number }} profile
 ...
 * @param {import('./types.js?v=20260418-sG').MostElement[]} elements
 * @returns {number}
 */
 ...
 * @param {import('./types.js?v=20260418-sG').MostElement} element
 ...
 * @param {import('./types.js?v=20260418-sG').AnalysisLine[]} lines
 * @param {number} operatingDays — annual operating days
 * @returns {import('./types.js?v=20260418-sG').AnalysisSummary}
 */
 ...
 * @param {import('./types.js?v=20260418-sG').WorkflowStep[]} steps — with computed adjusted_uph
 * @returns {import('./types.js?v=20260418-sG').WorkflowResult}
 */
 ...
 * @param {import('./types.js?v=20260418-sG').WorkflowStep[]} steps
 ...
 * @returns {import('./types.js?v=20260418-sG').MostToCmPayload['laborLines']}
 */
