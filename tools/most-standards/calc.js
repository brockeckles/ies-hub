 ...
 * @param {import('./types.js?v=20260417-mB').AllowanceProfile | { personal_pct?: number, fatigue_pct?: number, delay_pct?: number }} profile
 ...
 * @param {import('./types.js?v=20260417-mB').MostElement[]} elements
 * @returns {number}
 */
 ...
 * @param {import('./types.js?v=20260417-mB').MostElement} element
 ...
 * @param {import('./types.js?v=20260417-mB').AnalysisLine[]} lines
 * @param {number} operatingDays — annual operating days
 * @returns {import('./types.js?v=20260417-mB').AnalysisSummary}
 */
 ...
 * @param {import('./types.js?v=20260417-mB').WorkflowStep[]} steps — with computed adjusted_uph
 * @returns {import('./types.js?v=20260417-mB').WorkflowResult}
 */
 ...
 * @param {import('./types.js?v=20260417-mB').WorkflowStep[]} steps
 ...
 * @returns {import('./types.js?v=20260417-mB').MostToCmPayload['laborLines']}
 */
