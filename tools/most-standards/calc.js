 ...
 * @param {import('./types.js?v=20260418-sD').AllowanceProfile | { personal_pct?: number, fatigue_pct?: number, delay_pct?: number }} profile
 ...
 * @param {import('./types.js?v=20260418-sD').MostElement[]} elements
 * @returns {number}
 */
 ...
 * @param {import('./types.js?v=20260418-sD').MostElement} element
 ...
 * @param {import('./types.js?v=20260418-sD').AnalysisLine[]} lines
 * @param {number} operatingDays — annual operating days
 * @returns {import('./types.js?v=20260418-sD').AnalysisSummary}
 */
 ...
 * @param {import('./types.js?v=20260418-sD').WorkflowStep[]} steps — with computed adjusted_uph
 * @returns {import('./types.js?v=20260418-sD').WorkflowResult}
 */
 ...
 * @param {import('./types.js?v=20260418-sD').WorkflowStep[]} steps
 ...
 * @returns {import('./types.js?v=20260418-sD').MostToCmPayload['laborLines']}
 */
