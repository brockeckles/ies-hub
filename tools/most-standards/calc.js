 ...
 * @param {import('./types.js?v=20260418-sF').AllowanceProfile | { personal_pct?: number, fatigue_pct?: number, delay_pct?: number }} profile
 ...
 * @param {import('./types.js?v=20260418-sF').MostElement[]} elements
 * @returns {number}
 */
 ...
 * @param {import('./types.js?v=20260418-sF').MostElement} element
 ...
 * @param {import('./types.js?v=20260418-sF').AnalysisLine[]} lines
 * @param {number} operatingDays — annual operating days
 * @returns {import('./types.js?v=20260418-sF').AnalysisSummary}
 */
 ...
 * @param {import('./types.js?v=20260418-sF').WorkflowStep[]} steps — with computed adjusted_uph
 * @returns {import('./types.js?v=20260418-sF').WorkflowResult}
 */
 ...
 * @param {import('./types.js?v=20260418-sF').WorkflowStep[]} steps
 ...
 * @returns {import('./types.js?v=20260418-sF').MostToCmPayload['laborLines']}
 */
