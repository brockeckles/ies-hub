 ...
 * @param {import('./types.js?v=20260417-mI').AllowanceProfile | { personal_pct?: number, fatigue_pct?: number, delay_pct?: number }} profile
 ...
 * @param {import('./types.js?v=20260417-mI').MostElement[]} elements
 * @returns {number}
 */
 ...
 * @param {import('./types.js?v=20260417-mI').MostElement} element
 ...
 * @param {import('./types.js?v=20260417-mI').AnalysisLine[]} lines
 * @param {number} operatingDays — annual operating days
 * @returns {import('./types.js?v=20260417-mI').AnalysisSummary}
 */
 ...
 * @param {import('./types.js?v=20260417-mI').WorkflowStep[]} steps — with computed adjusted_uph
 * @returns {import('./types.js?v=20260417-mI').WorkflowResult}
 */
 ...
 * @param {import('./types.js?v=20260417-mI').WorkflowStep[]} steps
 ...
 * @returns {import('./types.js?v=20260417-mI').MostToCmPayload['laborLines']}
 */
