 ...
 * @param {import('./types.js?v=20260417-mF').AllowanceProfile | { personal_pct?: number, fatigue_pct?: number, delay_pct?: number }} profile
 ...
 * @param {import('./types.js?v=20260417-mF').MostElement[]} elements
 * @returns {number}
 */
 ...
 * @param {import('./types.js?v=20260417-mF').MostElement} element
 ...
 * @param {import('./types.js?v=20260417-mF').AnalysisLine[]} lines
 * @param {number} operatingDays — annual operating days
 * @returns {import('./types.js?v=20260417-mF').AnalysisSummary}
 */
 ...
 * @param {import('./types.js?v=20260417-mF').WorkflowStep[]} steps — with computed adjusted_uph
 * @returns {import('./types.js?v=20260417-mF').WorkflowResult}
 */
 ...
 * @param {import('./types.js?v=20260417-mF').WorkflowStep[]} steps
 ...
 * @returns {import('./types.js?v=20260417-mF').MostToCmPayload['laborLines']}
 */
