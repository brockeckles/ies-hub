 ...
 * @param {import('./types.js?v=20260418-sK').AllowanceProfile | { personal_pct?: number, fatigue_pct?: number, delay_pct?: number }} profile
 ...
 * @param {import('./types.js?v=20260418-sK').MostElement[]} elements
 * @returns {number}
 */
 ...
 * @param {import('./types.js?v=20260418-sK').MostElement} element
 ...
 * @param {import('./types.js?v=20260418-sK').AnalysisLine[]} lines
 * @param {number} operatingDays — annual operating days
 * @returns {import('./types.js?v=20260418-sK').AnalysisSummary}
 */
 ...
 * @param {import('./types.js?v=20260418-sK').WorkflowStep[]} steps — with computed adjusted_uph
 * @returns {import('./types.js?v=20260418-sK').WorkflowResult}
 */
 ...
 * @param {import('./types.js?v=20260418-sK').WorkflowStep[]} steps
 ...
 * @param {Map<string|number, import('./types.js?v=20260418-sK').MostTemplate>} [opts.templateMap] — optional: template_id → template for metadata lookup
 * @returns {import('./types.js?v=20260418-sK').MostToCmPayload['laborLines']}
 */
