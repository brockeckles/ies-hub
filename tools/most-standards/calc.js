 ...
 * @param {import('./types.js?v=20260418-sB').AllowanceProfile | { personal_pct?: number, fatigue_pct?: number, delay_pct?: number }} profile
 ...
 * @param {import('./types.js?v=20260418-sB').MostElement[]} elements
 * @returns {number}
 */
 ...
 * @param {import('./types.js?v=20260418-sB').MostElement} element
 ...
 * @param {import('./types.js?v=20260418-sB').AnalysisLine[]} lines
 * @param {number} operatingDays — annual operating days
 * @returns {import('./types.js?v=20260418-sB').AnalysisSummary}
 */
 ...
 * @param {import('./types.js?v=20260418-sB').WorkflowStep[]} steps — with computed adjusted_uph
 * @returns {import('./types.js?v=20260418-sB').WorkflowResult}
 */
 ...
 * @param {import('./types.js?v=20260418-sB').WorkflowStep[]} steps
 ...
 * @returns {import('./types.js?v=20260418-sB').MostToCmPayload['laborLines']}
 */
