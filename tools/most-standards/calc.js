 ...
 * @param {import('./types.js?v=20260417-mG').AllowanceProfile | { personal_pct?: number, fatigue_pct?: number, delay_pct?: number }} profile
 ...
 * @param {import('./types.js?v=20260417-mG').MostElement[]} elements
 * @returns {number}
 */
 ...
 * @param {import('./types.js?v=20260417-mG').MostElement} element
 ...
 * @param {import('./types.js?v=20260417-mG').AnalysisLine[]} lines
 * @param {number} operatingDays — annual operating days
 * @returns {import('./types.js?v=20260417-mG').AnalysisSummary}
 */
 ...
 * @param {import('./types.js?v=20260417-mG').WorkflowStep[]} steps — with computed adjusted_uph
 * @returns {import('./types.js?v=20260417-mG').WorkflowResult}
 */
 ...
 * @param {import('./types.js?v=20260417-mG').WorkflowStep[]} steps
 ...
 * @returns {import('./types.js?v=20260417-mG').MostToCmPayload['laborLines']}
 */
