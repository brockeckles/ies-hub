 ...
 * @param {import('./types.js?v=20260418-sC').AllowanceProfile | { personal_pct?: number, fatigue_pct?: number, delay_pct?: number }} profile
 ...
 * @param {import('./types.js?v=20260418-sC').MostElement[]} elements
 * @returns {number}
 */
 ...
 * @param {import('./types.js?v=20260418-sC').MostElement} element
 ...
 * @param {import('./types.js?v=20260418-sC').AnalysisLine[]} lines
 * @param {number} operatingDays — annual operating days
 * @returns {import('./types.js?v=20260418-sC').AnalysisSummary}
 */
 ...
 * @param {import('./types.js?v=20260418-sC').WorkflowStep[]} steps — with computed adjusted_uph
 * @returns {import('./types.js?v=20260418-sC').WorkflowResult}
 */
 ...
 * @param {import('./types.js?v=20260418-sC').WorkflowStep[]} steps
 ...
 * @returns {import('./types.js?v=20260418-sC').MostToCmPayload['laborLines']}
 */
