 ...
 * @returns {Promise<import('./types.js?v=20260418-sC').MostTemplate[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260418-sC').MostTemplate|null>}
 */
 ...
 * @param {Partial<import('./types.js?v=20260418-sC').MostTemplate>} data
 * @returns {Promise<import('./types.js?v=20260418-sC').MostTemplate>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260418-sC').MostElement[]>}
 */
 ...
 * @param {Partial<import('./types.js?v=20260418-sC').MostElement>} data
 * @returns {Promise<import('./types.js?v=20260418-sC').MostElement>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260418-sC').AllowanceProfile[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260418-sC').LaborAnalysis[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260418-sC').LaborAnalysis|null>}
 */
 ...
 * @param {import('./types.js?v=20260418-sC').LaborAnalysis} analysis
 * @returns {Promise<import('./types.js?v=20260418-sC').LaborAnalysis>}
 */
 ...
 * @returns {Promise<{ templates: import('./types.js?v=20260418-sC').MostTemplate[], allowanceProfiles: import('./types.js?v=20260418-sC').AllowanceProfile[] }>}
 */
