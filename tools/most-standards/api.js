 ...
 * @returns {Promise<import('./types.js?v=20260418-sA').MostTemplate[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260418-sA').MostTemplate|null>}
 */
 ...
 * @param {Partial<import('./types.js?v=20260418-sA').MostTemplate>} data
 * @returns {Promise<import('./types.js?v=20260418-sA').MostTemplate>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260418-sA').MostElement[]>}
 */
 ...
 * @param {Partial<import('./types.js?v=20260418-sA').MostElement>} data
 * @returns {Promise<import('./types.js?v=20260418-sA').MostElement>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260418-sA').AllowanceProfile[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260418-sA').LaborAnalysis[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260418-sA').LaborAnalysis|null>}
 */
 ...
 * @param {import('./types.js?v=20260418-sA').LaborAnalysis} analysis
 * @returns {Promise<import('./types.js?v=20260418-sA').LaborAnalysis>}
 */
 ...
 * @returns {Promise<{ templates: import('./types.js?v=20260418-sA').MostTemplate[], allowanceProfiles: import('./types.js?v=20260418-sA').AllowanceProfile[] }>}
 */
