 ...
 * @returns {Promise<import('./types.js').MostTemplate[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js').MostTemplate|null>}
 */
 ...
 * @param {Partial<import('./types.js').MostTemplate>} data
 * @returns {Promise<import('./types.js').MostTemplate>}
 */
 ...
 * @returns {Promise<import('./types.js').MostElement[]>}
 */
 ...
 * @param {Partial<import('./types.js').MostElement>} data
 * @returns {Promise<import('./types.js').MostElement>}
 */
 ...
 * @returns {Promise<import('./types.js').AllowanceProfile[]>}
 */
 ...
 * @returns {Promise<import('./types.js').LaborAnalysis[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js').LaborAnalysis|null>}
 */
 ...
 * @param {import('./types.js').LaborAnalysis} analysis
 * @returns {Promise<import('./types.js').LaborAnalysis>}
 */
 ...
 * @returns {Promise<{ templates: import('./types.js').MostTemplate[], allowanceProfiles: import('./types.js').AllowanceProfile[] }>}
 */
