 ...
 * @returns {Promise<import('./types.js?v=20260418-sF').MostTemplate[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260418-sF').MostTemplate|null>}
 */
 ...
 * @param {Partial<import('./types.js?v=20260418-sF').MostTemplate>} data
 * @returns {Promise<import('./types.js?v=20260418-sF').MostTemplate>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260418-sF').MostElement[]>}
 */
 ...
 * @param {Partial<import('./types.js?v=20260418-sF').MostElement>} data
 * @returns {Promise<import('./types.js?v=20260418-sF').MostElement>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260418-sF').AllowanceProfile[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260418-sF').LaborAnalysis[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260418-sF').LaborAnalysis|null>}
 */
 ...
 * @param {import('./types.js?v=20260418-sF').LaborAnalysis} analysis
 * @returns {Promise<import('./types.js?v=20260418-sF').LaborAnalysis>}
 */
 ...
 * @returns {Promise<{ templates: import('./types.js?v=20260418-sF').MostTemplate[], allowanceProfiles: import('./types.js?v=20260418-sF').AllowanceProfile[] }>}
 */
