 ...
 * @returns {Promise<import('./types.js?v=20260417-pc').FeedbackItem[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260417-pc').FeedbackItem|null>}
 */
...
/**
 * Submit new feedback.
 * @param {Omit<import('./types.js?v=20260417-pc').FeedbackItem, 'id' | 'upvotes' | 'upvotedBy' | 'comments'>} item
 * @returns {Promise<import('./types.js?v=20260417-pc').FeedbackItem>}
 */
 ...
 * @returns {Promise<{ items: import('./types.js?v=20260417-pc').FeedbackItem[] }>}
 */
