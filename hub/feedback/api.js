 ...
 * @returns {Promise<import('./types.js?v=20260417-p9').FeedbackItem[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260417-p9').FeedbackItem|null>}
 */
...
/**
 * Submit new feedback.
 * @param {Omit<import('./types.js?v=20260417-p9').FeedbackItem, 'id' | 'upvotes' | 'upvotedBy' | 'comments'>} item
 * @returns {Promise<import('./types.js?v=20260417-p9').FeedbackItem>}
 */
 ...
 * @returns {Promise<{ items: import('./types.js?v=20260417-p9').FeedbackItem[] }>}
 */
