 ...
 * @returns {Promise<import('./types.js').FeedbackItem[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js').FeedbackItem|null>}
 */
...
/**
 * Submit new feedback.
 * @param {Omit<import('./types.js').FeedbackItem, 'id' | 'upvotes' | 'upvotedBy' | 'comments'>} item
 * @returns {Promise<import('./types.js').FeedbackItem>}
 */
 ...
 * @returns {Promise<{ items: import('./types.js').FeedbackItem[] }>}
 */
