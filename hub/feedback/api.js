 ...
 * @returns {Promise<import('./types.js?v=20260417-m2').FeedbackItem[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260417-m2').FeedbackItem|null>}
 */
...
/**
 * Submit new feedback.
 * @param {Omit<import('./types.js?v=20260417-m2').FeedbackItem, 'id' | 'upvotes' | 'upvotedBy' | 'comments'>} item
 * @returns {Promise<import('./types.js?v=20260417-m2').FeedbackItem>}
 */
 ...
 * @returns {Promise<{ items: import('./types.js?v=20260417-m2').FeedbackItem[] }>}
 */
