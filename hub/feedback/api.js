 ...
 * @returns {Promise<import('./types.js?v=20260418-s1').FeedbackItem[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260418-s1').FeedbackItem|null>}
 */
...
/**
 * Submit new feedback.
 * @param {Omit<import('./types.js?v=20260418-s1').FeedbackItem, 'id' | 'upvotes' | 'upvotedBy' | 'comments'>} item
 * @returns {Promise<import('./types.js?v=20260418-s1').FeedbackItem>}
 */
 ...
 * @returns {Promise<{ items: import('./types.js?v=20260418-s1').FeedbackItem[] }>}
 */
