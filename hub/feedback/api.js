 ...
 * @returns {Promise<import('./types.js?v=20260418-sC').FeedbackItem[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260418-sC').FeedbackItem|null>}
 */
...
/**
 * Submit new feedback.
 * @param {Omit<import('./types.js?v=20260418-sC').FeedbackItem, 'id' | 'upvotes' | 'upvotedBy' | 'comments'>} item
 * @returns {Promise<import('./types.js?v=20260418-sC').FeedbackItem>}
 */
 ...
 * @returns {Promise<{ items: import('./types.js?v=20260418-sC').FeedbackItem[] }>}
 */
