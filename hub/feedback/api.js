 ...
 * @returns {Promise<import('./types.js?v=20260417-m4').FeedbackItem[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260417-m4').FeedbackItem|null>}
 */
...
/**
 * Submit new feedback.
 * @param {Omit<import('./types.js?v=20260417-m4').FeedbackItem, 'id' | 'upvotes' | 'upvotedBy' | 'comments'>} item
 * @returns {Promise<import('./types.js?v=20260417-m4').FeedbackItem>}
 */
 ...
 * @returns {Promise<{ items: import('./types.js?v=20260417-m4').FeedbackItem[] }>}
 */
