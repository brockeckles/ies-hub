 ...
 * @param {import('./types.js?v=20260417-m4').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260417-m4').FeedbackStats}
 */
 ...
 * @param {import('./types.js?v=20260417-m4').FeedbackItem[]} items
 * @param {string} type
 * @returns {import('./types.js?v=20260417-m4').FeedbackItem[]}
 */
 ...
 * @param {import('./types.js?v=20260417-m4').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260417-m4').FeedbackTrend[]}
 */
...
/** @type {import('./types.js?v=20260417-m4').FeedbackItem[]} */
