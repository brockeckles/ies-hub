 ...
 * @param {import('./types.js?v=20260417-m2').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260417-m2').FeedbackStats}
 */
 ...
 * @param {import('./types.js?v=20260417-m2').FeedbackItem[]} items
 * @param {string} type
 * @returns {import('./types.js?v=20260417-m2').FeedbackItem[]}
 */
 ...
 * @param {import('./types.js?v=20260417-m2').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260417-m2').FeedbackTrend[]}
 */
...
/** @type {import('./types.js?v=20260417-m2').FeedbackItem[]} */
