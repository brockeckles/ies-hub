 ...
 * @param {import('./types.js?v=20260417-m6').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260417-m6').FeedbackStats}
 */
 ...
 * @param {import('./types.js?v=20260417-m6').FeedbackItem[]} items
 * @param {string} type
 * @returns {import('./types.js?v=20260417-m6').FeedbackItem[]}
 */
 ...
 * @param {import('./types.js?v=20260417-m6').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260417-m6').FeedbackTrend[]}
 */
...
/** @type {import('./types.js?v=20260417-m6').FeedbackItem[]} */
