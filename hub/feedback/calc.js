 ...
 * @param {import('./types.js?v=20260418-s8').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260418-s8').FeedbackStats}
 */
 ...
 * @param {import('./types.js?v=20260418-s8').FeedbackItem[]} items
 * @param {string} type
 * @returns {import('./types.js?v=20260418-s8').FeedbackItem[]}
 */
 ...
 * @param {import('./types.js?v=20260418-s8').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260418-s8').FeedbackTrend[]}
 */
...
/** @type {import('./types.js?v=20260418-s8').FeedbackItem[]} */
