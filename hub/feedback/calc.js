 ...
 * @param {import('./types.js?v=20260418-s4').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260418-s4').FeedbackStats}
 */
 ...
 * @param {import('./types.js?v=20260418-s4').FeedbackItem[]} items
 * @param {string} type
 * @returns {import('./types.js?v=20260418-s4').FeedbackItem[]}
 */
 ...
 * @param {import('./types.js?v=20260418-s4').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260418-s4').FeedbackTrend[]}
 */
...
/** @type {import('./types.js?v=20260418-s4').FeedbackItem[]} */
