 ...
 * @param {import('./types.js?v=20260417-m5').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260417-m5').FeedbackStats}
 */
 ...
 * @param {import('./types.js?v=20260417-m5').FeedbackItem[]} items
 * @param {string} type
 * @returns {import('./types.js?v=20260417-m5').FeedbackItem[]}
 */
 ...
 * @param {import('./types.js?v=20260417-m5').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260417-m5').FeedbackTrend[]}
 */
...
/** @type {import('./types.js?v=20260417-m5').FeedbackItem[]} */
