 ...
 * @param {import('./types.js?v=20260417-p3').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260417-p3').FeedbackStats}
 */
 ...
 * @param {import('./types.js?v=20260417-p3').FeedbackItem[]} items
 * @param {string} type
 * @returns {import('./types.js?v=20260417-p3').FeedbackItem[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p3').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260417-p3').FeedbackTrend[]}
 */
...
/** @type {import('./types.js?v=20260417-p3').FeedbackItem[]} */
