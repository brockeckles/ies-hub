 ...
 * @param {import('./types.js?v=20260418-s1').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260418-s1').FeedbackStats}
 */
 ...
 * @param {import('./types.js?v=20260418-s1').FeedbackItem[]} items
 * @param {string} type
 * @returns {import('./types.js?v=20260418-s1').FeedbackItem[]}
 */
 ...
 * @param {import('./types.js?v=20260418-s1').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260418-s1').FeedbackTrend[]}
 */
...
/** @type {import('./types.js?v=20260418-s1').FeedbackItem[]} */
