 ...
 * @param {import('./types.js?v=20260418-s7').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260418-s7').FeedbackStats}
 */
 ...
 * @param {import('./types.js?v=20260418-s7').FeedbackItem[]} items
 * @param {string} type
 * @returns {import('./types.js?v=20260418-s7').FeedbackItem[]}
 */
 ...
 * @param {import('./types.js?v=20260418-s7').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260418-s7').FeedbackTrend[]}
 */
...
/** @type {import('./types.js?v=20260418-s7').FeedbackItem[]} */
