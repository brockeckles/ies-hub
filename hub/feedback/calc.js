 ...
 * @param {import('./types.js?v=20260417-m9').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260417-m9').FeedbackStats}
 */
 ...
 * @param {import('./types.js?v=20260417-m9').FeedbackItem[]} items
 * @param {string} type
 * @returns {import('./types.js?v=20260417-m9').FeedbackItem[]}
 */
 ...
 * @param {import('./types.js?v=20260417-m9').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260417-m9').FeedbackTrend[]}
 */
...
/** @type {import('./types.js?v=20260417-m9').FeedbackItem[]} */
