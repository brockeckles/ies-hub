 ...
 * @param {import('./types.js?v=20260417-m7').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260417-m7').FeedbackStats}
 */
 ...
 * @param {import('./types.js?v=20260417-m7').FeedbackItem[]} items
 * @param {string} type
 * @returns {import('./types.js?v=20260417-m7').FeedbackItem[]}
 */
 ...
 * @param {import('./types.js?v=20260417-m7').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260417-m7').FeedbackTrend[]}
 */
...
/** @type {import('./types.js?v=20260417-m7').FeedbackItem[]} */
