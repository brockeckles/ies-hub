 ...
 * @param {import('./types.js?v=20260418-s5').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260418-s5').FeedbackStats}
 */
 ...
 * @param {import('./types.js?v=20260418-s5').FeedbackItem[]} items
 * @param {string} type
 * @returns {import('./types.js?v=20260418-s5').FeedbackItem[]}
 */
 ...
 * @param {import('./types.js?v=20260418-s5').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260418-s5').FeedbackTrend[]}
 */
...
/** @type {import('./types.js?v=20260418-s5').FeedbackItem[]} */
