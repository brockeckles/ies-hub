 ...
 * @param {import('./types.js?v=20260417-p7').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260417-p7').FeedbackStats}
 */
 ...
 * @param {import('./types.js?v=20260417-p7').FeedbackItem[]} items
 * @param {string} type
 * @returns {import('./types.js?v=20260417-p7').FeedbackItem[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p7').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260417-p7').FeedbackTrend[]}
 */
...
/** @type {import('./types.js?v=20260417-p7').FeedbackItem[]} */
