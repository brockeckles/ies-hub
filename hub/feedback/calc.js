 ...
 * @param {import('./types.js?v=20260417-p4').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260417-p4').FeedbackStats}
 */
 ...
 * @param {import('./types.js?v=20260417-p4').FeedbackItem[]} items
 * @param {string} type
 * @returns {import('./types.js?v=20260417-p4').FeedbackItem[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p4').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260417-p4').FeedbackTrend[]}
 */
...
/** @type {import('./types.js?v=20260417-p4').FeedbackItem[]} */
