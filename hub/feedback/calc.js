 ...
 * @param {import('./types.js?v=20260417-p8').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260417-p8').FeedbackStats}
 */
 ...
 * @param {import('./types.js?v=20260417-p8').FeedbackItem[]} items
 * @param {string} type
 * @returns {import('./types.js?v=20260417-p8').FeedbackItem[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p8').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260417-p8').FeedbackTrend[]}
 */
...
/** @type {import('./types.js?v=20260417-p8').FeedbackItem[]} */
