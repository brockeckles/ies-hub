 ...
 * @param {import('./types.js?v=20260418-s6').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260418-s6').FeedbackStats}
 */
 ...
 * @param {import('./types.js?v=20260418-s6').FeedbackItem[]} items
 * @param {string} type
 * @returns {import('./types.js?v=20260418-s6').FeedbackItem[]}
 */
 ...
 * @param {import('./types.js?v=20260418-s6').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260418-s6').FeedbackTrend[]}
 */
...
/** @type {import('./types.js?v=20260418-s6').FeedbackItem[]} */
