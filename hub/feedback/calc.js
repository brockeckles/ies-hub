 ...
 * @param {import('./types.js?v=20260418-s3').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260418-s3').FeedbackStats}
 */
 ...
 * @param {import('./types.js?v=20260418-s3').FeedbackItem[]} items
 * @param {string} type
 * @returns {import('./types.js?v=20260418-s3').FeedbackItem[]}
 */
 ...
 * @param {import('./types.js?v=20260418-s3').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260418-s3').FeedbackTrend[]}
 */
...
/** @type {import('./types.js?v=20260418-s3').FeedbackItem[]} */
