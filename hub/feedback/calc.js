 ...
 * @param {import('./types.js?v=20260418-s2').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260418-s2').FeedbackStats}
 */
 ...
 * @param {import('./types.js?v=20260418-s2').FeedbackItem[]} items
 * @param {string} type
 * @returns {import('./types.js?v=20260418-s2').FeedbackItem[]}
 */
 ...
 * @param {import('./types.js?v=20260418-s2').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260418-s2').FeedbackTrend[]}
 */
...
/** @type {import('./types.js?v=20260418-s2').FeedbackItem[]} */
