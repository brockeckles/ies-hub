 ...
 * @param {import('./types.js?v=20260417-p9').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260417-p9').FeedbackStats}
 */
 ...
 * @param {import('./types.js?v=20260417-p9').FeedbackItem[]} items
 * @param {string} type
 * @returns {import('./types.js?v=20260417-p9').FeedbackItem[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p9').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260417-p9').FeedbackTrend[]}
 */
...
/** @type {import('./types.js?v=20260417-p9').FeedbackItem[]} */
