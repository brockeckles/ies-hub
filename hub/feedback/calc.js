 ...
 * @param {import('./types.js?v=20260418-s9').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260418-s9').FeedbackStats}
 */
 ...
 * @param {import('./types.js?v=20260418-s9').FeedbackItem[]} items
 * @param {string} type
 * @returns {import('./types.js?v=20260418-s9').FeedbackItem[]}
 */
 ...
 * @param {import('./types.js?v=20260418-s9').FeedbackItem[]} items
 * @returns {import('./types.js?v=20260418-s9').FeedbackTrend[]}
 */
...
/** @type {import('./types.js?v=20260418-s9').FeedbackItem[]} */
