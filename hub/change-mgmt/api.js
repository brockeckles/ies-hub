 ...
 * @returns {Promise<import('./types.js?v=20260417-m7').ChangeInitiative[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260417-m7').ChangeInitiative|null>}
 */
 ...
 * @returns {Promise<{ initiatives: import('./types.js?v=20260417-m7').ChangeInitiative[] }>}
 */
