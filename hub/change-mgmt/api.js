 ...
 * @returns {Promise<import('./types.js').ChangeInitiative[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js').ChangeInitiative|null>}
 */
 ...
 * @returns {Promise<{ initiatives: import('./types.js').ChangeInitiative[] }>}
 */
