 ...
 * @returns {Promise<import('./types.js?v=20260417-m8').ChangeInitiative[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260417-m8').ChangeInitiative|null>}
 */
 ...
 * @returns {Promise<{ initiatives: import('./types.js?v=20260417-m8').ChangeInitiative[] }>}
 */
