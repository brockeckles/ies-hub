 ...
 * @returns {Promise<import('./types.js?v=20260417-p9').ChangeInitiative[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260417-p9').ChangeInitiative|null>}
 */
 ...
 * @returns {Promise<{ initiatives: import('./types.js?v=20260417-p9').ChangeInitiative[] }>}
 */
