 ...
 * @param {import('./types.js?v=20260417-p8').ChangeInitiative[]} initiatives
 * @returns {import('./types.js?v=20260417-p8').InitiativeStats}
 */
 ...
 * @param {import('./types.js?v=20260417-p8').ChangeInitiative} initiative
 * @returns {import('./types.js?v=20260417-p8').ReadinessScore}
 */
 ...
 * @param {import('./types.js?v=20260417-p8').Milestone[]} milestones
 ...
 * @param {import('./types.js?v=20260417-p8').Stakeholder[]} stakeholders
 * @returns {number} 0-100
 */
 ...
 * @param {import('./types.js?v=20260417-p8').Communication[]} communications
 * @returns {number} 0-100
 */
 ...
 * @param {import('./types.js?v=20260417-p8').Stakeholder[]} stakeholders
 * @returns {Record<string, import('./types.js?v=20260417-p8').Stakeholder[]>}
 */
 ...
 * @param {import('./types.js?v=20260417-p8').Stakeholder[]} stakeholders
 * @returns {import('./types.js?v=20260417-p8').Stakeholder[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p8').ChangeInitiative[]} initiatives
 * @returns {import('./types.js?v=20260417-p8').TimelineEvent[]}
 */
export function buildTimeline(initiatives) {
  /** @type {import('./types.js?v=20260417-p8').TimelineEvent[]} */
  const events = [];
 ...
 * @param {import('./types.js?v=20260417-p8').TimelineEvent[]} events
 ...
 * @param {import('./types.js?v=20260417-p8').ChangeInitiative[]} initiatives
 * @param {string} status
 * @returns {import('./types.js?v=20260417-p8').ChangeInitiative[]}
 */
 ...
 * @returns {import('./types.js?v=20260417-p8').Milestone[]}
 */
...
/** @type {import('./types.js?v=20260417-p8').ChangeInitiative[]} */
