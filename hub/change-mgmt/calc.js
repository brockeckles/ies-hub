 ...
 * @param {import('./types.js').ChangeInitiative[]} initiatives
 * @returns {import('./types.js').InitiativeStats}
 */
 ...
 * @param {import('./types.js').ChangeInitiative} initiative
 * @returns {import('./types.js').ReadinessScore}
 */
 ...
 * @param {import('./types.js').Stakeholder[]} stakeholders
 * @returns {number} 0-100
 */
 ...
 * @param {import('./types.js').Communication[]} communications
 * @returns {number} 0-100
 */
 ...
 * @param {import('./types.js').Stakeholder[]} stakeholders
 * @returns {Record<string, import('./types.js').Stakeholder[]>}
 */
 ...
 * @param {import('./types.js').Stakeholder[]} stakeholders
 * @returns {import('./types.js').Stakeholder[]}
 */
 ...
 * @param {import('./types.js').ChangeInitiative[]} initiatives
 * @returns {import('./types.js').TimelineEvent[]}
 */
export function buildTimeline(initiatives) {
  /** @type {import('./types.js').TimelineEvent[]} */
  const events = [];
 ...
 * @param {import('./types.js').TimelineEvent[]} events
 ...
 * @param {import('./types.js').ChangeInitiative[]} initiatives
 * @param {string} status
 * @returns {import('./types.js').ChangeInitiative[]}
 */
 ...
 * @returns {import('./types.js').Milestone[]}
 */
...
/** @type {import('./types.js').ChangeInitiative[]} */
