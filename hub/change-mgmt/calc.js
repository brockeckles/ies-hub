 ...
 * @param {import('./types.js?v=20260417-m2').ChangeInitiative[]} initiatives
 * @returns {import('./types.js?v=20260417-m2').InitiativeStats}
 */
 ...
 * @param {import('./types.js?v=20260417-m2').ChangeInitiative} initiative
 * @returns {import('./types.js?v=20260417-m2').ReadinessScore}
 */
 ...
 * @param {import('./types.js?v=20260417-m2').Milestone[]} milestones
 ...
 * @param {import('./types.js?v=20260417-m2').Stakeholder[]} stakeholders
 * @returns {number} 0-100
 */
 ...
 * @param {import('./types.js?v=20260417-m2').Communication[]} communications
 * @returns {number} 0-100
 */
 ...
 * @param {import('./types.js?v=20260417-m2').Stakeholder[]} stakeholders
 * @returns {Record<string, import('./types.js?v=20260417-m2').Stakeholder[]>}
 */
 ...
 * @param {import('./types.js?v=20260417-m2').Stakeholder[]} stakeholders
 * @returns {import('./types.js?v=20260417-m2').Stakeholder[]}
 */
 ...
 * @param {import('./types.js?v=20260417-m2').ChangeInitiative[]} initiatives
 * @returns {import('./types.js?v=20260417-m2').TimelineEvent[]}
 */
export function buildTimeline(initiatives) {
  /** @type {import('./types.js?v=20260417-m2').TimelineEvent[]} */
  const events = [];
 ...
 * @param {import('./types.js?v=20260417-m2').TimelineEvent[]} events
 ...
 * @param {import('./types.js?v=20260417-m2').ChangeInitiative[]} initiatives
 * @param {string} status
 * @returns {import('./types.js?v=20260417-m2').ChangeInitiative[]}
 */
 ...
 * @returns {import('./types.js?v=20260417-m2').Milestone[]}
 */
...
/** @type {import('./types.js?v=20260417-m2').ChangeInitiative[]} */
