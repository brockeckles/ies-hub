 ...
 * @param {import('./types.js?v=20260417-p3').ChangeInitiative[]} initiatives
 * @returns {import('./types.js?v=20260417-p3').InitiativeStats}
 */
 ...
 * @param {import('./types.js?v=20260417-p3').ChangeInitiative} initiative
 * @returns {import('./types.js?v=20260417-p3').ReadinessScore}
 */
 ...
 * @param {import('./types.js?v=20260417-p3').Milestone[]} milestones
 ...
 * @param {import('./types.js?v=20260417-p3').Stakeholder[]} stakeholders
 * @returns {number} 0-100
 */
 ...
 * @param {import('./types.js?v=20260417-p3').Communication[]} communications
 * @returns {number} 0-100
 */
 ...
 * @param {import('./types.js?v=20260417-p3').Stakeholder[]} stakeholders
 * @returns {Record<string, import('./types.js?v=20260417-p3').Stakeholder[]>}
 */
 ...
 * @param {import('./types.js?v=20260417-p3').Stakeholder[]} stakeholders
 * @returns {import('./types.js?v=20260417-p3').Stakeholder[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p3').ChangeInitiative[]} initiatives
 * @returns {import('./types.js?v=20260417-p3').TimelineEvent[]}
 */
export function buildTimeline(initiatives) {
  /** @type {import('./types.js?v=20260417-p3').TimelineEvent[]} */
  const events = [];
 ...
 * @param {import('./types.js?v=20260417-p3').TimelineEvent[]} events
 ...
 * @param {import('./types.js?v=20260417-p3').ChangeInitiative[]} initiatives
 * @param {string} status
 * @returns {import('./types.js?v=20260417-p3').ChangeInitiative[]}
 */
 ...
 * @returns {import('./types.js?v=20260417-p3').Milestone[]}
 */
...
/** @type {import('./types.js?v=20260417-p3').ChangeInitiative[]} */
