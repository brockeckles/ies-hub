 ...
 * @param {import('./types.js?v=20260417-p1').ChangeInitiative[]} initiatives
 * @returns {import('./types.js?v=20260417-p1').InitiativeStats}
 */
 ...
 * @param {import('./types.js?v=20260417-p1').ChangeInitiative} initiative
 * @returns {import('./types.js?v=20260417-p1').ReadinessScore}
 */
 ...
 * @param {import('./types.js?v=20260417-p1').Milestone[]} milestones
 ...
 * @param {import('./types.js?v=20260417-p1').Stakeholder[]} stakeholders
 * @returns {number} 0-100
 */
 ...
 * @param {import('./types.js?v=20260417-p1').Communication[]} communications
 * @returns {number} 0-100
 */
 ...
 * @param {import('./types.js?v=20260417-p1').Stakeholder[]} stakeholders
 * @returns {Record<string, import('./types.js?v=20260417-p1').Stakeholder[]>}
 */
 ...
 * @param {import('./types.js?v=20260417-p1').Stakeholder[]} stakeholders
 * @returns {import('./types.js?v=20260417-p1').Stakeholder[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p1').ChangeInitiative[]} initiatives
 * @returns {import('./types.js?v=20260417-p1').TimelineEvent[]}
 */
export function buildTimeline(initiatives) {
  /** @type {import('./types.js?v=20260417-p1').TimelineEvent[]} */
  const events = [];
 ...
 * @param {import('./types.js?v=20260417-p1').TimelineEvent[]} events
 ...
 * @param {import('./types.js?v=20260417-p1').ChangeInitiative[]} initiatives
 * @param {string} status
 * @returns {import('./types.js?v=20260417-p1').ChangeInitiative[]}
 */
 ...
 * @returns {import('./types.js?v=20260417-p1').Milestone[]}
 */
...
/** @type {import('./types.js?v=20260417-p1').ChangeInitiative[]} */
