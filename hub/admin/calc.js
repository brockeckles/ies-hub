...
/** @type {import('./types.js?v=20260417-mE').MasterTableConfig[]} */
...
/** @type {import('./types.js?v=20260417-mE').UserAccount[]} */
...
/** @type {import('./types.js?v=20260417-mE').EscalationRule[]} */
...
/** @type {import('./types.js?v=20260417-mE').AuditLogEntry[]} */
 ...
 * @param {import('./types.js?v=20260417-mE').UserAccount[]} users
 * @param {import('./types.js?v=20260417-mE').MasterTableConfig[]} tables
 * @param {import('./types.js?v=20260417-mE').EscalationRule[]} escalations
 * @param {import('./types.js?v=20260417-mE').AuditLogEntry[]} auditLog
 * @param {string} [referenceDate] — ISO date for 7-day window
 * @returns {import('./types.js?v=20260417-mE').AdminStats}
 */
 ...
 * @param {import('./types.js?v=20260417-mE').ColumnDef[]} columns
 ...
 * @param {number} value
 * @param {import('./types.js?v=20260417-mE').EscalationRule[]} rules
 * @returns {import('./types.js?v=20260417-mE').EscalationRule[]} — triggered rules
 */
 ...
 * @param {import('./types.js?v=20260417-mE').EscalationRule[]} rules
 * @returns {Array<{ rule: import('./types.js?v=20260417-mE').EscalationRule, metricValue: number }>}
 */
 ...
 * @returns {import('./types.js?v=20260417-mE').UserAccount[]}
 */
 ...
 * @param {import('./types.js?v=20260417-mE').AuditLogEntry[]} log
 * @param {{ action?: string, tableName?: string, userId?: string }} filters
 * @returns {import('./types.js?v=20260417-mE').AuditLogEntry[]}
 */
