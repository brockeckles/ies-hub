...
/** @type {import('./types.js?v=20260418-sE').MasterTableConfig[]} */
export const MASTER_TABLES = [
  ...
  // ---- Go-to-market reference tables (restored 2026-04-18 per gap punchlist) ----
  {
    ...
    columns: [
      ...
      { key: 'tier', label: 'Priority', type: 'select', editable: true, options: ['A','B','C'] },
  ...
  },
  {
    ...
    columns: [
      ...
      { key: 'parent', label: 'Parent Co.', type: 'text', editable: true },
      { key: 'region', label: 'Region', type: 'text', editable: true },
  ...
  },
  {
    ...
    columns: [
      { key: 'code', label: 'Code', type: 'text', required: true, editable: true },
      { key: 'name', label: 'Vertical', type: 'text', required: true, editable: true },
      { key: 'sort_order', label: 'Sort Order', type: 'number', editable: true },
    ],
  },
];
...
/** @type {import('./types.js?v=20260418-sE').UserAccount[]} */
...
/** @type {import('./types.js?v=20260418-sE').EscalationRule[]} */
...
/** @type {import('./types.js?v=20260418-sE').AuditLogEntry[]} */
 ...
 * @param {import('./types.js?v=20260418-sE').UserAccount[]} users
 * @param {import('./types.js?v=20260418-sE').MasterTableConfig[]} tables
 * @param {import('./types.js?v=20260418-sE').EscalationRule[]} escalations
 * @param {import('./types.js?v=20260418-sE').AuditLogEntry[]} auditLog
 * @param {string} [referenceDate] — ISO date for 7-day window
 * @returns {import('./types.js?v=20260418-sE').AdminStats}
 */
 ...
 * @param {import('./types.js?v=20260418-sE').ColumnDef[]} columns
 ...
 * @param {number} value
 * @param {import('./types.js?v=20260418-sE').EscalationRule[]} rules
 * @returns {import('./types.js?v=20260418-sE').EscalationRule[]} — triggered rules
 */
 ...
 * @param {import('./types.js?v=20260418-sE').EscalationRule[]} rules
 * @returns {Array<{ rule: import('./types.js?v=20260418-sE').EscalationRule, metricValue: number }>}
 */
 ...
 * @returns {import('./types.js?v=20260418-sE').UserAccount[]}
 */
 ...
 * @param {import('./types.js?v=20260418-sE').AuditLogEntry[]} log
 * @param {{ action?: string, tableName?: string, userId?: string }} filters
 * @returns {import('./types.js?v=20260418-sE').AuditLogEntry[]}
 */
