...
/** @type {import('./types.js?v=20260418-sF').MasterTableConfig[]} */
...
/** @type {import('./types.js?v=20260418-sF').UserAccount[]} */
...
/** @type {import('./types.js?v=20260418-sF').EscalationRule[]} */
...
/** @type {import('./types.js?v=20260418-sF').AuditLogEntry[]} */
 ...
 * @param {import('./types.js?v=20260418-sF').UserAccount[]} users
 * @param {import('./types.js?v=20260418-sF').MasterTableConfig[]} tables
 * @param {import('./types.js?v=20260418-sF').EscalationRule[]} escalations
 * @param {import('./types.js?v=20260418-sF').AuditLogEntry[]} auditLog
 * @param {string} [referenceDate] — ISO date for 7-day window
 * @returns {import('./types.js?v=20260418-sF').AdminStats}
 */
 ...
 * @param {import('./types.js?v=20260418-sF').ColumnDef[]} columns
 ...
 * @param {number} value
 * @param {import('./types.js?v=20260418-sF').EscalationRule[]} rules
 * @returns {import('./types.js?v=20260418-sF').EscalationRule[]} — triggered rules
 */
 ...
 * @param {import('./types.js?v=20260418-sF').EscalationRule[]} rules
 * @returns {Array<{ rule: import('./types.js?v=20260418-sF').EscalationRule, metricValue: number }>}
 */
 ...
 * @returns {import('./types.js?v=20260418-sF').UserAccount[]}
 */
 ...
 * @param {import('./types.js?v=20260418-sF').AuditLogEntry[]} log
 * @param {{ action?: string, tableName?: string, userId?: string }} filters
 * @returns {import('./types.js?v=20260418-sF').AuditLogEntry[]}
 */
