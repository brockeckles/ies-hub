...
/** @type {import('./types.js?v=20260418-sH').MasterTableConfig[]} */
...
/** @type {import('./types.js?v=20260418-sH').UserAccount[]} */
...
/** @type {import('./types.js?v=20260418-sH').EscalationRule[]} */
...
/** @type {import('./types.js?v=20260418-sH').AuditLogEntry[]} */
 ...
 * @param {import('./types.js?v=20260418-sH').UserAccount[]} users
 * @param {import('./types.js?v=20260418-sH').MasterTableConfig[]} tables
 * @param {import('./types.js?v=20260418-sH').EscalationRule[]} escalations
 * @param {import('./types.js?v=20260418-sH').AuditLogEntry[]} auditLog
 * @param {string} [referenceDate] — ISO date for 7-day window
 * @returns {import('./types.js?v=20260418-sH').AdminStats}
 */
 ...
 * @param {import('./types.js?v=20260418-sH').ColumnDef[]} columns
 ...
 * @param {number} value
 * @param {import('./types.js?v=20260418-sH').EscalationRule[]} rules
 * @returns {import('./types.js?v=20260418-sH').EscalationRule[]} — triggered rules
 */
 ...
 * @param {import('./types.js?v=20260418-sH').EscalationRule[]} rules
 * @returns {Array<{ rule: import('./types.js?v=20260418-sH').EscalationRule, metricValue: number }>}
 */
 ...
 * @returns {import('./types.js?v=20260418-sH').UserAccount[]}
 */
 ...
 * @param {import('./types.js?v=20260418-sH').AuditLogEntry[]} log
 * @param {{ action?: string, tableName?: string, userId?: string }} filters
 * @returns {import('./types.js?v=20260418-sH').AuditLogEntry[]}
 */
