...
/** @type {import('./types.js?v=20260417-mI').MasterTableConfig[]} */
...
/** @type {import('./types.js?v=20260417-mI').UserAccount[]} */
...
/** @type {import('./types.js?v=20260417-mI').EscalationRule[]} */
...
/** @type {import('./types.js?v=20260417-mI').AuditLogEntry[]} */
 ...
 * @param {import('./types.js?v=20260417-mI').UserAccount[]} users
 * @param {import('./types.js?v=20260417-mI').MasterTableConfig[]} tables
 * @param {import('./types.js?v=20260417-mI').EscalationRule[]} escalations
 * @param {import('./types.js?v=20260417-mI').AuditLogEntry[]} auditLog
 * @param {string} [referenceDate] — ISO date for 7-day window
 * @returns {import('./types.js?v=20260417-mI').AdminStats}
 */
 ...
 * @param {import('./types.js?v=20260417-mI').ColumnDef[]} columns
 ...
 * @param {number} value
 * @param {import('./types.js?v=20260417-mI').EscalationRule[]} rules
 * @returns {import('./types.js?v=20260417-mI').EscalationRule[]} — triggered rules
 */
 ...
 * @param {import('./types.js?v=20260417-mI').EscalationRule[]} rules
 * @returns {Array<{ rule: import('./types.js?v=20260417-mI').EscalationRule, metricValue: number }>}
 */
 ...
 * @returns {import('./types.js?v=20260417-mI').UserAccount[]}
 */
 ...
 * @param {import('./types.js?v=20260417-mI').AuditLogEntry[]} log
 * @param {{ action?: string, tableName?: string, userId?: string }} filters
 * @returns {import('./types.js?v=20260417-mI').AuditLogEntry[]}
 */
