...
/** @type {import('./types.js?v=20260417-s2').MasterTableConfig[]} */
...
/** @type {import('./types.js?v=20260417-s2').UserAccount[]} */
...
/** @type {import('./types.js?v=20260417-s2').EscalationRule[]} */
...
/** @type {import('./types.js?v=20260417-s2').AuditLogEntry[]} */
 ...
 * @param {import('./types.js?v=20260417-s2').UserAccount[]} users
 * @param {import('./types.js?v=20260417-s2').MasterTableConfig[]} tables
 * @param {import('./types.js?v=20260417-s2').EscalationRule[]} escalations
 * @param {import('./types.js?v=20260417-s2').AuditLogEntry[]} auditLog
 * @param {string} [referenceDate] — ISO date for 7-day window
 * @returns {import('./types.js?v=20260417-s2').AdminStats}
 */
 ...
 * @param {import('./types.js?v=20260417-s2').ColumnDef[]} columns
 ...
 * @param {number} value
 * @param {import('./types.js?v=20260417-s2').EscalationRule[]} rules
 * @returns {import('./types.js?v=20260417-s2').EscalationRule[]} — triggered rules
 */
 ...
 * @param {import('./types.js?v=20260417-s2').EscalationRule[]} rules
 * @returns {Array<{ rule: import('./types.js?v=20260417-s2').EscalationRule, metricValue: number }>}
 */
 ...
 * @returns {import('./types.js?v=20260417-s2').UserAccount[]}
 */
 ...
 * @param {import('./types.js?v=20260417-s2').AuditLogEntry[]} log
 * @param {{ action?: string, tableName?: string, userId?: string }} filters
 * @returns {import('./types.js?v=20260417-s2').AuditLogEntry[]}
 */
