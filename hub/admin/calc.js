...
/** @type {import('./types.js?v=20260418-sB').MasterTableConfig[]} */
...
/** @type {import('./types.js?v=20260418-sB').UserAccount[]} */
...
/** @type {import('./types.js?v=20260418-sB').EscalationRule[]} */
...
/** @type {import('./types.js?v=20260418-sB').AuditLogEntry[]} */
 ...
 * @param {import('./types.js?v=20260418-sB').UserAccount[]} users
 * @param {import('./types.js?v=20260418-sB').MasterTableConfig[]} tables
 * @param {import('./types.js?v=20260418-sB').EscalationRule[]} escalations
 * @param {import('./types.js?v=20260418-sB').AuditLogEntry[]} auditLog
 * @param {string} [referenceDate] — ISO date for 7-day window
 * @returns {import('./types.js?v=20260418-sB').AdminStats}
 */
 ...
 * @param {import('./types.js?v=20260418-sB').ColumnDef[]} columns
 ...
 * @param {number} value
 * @param {import('./types.js?v=20260418-sB').EscalationRule[]} rules
 * @returns {import('./types.js?v=20260418-sB').EscalationRule[]} — triggered rules
 */
 ...
 * @param {import('./types.js?v=20260418-sB').EscalationRule[]} rules
 * @returns {Array<{ rule: import('./types.js?v=20260418-sB').EscalationRule, metricValue: number }>}
 */
 ...
 * @returns {import('./types.js?v=20260418-sB').UserAccount[]}
 */
 ...
 * @param {import('./types.js?v=20260418-sB').AuditLogEntry[]} log
 * @param {{ action?: string, tableName?: string, userId?: string }} filters
 * @returns {import('./types.js?v=20260418-sB').AuditLogEntry[]}
 */
