...
/** @type {import('./types.js?v=20260418-s4').MasterTableConfig[]} */
...
/** @type {import('./types.js?v=20260418-s4').UserAccount[]} */
...
/** @type {import('./types.js?v=20260418-s4').EscalationRule[]} */
...
/** @type {import('./types.js?v=20260418-s4').AuditLogEntry[]} */
 ...
 * @param {import('./types.js?v=20260418-s4').UserAccount[]} users
 * @param {import('./types.js?v=20260418-s4').MasterTableConfig[]} tables
 * @param {import('./types.js?v=20260418-s4').EscalationRule[]} escalations
 * @param {import('./types.js?v=20260418-s4').AuditLogEntry[]} auditLog
 * @param {string} [referenceDate] — ISO date for 7-day window
 * @returns {import('./types.js?v=20260418-s4').AdminStats}
 */
 ...
 * @param {import('./types.js?v=20260418-s4').ColumnDef[]} columns
 ...
 * @param {number} value
 * @param {import('./types.js?v=20260418-s4').EscalationRule[]} rules
 * @returns {import('./types.js?v=20260418-s4').EscalationRule[]} — triggered rules
 */
 ...
 * @param {import('./types.js?v=20260418-s4').EscalationRule[]} rules
 * @returns {Array<{ rule: import('./types.js?v=20260418-s4').EscalationRule, metricValue: number }>}
 */
 ...
 * @returns {import('./types.js?v=20260418-s4').UserAccount[]}
 */
 ...
 * @param {import('./types.js?v=20260418-s4').AuditLogEntry[]} log
 * @param {{ action?: string, tableName?: string, userId?: string }} filters
 * @returns {import('./types.js?v=20260418-s4').AuditLogEntry[]}
 */
