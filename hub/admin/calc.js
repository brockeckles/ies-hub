...
/** @type {import('./types.js?v=20260417-pb').MasterTableConfig[]} */
...
/** @type {import('./types.js?v=20260417-pb').UserAccount[]} */
...
/** @type {import('./types.js?v=20260417-pb').EscalationRule[]} */
...
/** @type {import('./types.js?v=20260417-pb').AuditLogEntry[]} */
 ...
 * @param {import('./types.js?v=20260417-pb').UserAccount[]} users
 * @param {import('./types.js?v=20260417-pb').MasterTableConfig[]} tables
 * @param {import('./types.js?v=20260417-pb').EscalationRule[]} escalations
 * @param {import('./types.js?v=20260417-pb').AuditLogEntry[]} auditLog
 * @param {string} [referenceDate] — ISO date for 7-day window
 * @returns {import('./types.js?v=20260417-pb').AdminStats}
 */
 ...
 * @param {import('./types.js?v=20260417-pb').ColumnDef[]} columns
 ...
 * @param {number} value
 * @param {import('./types.js?v=20260417-pb').EscalationRule[]} rules
 * @returns {import('./types.js?v=20260417-pb').EscalationRule[]} — triggered rules
 */
 ...
 * @param {import('./types.js?v=20260417-pb').EscalationRule[]} rules
 * @returns {Array<{ rule: import('./types.js?v=20260417-pb').EscalationRule, metricValue: number }>}
 */
 ...
 * @returns {import('./types.js?v=20260417-pb').UserAccount[]}
 */
 ...
 * @param {import('./types.js?v=20260417-pb').AuditLogEntry[]} log
 * @param {{ action?: string, tableName?: string, userId?: string }} filters
 * @returns {import('./types.js?v=20260417-pb').AuditLogEntry[]}
 */
