...
/** @type {import('./types.js?v=20260417-mD').MasterTableConfig[]} */
...
/** @type {import('./types.js?v=20260417-mD').UserAccount[]} */
...
/** @type {import('./types.js?v=20260417-mD').EscalationRule[]} */
...
/** @type {import('./types.js?v=20260417-mD').AuditLogEntry[]} */
 ...
 * @param {import('./types.js?v=20260417-mD').UserAccount[]} users
 * @param {import('./types.js?v=20260417-mD').MasterTableConfig[]} tables
 * @param {import('./types.js?v=20260417-mD').EscalationRule[]} escalations
 * @param {import('./types.js?v=20260417-mD').AuditLogEntry[]} auditLog
 * @param {string} [referenceDate] — ISO date for 7-day window
 * @returns {import('./types.js?v=20260417-mD').AdminStats}
 */
 ...
 * @param {import('./types.js?v=20260417-mD').ColumnDef[]} columns
 ...
 * @param {number} value
 * @param {import('./types.js?v=20260417-mD').EscalationRule[]} rules
 * @returns {import('./types.js?v=20260417-mD').EscalationRule[]} — triggered rules
 */
 ...
 * @param {import('./types.js?v=20260417-mD').EscalationRule[]} rules
 * @returns {Array<{ rule: import('./types.js?v=20260417-mD').EscalationRule, metricValue: number }>}
 */
 ...
 * @returns {import('./types.js?v=20260417-mD').UserAccount[]}
 */
 ...
 * @param {import('./types.js?v=20260417-mD').AuditLogEntry[]} log
 * @param {{ action?: string, tableName?: string, userId?: string }} filters
 * @returns {import('./types.js?v=20260417-mD').AuditLogEntry[]}
 */
