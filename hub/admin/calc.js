...
/** @type {import('./types.js?v=20260418-sI').MasterTableConfig[]} */
...
/** @type {import('./types.js?v=20260418-sI').UserAccount[]} */
...
/** @type {import('./types.js?v=20260418-sI').EscalationRule[]} */
...
/** @type {import('./types.js?v=20260418-sI').AuditLogEntry[]} */
 ...
 * @param {import('./types.js?v=20260418-sI').UserAccount[]} users
 * @param {import('./types.js?v=20260418-sI').MasterTableConfig[]} tables
 * @param {import('./types.js?v=20260418-sI').EscalationRule[]} escalations
 * @param {import('./types.js?v=20260418-sI').AuditLogEntry[]} auditLog
 * @param {string} [referenceDate] — ISO date for 7-day window
 * @returns {import('./types.js?v=20260418-sI').AdminStats}
 */
 ...
 * @param {import('./types.js?v=20260418-sI').ColumnDef[]} columns
 ...
 * @param {number} value
 * @param {import('./types.js?v=20260418-sI').EscalationRule[]} rules
 * @returns {import('./types.js?v=20260418-sI').EscalationRule[]} — triggered rules
 */
 ...
 * @param {import('./types.js?v=20260418-sI').EscalationRule[]} rules
 * @returns {Array<{ rule: import('./types.js?v=20260418-sI').EscalationRule, metricValue: number }>}
 */
 ...
 * @returns {import('./types.js?v=20260418-sI').UserAccount[]}
 */
 ...
 * @param {import('./types.js?v=20260418-sI').AuditLogEntry[]} log
 * @param {{ action?: string, tableName?: string, userId?: string }} filters
 * @returns {import('./types.js?v=20260418-sI').AuditLogEntry[]}
 */
