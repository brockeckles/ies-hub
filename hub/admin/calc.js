...
/** @type {import('./types.js?v=20260417-p8').MasterTableConfig[]} */
...
/** @type {import('./types.js?v=20260417-p8').UserAccount[]} */
...
/** @type {import('./types.js?v=20260417-p8').EscalationRule[]} */
...
/** @type {import('./types.js?v=20260417-p8').AuditLogEntry[]} */
 ...
 * @param {import('./types.js?v=20260417-p8').UserAccount[]} users
 * @param {import('./types.js?v=20260417-p8').MasterTableConfig[]} tables
 * @param {import('./types.js?v=20260417-p8').EscalationRule[]} escalations
 * @param {import('./types.js?v=20260417-p8').AuditLogEntry[]} auditLog
 * @param {string} [referenceDate] — ISO date for 7-day window
 * @returns {import('./types.js?v=20260417-p8').AdminStats}
 */
 ...
 * @param {import('./types.js?v=20260417-p8').ColumnDef[]} columns
 ...
 * @param {number} value
 * @param {import('./types.js?v=20260417-p8').EscalationRule[]} rules
 * @returns {import('./types.js?v=20260417-p8').EscalationRule[]} — triggered rules
 */
 ...
 * @param {import('./types.js?v=20260417-p8').EscalationRule[]} rules
 * @returns {Array<{ rule: import('./types.js?v=20260417-p8').EscalationRule, metricValue: number }>}
 */
 ...
 * @returns {import('./types.js?v=20260417-p8').UserAccount[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p8').AuditLogEntry[]} log
 * @param {{ action?: string, tableName?: string, userId?: string }} filters
 * @returns {import('./types.js?v=20260417-p8').AuditLogEntry[]}
 */
