...
/** @type {import('./types.js?v=20260417-mF').MasterTableConfig[]} */
...
/** @type {import('./types.js?v=20260417-mF').UserAccount[]} */
...
/** @type {import('./types.js?v=20260417-mF').EscalationRule[]} */
...
/** @type {import('./types.js?v=20260417-mF').AuditLogEntry[]} */
 ...
 * @param {import('./types.js?v=20260417-mF').UserAccount[]} users
 * @param {import('./types.js?v=20260417-mF').MasterTableConfig[]} tables
 * @param {import('./types.js?v=20260417-mF').EscalationRule[]} escalations
 * @param {import('./types.js?v=20260417-mF').AuditLogEntry[]} auditLog
 * @param {string} [referenceDate] — ISO date for 7-day window
 * @returns {import('./types.js?v=20260417-mF').AdminStats}
 */
 ...
 * @param {import('./types.js?v=20260417-mF').ColumnDef[]} columns
 ...
 * @param {number} value
 * @param {import('./types.js?v=20260417-mF').EscalationRule[]} rules
 * @returns {import('./types.js?v=20260417-mF').EscalationRule[]} — triggered rules
 */
 ...
 * @param {import('./types.js?v=20260417-mF').EscalationRule[]} rules
 * @returns {Array<{ rule: import('./types.js?v=20260417-mF').EscalationRule, metricValue: number }>}
 */
 ...
 * @returns {import('./types.js?v=20260417-mF').UserAccount[]}
 */
 ...
 * @param {import('./types.js?v=20260417-mF').AuditLogEntry[]} log
 * @param {{ action?: string, tableName?: string, userId?: string }} filters
 * @returns {import('./types.js?v=20260417-mF').AuditLogEntry[]}
 */
