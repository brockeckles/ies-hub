...
/** @type {import('./types.js?v=20260417-mA').MasterTableConfig[]} */
...
/** @type {import('./types.js?v=20260417-mA').UserAccount[]} */
...
/** @type {import('./types.js?v=20260417-mA').EscalationRule[]} */
...
/** @type {import('./types.js?v=20260417-mA').AuditLogEntry[]} */
 ...
 * @param {import('./types.js?v=20260417-mA').UserAccount[]} users
 * @param {import('./types.js?v=20260417-mA').MasterTableConfig[]} tables
 * @param {import('./types.js?v=20260417-mA').EscalationRule[]} escalations
 * @param {import('./types.js?v=20260417-mA').AuditLogEntry[]} auditLog
 * @param {string} [referenceDate] — ISO date for 7-day window
 * @returns {import('./types.js?v=20260417-mA').AdminStats}
 */
 ...
 * @param {import('./types.js?v=20260417-mA').ColumnDef[]} columns
 ...
 * @param {number} value
 * @param {import('./types.js?v=20260417-mA').EscalationRule[]} rules
 * @returns {import('./types.js?v=20260417-mA').EscalationRule[]} — triggered rules
 */
 ...
 * @param {import('./types.js?v=20260417-mA').EscalationRule[]} rules
 * @returns {Array<{ rule: import('./types.js?v=20260417-mA').EscalationRule, metricValue: number }>}
 */
 ...
 * @returns {import('./types.js?v=20260417-mA').UserAccount[]}
 */
 ...
 * @param {import('./types.js?v=20260417-mA').AuditLogEntry[]} log
 * @param {{ action?: string, tableName?: string, userId?: string }} filters
 * @returns {import('./types.js?v=20260417-mA').AuditLogEntry[]}
 */
