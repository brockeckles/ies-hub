...
/** @type {import('./types.js?v=20260417-m9').MasterTableConfig[]} */
...
/** @type {import('./types.js?v=20260417-m9').UserAccount[]} */
...
/** @type {import('./types.js?v=20260417-m9').EscalationRule[]} */
...
/** @type {import('./types.js?v=20260417-m9').AuditLogEntry[]} */
 ...
 * @param {import('./types.js?v=20260417-m9').UserAccount[]} users
 * @param {import('./types.js?v=20260417-m9').MasterTableConfig[]} tables
 * @param {import('./types.js?v=20260417-m9').EscalationRule[]} escalations
 * @param {import('./types.js?v=20260417-m9').AuditLogEntry[]} auditLog
 * @param {string} [referenceDate] — ISO date for 7-day window
 * @returns {import('./types.js?v=20260417-m9').AdminStats}
 */
 ...
 * @param {import('./types.js?v=20260417-m9').ColumnDef[]} columns
 ...
 * @param {number} value
 * @param {import('./types.js?v=20260417-m9').EscalationRule[]} rules
 * @returns {import('./types.js?v=20260417-m9').EscalationRule[]} — triggered rules
 */
 ...
 * @param {import('./types.js?v=20260417-m9').EscalationRule[]} rules
 * @returns {Array<{ rule: import('./types.js?v=20260417-m9').EscalationRule, metricValue: number }>}
 */
 ...
 * @returns {import('./types.js?v=20260417-m9').UserAccount[]}
 */
 ...
 * @param {import('./types.js?v=20260417-m9').AuditLogEntry[]} log
 * @param {{ action?: string, tableName?: string, userId?: string }} filters
 * @returns {import('./types.js?v=20260417-m9').AuditLogEntry[]}
 */
