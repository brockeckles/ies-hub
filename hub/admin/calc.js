...
/** @type {import('./types.js?v=20260417-pa').MasterTableConfig[]} */
...
/** @type {import('./types.js?v=20260417-pa').UserAccount[]} */
...
/** @type {import('./types.js?v=20260417-pa').EscalationRule[]} */
...
/** @type {import('./types.js?v=20260417-pa').AuditLogEntry[]} */
 ...
 * @param {import('./types.js?v=20260417-pa').UserAccount[]} users
 * @param {import('./types.js?v=20260417-pa').MasterTableConfig[]} tables
 * @param {import('./types.js?v=20260417-pa').EscalationRule[]} escalations
 * @param {import('./types.js?v=20260417-pa').AuditLogEntry[]} auditLog
 * @param {string} [referenceDate] — ISO date for 7-day window
 * @returns {import('./types.js?v=20260417-pa').AdminStats}
 */
 ...
 * @param {import('./types.js?v=20260417-pa').ColumnDef[]} columns
 ...
 * @param {number} value
 * @param {import('./types.js?v=20260417-pa').EscalationRule[]} rules
 * @returns {import('./types.js?v=20260417-pa').EscalationRule[]} — triggered rules
 */
 ...
 * @param {import('./types.js?v=20260417-pa').EscalationRule[]} rules
 * @returns {Array<{ rule: import('./types.js?v=20260417-pa').EscalationRule, metricValue: number }>}
 */
 ...
 * @returns {import('./types.js?v=20260417-pa').UserAccount[]}
 */
 ...
 * @param {import('./types.js?v=20260417-pa').AuditLogEntry[]} log
 * @param {{ action?: string, tableName?: string, userId?: string }} filters
 * @returns {import('./types.js?v=20260417-pa').AuditLogEntry[]}
 */
