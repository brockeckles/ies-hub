...
/** @type {import('./types.js?v=20260417-p3').MasterTableConfig[]} */
...
/** @type {import('./types.js?v=20260417-p3').UserAccount[]} */
...
/** @type {import('./types.js?v=20260417-p3').EscalationRule[]} */
...
/** @type {import('./types.js?v=20260417-p3').AuditLogEntry[]} */
 ...
 * @param {import('./types.js?v=20260417-p3').UserAccount[]} users
 * @param {import('./types.js?v=20260417-p3').MasterTableConfig[]} tables
 * @param {import('./types.js?v=20260417-p3').EscalationRule[]} escalations
 * @param {import('./types.js?v=20260417-p3').AuditLogEntry[]} auditLog
 * @param {string} [referenceDate] — ISO date for 7-day window
 * @returns {import('./types.js?v=20260417-p3').AdminStats}
 */
 ...
 * @param {import('./types.js?v=20260417-p3').ColumnDef[]} columns
 ...
 * @param {number} value
 * @param {import('./types.js?v=20260417-p3').EscalationRule[]} rules
 * @returns {import('./types.js?v=20260417-p3').EscalationRule[]} — triggered rules
 */
 ...
 * @param {import('./types.js?v=20260417-p3').EscalationRule[]} rules
 * @returns {Array<{ rule: import('./types.js?v=20260417-p3').EscalationRule, metricValue: number }>}
 */
 ...
 * @returns {import('./types.js?v=20260417-p3').UserAccount[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p3').AuditLogEntry[]} log
 * @param {{ action?: string, tableName?: string, userId?: string }} filters
 * @returns {import('./types.js?v=20260417-p3').AuditLogEntry[]}
 */
