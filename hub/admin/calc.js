...
/** @type {import('./types.js?v=20260418-sG').MasterTableConfig[]} */
...
/** @type {import('./types.js?v=20260418-sG').UserAccount[]} */
...
/** @type {import('./types.js?v=20260418-sG').EscalationRule[]} */
...
/** @type {import('./types.js?v=20260418-sG').AuditLogEntry[]} */
 ...
 * @param {import('./types.js?v=20260418-sG').UserAccount[]} users
 * @param {import('./types.js?v=20260418-sG').MasterTableConfig[]} tables
 * @param {import('./types.js?v=20260418-sG').EscalationRule[]} escalations
 * @param {import('./types.js?v=20260418-sG').AuditLogEntry[]} auditLog
 * @param {string} [referenceDate] — ISO date for 7-day window
 * @returns {import('./types.js?v=20260418-sG').AdminStats}
 */
 ...
 * @param {import('./types.js?v=20260418-sG').ColumnDef[]} columns
 ...
 * @param {number} value
 * @param {import('./types.js?v=20260418-sG').EscalationRule[]} rules
 * @returns {import('./types.js?v=20260418-sG').EscalationRule[]} — triggered rules
 */
 ...
 * @param {import('./types.js?v=20260418-sG').EscalationRule[]} rules
 * @returns {Array<{ rule: import('./types.js?v=20260418-sG').EscalationRule, metricValue: number }>}
 */
 ...
 * @returns {import('./types.js?v=20260418-sG').UserAccount[]}
 */
 ...
 * @param {import('./types.js?v=20260418-sG').AuditLogEntry[]} log
 * @param {{ action?: string, tableName?: string, userId?: string }} filters
 * @returns {import('./types.js?v=20260418-sG').AuditLogEntry[]}
 */
