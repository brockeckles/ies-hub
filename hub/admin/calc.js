...
/** @type {import('./types.js?v=20260418-sC').MasterTableConfig[]} */
...
/** @type {import('./types.js?v=20260418-sC').UserAccount[]} */
...
/** @type {import('./types.js?v=20260418-sC').EscalationRule[]} */
...
/** @type {import('./types.js?v=20260418-sC').AuditLogEntry[]} */
 ...
 * @param {import('./types.js?v=20260418-sC').UserAccount[]} users
 * @param {import('./types.js?v=20260418-sC').MasterTableConfig[]} tables
 * @param {import('./types.js?v=20260418-sC').EscalationRule[]} escalations
 * @param {import('./types.js?v=20260418-sC').AuditLogEntry[]} auditLog
 * @param {string} [referenceDate] — ISO date for 7-day window
 * @returns {import('./types.js?v=20260418-sC').AdminStats}
 */
 ...
 * @param {import('./types.js?v=20260418-sC').ColumnDef[]} columns
 ...
 * @param {number} value
 * @param {import('./types.js?v=20260418-sC').EscalationRule[]} rules
 * @returns {import('./types.js?v=20260418-sC').EscalationRule[]} — triggered rules
 */
 ...
 * @param {import('./types.js?v=20260418-sC').EscalationRule[]} rules
 * @returns {Array<{ rule: import('./types.js?v=20260418-sC').EscalationRule, metricValue: number }>}
 */
 ...
 * @returns {import('./types.js?v=20260418-sC').UserAccount[]}
 */
 ...
 * @param {import('./types.js?v=20260418-sC').AuditLogEntry[]} log
 * @param {{ action?: string, tableName?: string, userId?: string }} filters
 * @returns {import('./types.js?v=20260418-sC').AuditLogEntry[]}
 */
