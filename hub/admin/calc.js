...
// DEMO_USERS / DEMO_ESCALATIONS / DEMO_AUDIT_LOG deleted (C5, 2026-07-22).
// They fed fabricated rosters/rules/log rows into real-looking admin UI;
// every tab is now DB-backed or an honest empty state.
