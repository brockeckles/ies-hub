...
/** @type {import('./types.js?v=20260417-m6').MasterTableConfig[]} */
...
/** @type {import('./types.js?v=20260417-m6').UserAccount[]} */
...
/** @type {import('./types.js?v=20260417-m6').EscalationRule[]} */
...
/** @type {import('./types.js?v=20260417-m6').AuditLogEntry[]} */
 ...
 * @param {import('./types.js?v=20260417-m6').UserAccount[]} users
 * @param {import('./types.js?v=20260417-m6').MasterTableConfig[]} tables
 * @param {import('./types.js?v=20260417-m6').EscalationRule[]} escalations
 * @param {import('./types.js?v=20260417-m6').AuditLogEntry[]} auditLog
 * @param {string} [referenceDate] — ISO date for 7-day window
 * @returns {import('./types.js?v=20260417-m6').AdminStats}
 */
 ...
 * @param {import('./types.js?v=20260417-m6').ColumnDef[]} columns
 ...
 * @param {number} value
 * @param {import('./types.js?v=20260417-m6').EscalationRule[]} rules
 * @returns {import('./types.js?v=20260417-m6').EscalationRule[]} — triggered rules
 */
 ...
 * @param {import('./types.js?v=20260417-m6').EscalationRule[]} rules
 * @returns {Array<{ rule: import('./types.js?v=20260417-m6').EscalationRule, metricValue: number }>}
 */
 ...
 * @returns {import('./types.js?v=20260417-m6').UserAccount[]}
 */
 ...
 * @param {import('./types.js?v=20260417-m6').AuditLogEntry[]} log
 * @param {{ action?: string, tableName?: string, userId?: string }} filters
 * @returns {import('./types.js?v=20260417-m6').AuditLogEntry[]}
 */
