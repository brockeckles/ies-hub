...
/** @type {import('./types.js?v=20260417-m7').MasterTableConfig[]} */
...
/** @type {import('./types.js?v=20260417-m7').UserAccount[]} */
...
/** @type {import('./types.js?v=20260417-m7').EscalationRule[]} */
...
/** @type {import('./types.js?v=20260417-m7').AuditLogEntry[]} */
 ...
 * @param {import('./types.js?v=20260417-m7').UserAccount[]} users
 * @param {import('./types.js?v=20260417-m7').MasterTableConfig[]} tables
 * @param {import('./types.js?v=20260417-m7').EscalationRule[]} escalations
 * @param {import('./types.js?v=20260417-m7').AuditLogEntry[]} auditLog
 * @param {string} [referenceDate] — ISO date for 7-day window
 * @returns {import('./types.js?v=20260417-m7').AdminStats}
 */
 ...
 * @param {import('./types.js?v=20260417-m7').ColumnDef[]} columns
 ...
 * @param {number} value
 * @param {import('./types.js?v=20260417-m7').EscalationRule[]} rules
 * @returns {import('./types.js?v=20260417-m7').EscalationRule[]} — triggered rules
 */
 ...
 * @param {import('./types.js?v=20260417-m7').EscalationRule[]} rules
 * @returns {Array<{ rule: import('./types.js?v=20260417-m7').EscalationRule, metricValue: number }>}
 */
 ...
 * @returns {import('./types.js?v=20260417-m7').UserAccount[]}
 */
 ...
 * @param {import('./types.js?v=20260417-m7').AuditLogEntry[]} log
 * @param {{ action?: string, tableName?: string, userId?: string }} filters
 * @returns {import('./types.js?v=20260417-m7').AuditLogEntry[]}
 */
