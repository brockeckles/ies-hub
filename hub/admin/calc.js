...
/** @type {import('./types.js?v=20260418-sA').MasterTableConfig[]} */
...
/** @type {import('./types.js?v=20260418-sA').UserAccount[]} */
...
/** @type {import('./types.js?v=20260418-sA').EscalationRule[]} */
...
/** @type {import('./types.js?v=20260418-sA').AuditLogEntry[]} */
 ...
 * @param {import('./types.js?v=20260418-sA').UserAccount[]} users
 * @param {import('./types.js?v=20260418-sA').MasterTableConfig[]} tables
 * @param {import('./types.js?v=20260418-sA').EscalationRule[]} escalations
 * @param {import('./types.js?v=20260418-sA').AuditLogEntry[]} auditLog
 * @param {string} [referenceDate] — ISO date for 7-day window
 * @returns {import('./types.js?v=20260418-sA').AdminStats}
 */
 ...
 * @param {import('./types.js?v=20260418-sA').ColumnDef[]} columns
 ...
 * @param {number} value
 * @param {import('./types.js?v=20260418-sA').EscalationRule[]} rules
 * @returns {import('./types.js?v=20260418-sA').EscalationRule[]} — triggered rules
 */
 ...
 * @param {import('./types.js?v=20260418-sA').EscalationRule[]} rules
 * @returns {Array<{ rule: import('./types.js?v=20260418-sA').EscalationRule, metricValue: number }>}
 */
 ...
 * @returns {import('./types.js?v=20260418-sA').UserAccount[]}
 */
 ...
 * @param {import('./types.js?v=20260418-sA').AuditLogEntry[]} log
 * @param {{ action?: string, tableName?: string, userId?: string }} filters
 * @returns {import('./types.js?v=20260418-sA').AuditLogEntry[]}
 */
