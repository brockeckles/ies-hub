...
/** @type {import('./types.js?v=20260417-mH').MasterTableConfig[]} */
...
/** @type {import('./types.js?v=20260417-mH').UserAccount[]} */
...
/** @type {import('./types.js?v=20260417-mH').EscalationRule[]} */
...
/** @type {import('./types.js?v=20260417-mH').AuditLogEntry[]} */
 ...
 * @param {import('./types.js?v=20260417-mH').UserAccount[]} users
 * @param {import('./types.js?v=20260417-mH').MasterTableConfig[]} tables
 * @param {import('./types.js?v=20260417-mH').EscalationRule[]} escalations
 * @param {import('./types.js?v=20260417-mH').AuditLogEntry[]} auditLog
 * @param {string} [referenceDate] — ISO date for 7-day window
 * @returns {import('./types.js?v=20260417-mH').AdminStats}
 */
 ...
 * @param {import('./types.js?v=20260417-mH').ColumnDef[]} columns
 ...
 * @param {number} value
 * @param {import('./types.js?v=20260417-mH').EscalationRule[]} rules
 * @returns {import('./types.js?v=20260417-mH').EscalationRule[]} — triggered rules
 */
 ...
 * @param {import('./types.js?v=20260417-mH').EscalationRule[]} rules
 * @returns {Array<{ rule: import('./types.js?v=20260417-mH').EscalationRule, metricValue: number }>}
 */
 ...
 * @returns {import('./types.js?v=20260417-mH').UserAccount[]}
 */
 ...
 * @param {import('./types.js?v=20260417-mH').AuditLogEntry[]} log
 * @param {{ action?: string, tableName?: string, userId?: string }} filters
 * @returns {import('./types.js?v=20260417-mH').AuditLogEntry[]}
 */
