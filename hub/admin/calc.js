...
/** @type {import('./types.js?v=20260418-sD').MasterTableConfig[]} */
...
/** @type {import('./types.js?v=20260418-sD').UserAccount[]} */
...
/** @type {import('./types.js?v=20260418-sD').EscalationRule[]} */
...
/** @type {import('./types.js?v=20260418-sD').AuditLogEntry[]} */
 ...
 * @param {import('./types.js?v=20260418-sD').UserAccount[]} users
 * @param {import('./types.js?v=20260418-sD').MasterTableConfig[]} tables
 * @param {import('./types.js?v=20260418-sD').EscalationRule[]} escalations
 * @param {import('./types.js?v=20260418-sD').AuditLogEntry[]} auditLog
 * @param {string} [referenceDate] — ISO date for 7-day window
 * @returns {import('./types.js?v=20260418-sD').AdminStats}
 */
 ...
 * @param {import('./types.js?v=20260418-sD').ColumnDef[]} columns
 ...
 * @param {number} value
 * @param {import('./types.js?v=20260418-sD').EscalationRule[]} rules
 * @returns {import('./types.js?v=20260418-sD').EscalationRule[]} — triggered rules
 */
 ...
 * @param {import('./types.js?v=20260418-sD').EscalationRule[]} rules
 * @returns {Array<{ rule: import('./types.js?v=20260418-sD').EscalationRule, metricValue: number }>}
 */
 ...
 * @returns {import('./types.js?v=20260418-sD').UserAccount[]}
 */
 ...
 * @param {import('./types.js?v=20260418-sD').AuditLogEntry[]} log
 * @param {{ action?: string, tableName?: string, userId?: string }} filters
 * @returns {import('./types.js?v=20260418-sD').AuditLogEntry[]}
 */
