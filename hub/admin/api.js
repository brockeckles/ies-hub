...
/**
 * List user accounts.
 * @returns {Promise<import('./types.js?v=20260417-mD').UserAccount[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260417-mD').EscalationRule[]>}
 */
 ...
 * @param {import('./types.js?v=20260417-mD').EscalationRule} rule
 * @returns {Promise<any>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260417-mD').AuditLogEntry[]>}
 */
 ...
 * @param {Omit<import('./types.js?v=20260417-mD').AuditLogEntry, 'id'>} entry
 * @returns {Promise<void>}
 */
