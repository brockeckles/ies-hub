...
/**
 * List user accounts.
 * @returns {Promise<import('./types.js?v=20260418-sG').UserAccount[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260418-sG').EscalationRule[]>}
 */
 ...
 * @param {import('./types.js?v=20260418-sG').EscalationRule} rule
 * @returns {Promise<any>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260418-sG').AuditLogEntry[]>}
 */
 ...
 * @param {Omit<import('./types.js?v=20260418-sG').AuditLogEntry, 'id'>} entry
 * @returns {Promise<void>}
 */
