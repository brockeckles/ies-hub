...
/**
 * List user accounts.
 * @returns {Promise<import('./types.js?v=20260418-sI').UserAccount[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260418-sI').EscalationRule[]>}
 */
 ...
 * @param {import('./types.js?v=20260418-sI').EscalationRule} rule
 * @returns {Promise<any>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260418-sI').AuditLogEntry[]>}
 */
 ...
 * @param {Omit<import('./types.js?v=20260418-sI').AuditLogEntry, 'id'>} entry
 * @returns {Promise<void>}
 */
