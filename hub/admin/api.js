...
/**
 * List user accounts.
 * @returns {Promise<import('./types.js?v=20260417-mA').UserAccount[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260417-mA').EscalationRule[]>}
 */
 ...
 * @param {import('./types.js?v=20260417-mA').EscalationRule} rule
 * @returns {Promise<any>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260417-mA').AuditLogEntry[]>}
 */
 ...
 * @param {Omit<import('./types.js?v=20260417-mA').AuditLogEntry, 'id'>} entry
 * @returns {Promise<void>}
 */
