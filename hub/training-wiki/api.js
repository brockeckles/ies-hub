...
/**
 * List all categories.
 * @returns {Promise<import('./types.js?v=20260418-sH').WikiCategory[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260418-sH').WikiArticle[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260418-sH').WikiArticle|null>}
 */
 ...
 * @param {import('./types.js?v=20260418-sH').WikiArticle} article
 * @returns {Promise<import('./types.js?v=20260418-sH').WikiArticle>}
 */
...
/**
 * Load all wiki data.
 * @returns {Promise<{ categories: import('./types.js?v=20260418-sH').WikiCategory[], articles: import('./types.js?v=20260418-sH').WikiArticle[] }>}
 */
