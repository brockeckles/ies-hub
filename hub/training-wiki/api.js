...
/**
 * List all categories.
 * @returns {Promise<import('./types.js?v=20260418-sK').WikiCategory[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260418-sK').WikiArticle[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260418-sK').WikiArticle|null>}
 */
 ...
 * @param {import('./types.js?v=20260418-sK').WikiArticle} article
 * @returns {Promise<import('./types.js?v=20260418-sK').WikiArticle>}
 */
...
/**
 * Load all wiki data.
 * @returns {Promise<{ categories: import('./types.js?v=20260418-sK').WikiCategory[], articles: import('./types.js?v=20260418-sK').WikiArticle[] }>}
 */
