...
/**
 * List all categories.
 * @returns {Promise<import('./types.js?v=20260418-sA').WikiCategory[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260418-sA').WikiArticle[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260418-sA').WikiArticle|null>}
 */
 ...
 * @param {import('./types.js?v=20260418-sA').WikiArticle} article
 * @returns {Promise<import('./types.js?v=20260418-sA').WikiArticle>}
 */
...
/**
 * Load all wiki data.
 * @returns {Promise<{ categories: import('./types.js?v=20260418-sA').WikiCategory[], articles: import('./types.js?v=20260418-sA').WikiArticle[] }>}
 */
