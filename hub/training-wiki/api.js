...
/**
 * List all categories.
 * @returns {Promise<import('./types.js?v=20260417-m6').WikiCategory[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260417-m6').WikiArticle[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260417-m6').WikiArticle|null>}
 */
 ...
 * @param {import('./types.js?v=20260417-m6').WikiArticle} article
 * @returns {Promise<import('./types.js?v=20260417-m6').WikiArticle>}
 */
...
/**
 * Load all wiki data.
 * @returns {Promise<{ categories: import('./types.js?v=20260417-m6').WikiCategory[], articles: import('./types.js?v=20260417-m6').WikiArticle[] }>}
 */
