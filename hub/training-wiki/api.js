...
/**
 * List all categories.
 * @returns {Promise<import('./types.js').WikiCategory[]>}
 */
 ...
 * @returns {Promise<import('./types.js').WikiArticle[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js').WikiArticle|null>}
 */
 ...
 * @param {import('./types.js').WikiArticle} article
 * @returns {Promise<import('./types.js').WikiArticle>}
 */
...
/**
 * Load all wiki data.
 * @returns {Promise<{ categories: import('./types.js').WikiCategory[], articles: import('./types.js').WikiArticle[] }>}
 */
