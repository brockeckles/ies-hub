...
/**
 * List all categories.
 * @returns {Promise<import('./types.js?v=20260417-p4').WikiCategory[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260417-p4').WikiArticle[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260417-p4').WikiArticle|null>}
 */
 ...
 * @param {import('./types.js?v=20260417-p4').WikiArticle} article
 * @returns {Promise<import('./types.js?v=20260417-p4').WikiArticle>}
 */
...
/**
 * Load all wiki data.
 * @returns {Promise<{ categories: import('./types.js?v=20260417-p4').WikiCategory[], articles: import('./types.js?v=20260417-p4').WikiArticle[] }>}
 */
