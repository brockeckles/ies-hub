...
/**
 * List all categories.
 * @returns {Promise<import('./types.js?v=20260417-p7').WikiCategory[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260417-p7').WikiArticle[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260417-p7').WikiArticle|null>}
 */
 ...
 * @param {import('./types.js?v=20260417-p7').WikiArticle} article
 * @returns {Promise<import('./types.js?v=20260417-p7').WikiArticle>}
 */
...
/**
 * Load all wiki data.
 * @returns {Promise<{ categories: import('./types.js?v=20260417-p7').WikiCategory[], articles: import('./types.js?v=20260417-p7').WikiArticle[] }>}
 */
