...
/**
 * List all categories.
 * @returns {Promise<import('./types.js?v=20260418-sC').WikiCategory[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260418-sC').WikiArticle[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260418-sC').WikiArticle|null>}
 */
 ...
 * @param {import('./types.js?v=20260418-sC').WikiArticle} article
 * @returns {Promise<import('./types.js?v=20260418-sC').WikiArticle>}
 */
...
/**
 * Load all wiki data.
 * @returns {Promise<{ categories: import('./types.js?v=20260418-sC').WikiCategory[], articles: import('./types.js?v=20260418-sC').WikiArticle[] }>}
 */
