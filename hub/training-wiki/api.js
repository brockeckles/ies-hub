...
/**
 * List all categories.
 * @returns {Promise<import('./types.js?v=20260418-s8').WikiCategory[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260418-s8').WikiArticle[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260418-s8').WikiArticle|null>}
 */
 ...
 * @param {import('./types.js?v=20260418-s8').WikiArticle} article
 * @returns {Promise<import('./types.js?v=20260418-s8').WikiArticle>}
 */
...
/**
 * Load all wiki data.
 * @returns {Promise<{ categories: import('./types.js?v=20260418-s8').WikiCategory[], articles: import('./types.js?v=20260418-s8').WikiArticle[] }>}
 */
