...
/**
 * List all categories.
 * @returns {Promise<import('./types.js?v=20260417-p1').WikiCategory[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260417-p1').WikiArticle[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260417-p1').WikiArticle|null>}
 */
 ...
 * @param {import('./types.js?v=20260417-p1').WikiArticle} article
 * @returns {Promise<import('./types.js?v=20260417-p1').WikiArticle>}
 */
...
/**
 * Load all wiki data.
 * @returns {Promise<{ categories: import('./types.js?v=20260417-p1').WikiCategory[], articles: import('./types.js?v=20260417-p1').WikiArticle[] }>}
 */
