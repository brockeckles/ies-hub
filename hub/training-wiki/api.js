...
/**
 * List all categories.
 * @returns {Promise<import('./types.js?v=20260418-sF').WikiCategory[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260418-sF').WikiArticle[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260418-sF').WikiArticle|null>}
 */
 ...
 * @param {import('./types.js?v=20260418-sF').WikiArticle} article
 * @returns {Promise<import('./types.js?v=20260418-sF').WikiArticle>}
 */
...
/**
 * Load all wiki data.
 * @returns {Promise<{ categories: import('./types.js?v=20260418-sF').WikiCategory[], articles: import('./types.js?v=20260418-sF').WikiArticle[] }>}
 */
