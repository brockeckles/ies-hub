...
/**
 * List all categories.
 * @returns {Promise<import('./types.js?v=20260417-m8').WikiCategory[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260417-m8').WikiArticle[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260417-m8').WikiArticle|null>}
 */
 ...
 * @param {import('./types.js?v=20260417-m8').WikiArticle} article
 * @returns {Promise<import('./types.js?v=20260417-m8').WikiArticle>}
 */
...
/**
 * Load all wiki data.
 * @returns {Promise<{ categories: import('./types.js?v=20260417-m8').WikiCategory[], articles: import('./types.js?v=20260417-m8').WikiArticle[] }>}
 */
