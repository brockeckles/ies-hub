...
/**
 * List all categories.
 * @returns {Promise<import('./types.js?v=20260417-mI').WikiCategory[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260417-mI').WikiArticle[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260417-mI').WikiArticle|null>}
 */
 ...
 * @param {import('./types.js?v=20260417-mI').WikiArticle} article
 * @returns {Promise<import('./types.js?v=20260417-mI').WikiArticle>}
 */
...
/**
 * Load all wiki data.
 * @returns {Promise<{ categories: import('./types.js?v=20260417-mI').WikiCategory[], articles: import('./types.js?v=20260417-mI').WikiArticle[] }>}
 */
