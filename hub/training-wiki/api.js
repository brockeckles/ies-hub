...
/**
 * List all categories.
 * @returns {Promise<import('./types.js?v=20260418-sI').WikiCategory[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260418-sI').WikiArticle[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260418-sI').WikiArticle|null>}
 */
 ...
 * @param {import('./types.js?v=20260418-sI').WikiArticle} article
 * @returns {Promise<import('./types.js?v=20260418-sI').WikiArticle>}
 */
...
/**
 * Load all wiki data.
 * @returns {Promise<{ categories: import('./types.js?v=20260418-sI').WikiCategory[], articles: import('./types.js?v=20260418-sI').WikiArticle[] }>}
 */
