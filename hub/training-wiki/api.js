...
/**
 * List all categories.
 * @returns {Promise<import('./types.js?v=20260417-mH').WikiCategory[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260417-mH').WikiArticle[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260417-mH').WikiArticle|null>}
 */
 ...
 * @param {import('./types.js?v=20260417-mH').WikiArticle} article
 * @returns {Promise<import('./types.js?v=20260417-mH').WikiArticle>}
 */
...
/**
 * Load all wiki data.
 * @returns {Promise<{ categories: import('./types.js?v=20260417-mH').WikiCategory[], articles: import('./types.js?v=20260417-mH').WikiArticle[] }>}
 */
