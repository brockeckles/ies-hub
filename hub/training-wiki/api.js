...
/**
 * List all categories.
 * @returns {Promise<import('./types.js?v=20260417-mE').WikiCategory[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260417-mE').WikiArticle[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260417-mE').WikiArticle|null>}
 */
 ...
 * @param {import('./types.js?v=20260417-mE').WikiArticle} article
 * @returns {Promise<import('./types.js?v=20260417-mE').WikiArticle>}
 */
...
/**
 * Load all wiki data.
 * @returns {Promise<{ categories: import('./types.js?v=20260417-mE').WikiCategory[], articles: import('./types.js?v=20260417-mE').WikiArticle[] }>}
 */
