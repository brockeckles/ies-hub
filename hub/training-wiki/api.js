...
/**
 * List all categories.
 * @returns {Promise<import('./types.js?v=20260417-mA').WikiCategory[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260417-mA').WikiArticle[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260417-mA').WikiArticle|null>}
 */
 ...
 * @param {import('./types.js?v=20260417-mA').WikiArticle} article
 * @returns {Promise<import('./types.js?v=20260417-mA').WikiArticle>}
 */
...
/**
 * Load all wiki data.
 * @returns {Promise<{ categories: import('./types.js?v=20260417-mA').WikiCategory[], articles: import('./types.js?v=20260417-mA').WikiArticle[] }>}
 */
