...
/**
 * List all categories.
 * @returns {Promise<import('./types.js?v=20260418-sB').WikiCategory[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260418-sB').WikiArticle[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260418-sB').WikiArticle|null>}
 */
 ...
 * @param {import('./types.js?v=20260418-sB').WikiArticle} article
 * @returns {Promise<import('./types.js?v=20260418-sB').WikiArticle>}
 */
...
/**
 * Load all wiki data.
 * @returns {Promise<{ categories: import('./types.js?v=20260418-sB').WikiCategory[], articles: import('./types.js?v=20260418-sB').WikiArticle[] }>}
 */
