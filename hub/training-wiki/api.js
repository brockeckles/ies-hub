...
/**
 * List all categories.
 * @returns {Promise<import('./types.js?v=20260417-p3').WikiCategory[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260417-p3').WikiArticle[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260417-p3').WikiArticle|null>}
 */
 ...
 * @param {import('./types.js?v=20260417-p3').WikiArticle} article
 * @returns {Promise<import('./types.js?v=20260417-p3').WikiArticle>}
 */
...
/**
 * Load all wiki data.
 * @returns {Promise<{ categories: import('./types.js?v=20260417-p3').WikiCategory[], articles: import('./types.js?v=20260417-p3').WikiArticle[] }>}
 */
