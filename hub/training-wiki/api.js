...
/**
 * List all categories.
 * @returns {Promise<import('./types.js?v=20260418-sG').WikiCategory[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260418-sG').WikiArticle[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260418-sG').WikiArticle|null>}
 */
 ...
 * @param {import('./types.js?v=20260418-sG').WikiArticle} article
 * @returns {Promise<import('./types.js?v=20260418-sG').WikiArticle>}
 */
...
/**
 * Load all wiki data.
 * @returns {Promise<{ categories: import('./types.js?v=20260418-sG').WikiCategory[], articles: import('./types.js?v=20260418-sG').WikiArticle[] }>}
 */
