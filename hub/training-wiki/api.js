...
/**
 * List all categories.
 * @returns {Promise<import('./types.js?v=20260418-s1').WikiCategory[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260418-s1').WikiArticle[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260418-s1').WikiArticle|null>}
 */
 ...
 * @param {import('./types.js?v=20260418-s1').WikiArticle} article
 * @returns {Promise<import('./types.js?v=20260418-s1').WikiArticle>}
 */
...
/**
 * Load all wiki data.
 * @returns {Promise<{ categories: import('./types.js?v=20260418-s1').WikiCategory[], articles: import('./types.js?v=20260418-s1').WikiArticle[] }>}
 */
