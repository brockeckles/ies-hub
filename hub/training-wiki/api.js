...
/**
 * List all categories.
 * @returns {Promise<import('./types.js?v=20260417-mD').WikiCategory[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260417-mD').WikiArticle[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260417-mD').WikiArticle|null>}
 */
 ...
 * @param {import('./types.js?v=20260417-mD').WikiArticle} article
 * @returns {Promise<import('./types.js?v=20260417-mD').WikiArticle>}
 */
...
/**
 * Load all wiki data.
 * @returns {Promise<{ categories: import('./types.js?v=20260417-mD').WikiCategory[], articles: import('./types.js?v=20260417-mD').WikiArticle[] }>}
 */
