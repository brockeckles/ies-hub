...
/**
 * List all categories.
 * @returns {Promise<import('./types.js?v=20260417-s2').WikiCategory[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260417-s2').WikiArticle[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260417-s2').WikiArticle|null>}
 */
 ...
 * @param {import('./types.js?v=20260417-s2').WikiArticle} article
 * @returns {Promise<import('./types.js?v=20260417-s2').WikiArticle>}
 */
...
/**
 * Load all wiki data.
 * @returns {Promise<{ categories: import('./types.js?v=20260417-s2').WikiCategory[], articles: import('./types.js?v=20260417-s2').WikiArticle[] }>}
 */
