...
/**
 * List all categories.
 * @returns {Promise<import('./types.js?v=20260418-s9').WikiCategory[]>}
 */
 ...
 * @returns {Promise<import('./types.js?v=20260418-s9').WikiArticle[]>}
 */
 ...
 * @param {string} id
 * @returns {Promise<import('./types.js?v=20260418-s9').WikiArticle|null>}
 */
 ...
 * @param {import('./types.js?v=20260418-s9').WikiArticle} article
 * @returns {Promise<import('./types.js?v=20260418-s9').WikiArticle>}
 */
...
/**
 * Load all wiki data.
 * @returns {Promise<{ categories: import('./types.js?v=20260418-s9').WikiCategory[], articles: import('./types.js?v=20260418-s9').WikiArticle[] }>}
 */
