 ...
 * @param {import('./types.js?v=20260417-p9').WikiArticle[]} articles
 * @param {string} query
 * @returns {import('./types.js?v=20260417-p9').WikiSearchResult[]}
 */
 ...
 * @returns {import('./types.js?v=20260417-p9').WikiArticle[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p9').WikiArticle[]} articles
 * @param {import('./types.js?v=20260417-p9').WikiCategory[]} categories
 * @returns {import('./types.js?v=20260417-p9').WikiStats}
 */
...
/** @type {import('./types.js?v=20260417-p9').WikiCategory[]} */
...
/** @type {import('./types.js?v=20260417-p9').WikiArticle[]} */
