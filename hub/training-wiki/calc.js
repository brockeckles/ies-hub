 ...
 * @param {import('./types.js?v=20260417-p8').WikiArticle[]} articles
 * @param {string} query
 * @returns {import('./types.js?v=20260417-p8').WikiSearchResult[]}
 */
 ...
 * @returns {import('./types.js?v=20260417-p8').WikiArticle[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p8').WikiArticle[]} articles
 * @param {import('./types.js?v=20260417-p8').WikiCategory[]} categories
 * @returns {import('./types.js?v=20260417-p8').WikiStats}
 */
...
/** @type {import('./types.js?v=20260417-p8').WikiCategory[]} */
...
/** @type {import('./types.js?v=20260417-p8').WikiArticle[]} */
