 ...
 * @param {import('./types.js?v=20260417-p5').WikiArticle[]} articles
 * @param {string} query
 * @returns {import('./types.js?v=20260417-p5').WikiSearchResult[]}
 */
 ...
 * @returns {import('./types.js?v=20260417-p5').WikiArticle[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p5').WikiArticle[]} articles
 * @param {import('./types.js?v=20260417-p5').WikiCategory[]} categories
 * @returns {import('./types.js?v=20260417-p5').WikiStats}
 */
...
/** @type {import('./types.js?v=20260417-p5').WikiCategory[]} */
...
/** @type {import('./types.js?v=20260417-p5').WikiArticle[]} */
