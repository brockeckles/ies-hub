 ...
 * @param {import('./types.js?v=20260417-p4').WikiArticle[]} articles
 * @param {string} query
 * @returns {import('./types.js?v=20260417-p4').WikiSearchResult[]}
 */
 ...
 * @returns {import('./types.js?v=20260417-p4').WikiArticle[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p4').WikiArticle[]} articles
 * @param {import('./types.js?v=20260417-p4').WikiCategory[]} categories
 * @returns {import('./types.js?v=20260417-p4').WikiStats}
 */
...
/** @type {import('./types.js?v=20260417-p4').WikiCategory[]} */
...
/** @type {import('./types.js?v=20260417-p4').WikiArticle[]} */
