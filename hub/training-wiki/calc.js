 ...
 * @param {import('./types.js?v=20260417-p6').WikiArticle[]} articles
 * @param {string} query
 * @returns {import('./types.js?v=20260417-p6').WikiSearchResult[]}
 */
 ...
 * @returns {import('./types.js?v=20260417-p6').WikiArticle[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p6').WikiArticle[]} articles
 * @param {import('./types.js?v=20260417-p6').WikiCategory[]} categories
 * @returns {import('./types.js?v=20260417-p6').WikiStats}
 */
...
/** @type {import('./types.js?v=20260417-p6').WikiCategory[]} */
...
/** @type {import('./types.js?v=20260417-p6').WikiArticle[]} */
