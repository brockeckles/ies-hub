 ...
 * @param {import('./types.js?v=20260417-p1').WikiArticle[]} articles
 * @param {string} query
 * @returns {import('./types.js?v=20260417-p1').WikiSearchResult[]}
 */
 ...
 * @returns {import('./types.js?v=20260417-p1').WikiArticle[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p1').WikiArticle[]} articles
 * @param {import('./types.js?v=20260417-p1').WikiCategory[]} categories
 * @returns {import('./types.js?v=20260417-p1').WikiStats}
 */
...
/** @type {import('./types.js?v=20260417-p1').WikiCategory[]} */
...
/** @type {import('./types.js?v=20260417-p1').WikiArticle[]} */
