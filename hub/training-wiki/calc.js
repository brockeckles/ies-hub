 ...
 * @param {import('./types.js?v=20260417-p3').WikiArticle[]} articles
 * @param {string} query
 * @returns {import('./types.js?v=20260417-p3').WikiSearchResult[]}
 */
 ...
 * @returns {import('./types.js?v=20260417-p3').WikiArticle[]}
 */
 ...
 * @param {import('./types.js?v=20260417-p3').WikiArticle[]} articles
 * @param {import('./types.js?v=20260417-p3').WikiCategory[]} categories
 * @returns {import('./types.js?v=20260417-p3').WikiStats}
 */
...
/** @type {import('./types.js?v=20260417-p3').WikiCategory[]} */
...
/** @type {import('./types.js?v=20260417-p3').WikiArticle[]} */
